...
namespace ACBrAPI.Sdk.Api
{
    ...
    public interface IDistribuioNFEApiSync : IApiAccessor
    {
        ...
        /// <param name="id">ID único do documento gerado pela API.</param>
        ...
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da distribuição de NF-e gerada pela API.</param>
        ...
        /// </remarks>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da manifestação gerado pela API.</param>
    ...
    public partial class DistribuioNFEApi : IDisposable, IDistribuioNFEApi
    {
        ...
        /// <returns></returns>
        public DistribuioNFEApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DistribuioNFEApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DistribuioNFEApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfDocumentoDistribuicaoNfeWithHttpInfo(id);
        ...
        /// <param name="id">ID único do documento gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfDocumentoDistribuicaoNfeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->BaixarPdfDocumentoDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfDocumentoDistribuicaoNfeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfDocumentoDistribuicaoNfeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->BaixarPdfDocumentoDistribuicaoNfe");
        ...
        /// <summary>
        /// Baixar XML do documento Utilize esse endpoint para obter o XML das informações resumidas ou documento fiscal de interesse da pessoa ou empresa interessada.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único do documento gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlDocumentoDistribuicaoNfeWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do documento gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlDocumentoDistribuicaoNfeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->BaixarXmlDocumentoDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlDocumentoDistribuicaoNfeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlDocumentoDistribuicaoNfeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->BaixarXmlDocumentoDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe> localVarResponse = ConsultarDistribuicaoNfeWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da distribuição de NF-e gerada pela API.</param>
        /// <returns>ApiResponse of DistribuicaoNfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe> ConsultarDistribuicaoNfeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->ConsultarDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe> localVarResponse = await ConsultarDistribuicaoNfeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe>> ConsultarDistribuicaoNfeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->ConsultarDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumento> localVarResponse = ConsultarDocumentoDistribuicaoNfeWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do documento gerado pela API.</param>
        /// <returns>ApiResponse of DistribuicaoNfeDocumento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumento> ConsultarDocumentoDistribuicaoNfeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->ConsultarDocumentoDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumento> localVarResponse = await ConsultarDocumentoDistribuicaoNfeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfeDocumento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumento>> ConsultarDocumentoDistribuicaoNfeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->ConsultarDocumentoDistribuicaoNfe");
        ...
        /// <summary>
        /// Consultar manifestação Consulta os detalhes de uma manifestação de NF-e já existente. Forneça o ID único obtido de uma requisição de manifestação ou de listagem de manifestações e a API irá retornar as informações da manifestação correspondente.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da manifestação gerado pela API.</param>
        /// <returns>DistribuicaoNfeEvento</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento> localVarResponse = ConsultarManifestacaoNfeWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da manifestação gerado pela API.</param>
        /// <returns>ApiResponse of DistribuicaoNfeEvento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento> ConsultarManifestacaoNfeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->ConsultarManifestacaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento> localVarResponse = await ConsultarManifestacaoNfeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfeEvento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento>> ConsultarManifestacaoNfeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DistribuioNFEApi->ConsultarManifestacaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe> localVarResponse = GerarDistribuicaoNfeWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of DistribuicaoNfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe> GerarDistribuicaoNfeWithHttpInfo(DistribuicaoNfePedido body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling DistribuioNFEApi->GerarDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe> localVarResponse = await GerarDistribuicaoNfeWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfe>> GerarDistribuicaoNfeWithHttpInfoAsync(DistribuicaoNfePedido body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling DistribuioNFEApi->GerarDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeListagem> localVarResponse = ListarDistribuicaoNfeWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inlinecount">Inclui no JSON de resposta, na propriedade &#x60;@count&#x60;, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (optional, default to false)</param>
        /// <returns>ApiResponse of DistribuicaoNfeListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeListagem> ListarDistribuicaoNfeWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarDistribuicaoNfe");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling DistribuioNFEApi->ListarDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeListagem> localVarResponse = await ListarDistribuicaoNfeWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumentoListagem> localVarResponse = ListarDocumentoDistribuicaoNfeWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, distNsu, tipoDocumento, formaDistribuicao, chaveAcesso);
            return localVarResponse.Data;
        }
        ...
        /// <param name="chaveAcesso">Filtrar pela chave de acesso da NF-e. (optional)</param>
        /// <returns>ApiResponse of DistribuicaoNfeDocumentoListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumentoListagem> ListarDocumentoDistribuicaoNfeWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), long? distNsu = default(long?), string tipoDocumento = default(string), string formaDistribuicao = default(string), string chaveAcesso = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarDocumentoDistribuicaoNfe");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling DistribuioNFEApi->ListarDocumentoDistribuicaoNfe");
            ...
            if (distNsu != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "dist_nsu", distNsu));
            }
            if (tipoDocumento != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "tipo_documento", tipoDocumento));
            }
            if (formaDistribuicao != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "forma_distribuicao", formaDistribuicao));
            }
            if (chaveAcesso != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "chave_acesso", chaveAcesso));
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumentoListagem> localVarResponse = await ListarDocumentoDistribuicaoNfeWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, distNsu, tipoDocumento, formaDistribuicao, chaveAcesso, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfeDocumentoListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeDocumentoListagem>> ListarDocumentoDistribuicaoNfeWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), long? distNsu = default(long?), string tipoDocumento = default(string), string formaDistribuicao = default(string), string chaveAcesso = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarDocumentoDistribuicaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<ManifestacaoNfeListagem> localVarResponse = ListarManifestacaoNfeWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inlinecount">Inclui no JSON de resposta, na propriedade &#x60;@count&#x60;, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (optional, default to false)</param>
        /// <returns>ApiResponse of ManifestacaoNfeListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<ManifestacaoNfeListagem> ListarManifestacaoNfeWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarManifestacaoNfe");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling DistribuioNFEApi->ListarManifestacaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<ManifestacaoNfeListagem> localVarResponse = await ListarManifestacaoNfeWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ManifestacaoNfeListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<ManifestacaoNfeListagem>> ListarManifestacaoNfeWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarManifestacaoNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeNotaListagem> localVarResponse = ListarNfeSemManifestacaoWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, conclusiva);
            return localVarResponse.Data;
        }
        ...
        /// <param name="conclusiva">Indica se serão consideradas apenas as manifestações conclusivas.    Valores:  * &#x60;false&#x60;: serão retornadas notas que não possuírem qualquer tipo de    manifestação.    * &#x60;true&#x60;: apenas as notas que não possuírem manifestação conclusiva    serão retornadas. Ou seja, notas que tenham sido manifestadas apenas    com Ciência da Operação (210210) continuarão sendo retornadas por    esse endpoint até que recebam uma manifestação conclusiva. (optional, default to false)</param>
        /// <returns>ApiResponse of DistribuicaoNfeNotaListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeNotaListagem> ListarNfeSemManifestacaoWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), bool? conclusiva = default(bool?))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarNfeSemManifestacao");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling DistribuioNFEApi->ListarNfeSemManifestacao");
            ...
            if (conclusiva != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "conclusiva", conclusiva));
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeNotaListagem> localVarResponse = await ListarNfeSemManifestacaoWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, conclusiva, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfeNotaListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeNotaListagem>> ListarNfeSemManifestacaoWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), bool? conclusiva = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DistribuioNFEApi->ListarNfeSemManifestacao");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento> localVarResponse = ManifestarNfeWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body">Contém os dados do pedido para manifestação do destinatário.</param>
        /// <returns>ApiResponse of DistribuicaoNfeEvento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento> ManifestarNfeWithHttpInfo(DistribuicaoNfePedidoManifestacao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling DistribuioNFEApi->ManifestarNfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento> localVarResponse = await ManifestarNfeWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DistribuicaoNfeEvento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DistribuicaoNfeEvento>> ManifestarNfeWithHttpInfoAsync(DistribuicaoNfePedidoManifestacao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling DistribuioNFEApi->ManifestarNfe");
