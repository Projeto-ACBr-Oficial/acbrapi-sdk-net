...
namespace ACBrAPI.Sdk.Api
{
    ...
    public interface INfseApiSync : IApiAccessor
    {
        ...
        EmailStatusResponse EnviarEmailNfse(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail));
        ...
        ApiResponse<EmailStatusResponse> EnviarEmailNfseWithHttpInfo(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail));
        /// <summary>
    ...
    public interface INfseApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<EmailStatusResponse> EnviarEmailNfseAsync(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EmailStatusResponse>> EnviarEmailNfseWithHttpInfoAsync(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Listar lotes de NFS-e
        /// </summary>
        /// <remarks>
    ...
    public partial class NfseApi : IDisposable, INfseApi
    {
        ...
        /// <returns></returns>
        public NfseApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NfseApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NfseApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfNfseWithHttpInfo(id, logotipo, mensagemRodape);
        ...
        /// <param name="mensagemRodape">Imprime mensagem no rodapé do documento.    O caractere &#x60;|&#x60; (pipe) poderá ser utilizado para definir a quantidade e o alinhamento das mensagens.    **Exemplos de Uso:**  * &#x60;\&quot;esquerda\&quot;&#x60;  * &#x60;\&quot;esquerda|centro\&quot;&#x60;  * &#x60;\&quot;esquerda|centro|direita\&quot;&#x60;  * &#x60;\&quot;|centro\&quot;&#x60;, &#x60;\&quot;|centro|\&quot;&#x60;  * &#x60;\&quot;|centro|direita\&quot;&#x60;  * &#x60;\&quot;||direita\&quot;&#x60;  * &#x60;\&quot;esquerda||direita\&quot;&#x60;    Default: &#x60;\&quot;\&quot;&#x60; (optional)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfNfseWithHttpInfo(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->BaixarPdfNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfNfseWithHttpInfoAsync(id, logotipo, mensagemRodape, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfNfseWithHttpInfoAsync(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->BaixarPdfNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCancelamentoNfseWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCancelamentoNfseWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->BaixarXmlCancelamentoNfse");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FileParameter>("/nfse/{Id}/cancelamento/xml", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BaixarXmlCancelamentoNfse", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCancelamentoNfseWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlCancelamentoNfseWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileParameter>("/nfse/{Id}/cancelamento/xml", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlDpsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlDpsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->BaixarXmlDps");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FileParameter>("/nfse/{id}/xml/dps", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BaixarXmlDps", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlDpsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlDpsWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileParameter>("/nfse/{id}/xml/dps", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlNfseWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlNfseWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->BaixarXmlNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlNfseWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento> localVarResponse = CancelarNfseWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento> CancelarNfseWithHttpInfo(string id, NfsePedidoCancelamento body = default(NfsePedidoCancelamento))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->CancelarNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento> localVarResponse = await CancelarNfseWithHttpInfoAsync(id, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NfseCancelamento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento>> CancelarNfseWithHttpInfoAsync(string id, NfsePedidoCancelamento body = default(NfsePedidoCancelamento), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->CancelarNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCidadesAtendidas> localVarResponse = CidadesAtendidasWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of NfseCidadesAtendidas</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<NfseCidadesAtendidas> CidadesAtendidasWithHttpInfo()
        {
            ACBrAPI.Sdk.Client.RequestOptions localVarRequestOptions = new ACBrAPI.Sdk.Client.RequestOptions();
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCidadesAtendidas> localVarResponse = await CidadesAtendidasWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NfseCidadesAtendidas)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<NfseCidadesAtendidas>> CidadesAtendidasWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento> localVarResponse = ConsultarCancelamentoNfseWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento> ConsultarCancelamentoNfseWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->ConsultarCancelamentoNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCancelamento> localVarResponse = await ConsultarCancelamentoNfseWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<RpsLote> localVarResponse = ConsultarLoteNfseWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<RpsLote> ConsultarLoteNfseWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->ConsultarLoteNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<RpsLote> localVarResponse = await ConsultarLoteNfseWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCidadeMetadados> localVarResponse = ConsultarMetadadosWithHttpInfo(codigoIbge);
            return localVarResponse.Data;
        }
        ...
        /// <param name="codigoIbge">Código IBGE do município.</param>
        /// <returns>ApiResponse of NfseCidadeMetadados</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<NfseCidadeMetadados> ConsultarMetadadosWithHttpInfo(string codigoIbge)
        {
            // verify the required parameter 'codigoIbge' is set
            if (codigoIbge == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'codigoIbge' when calling NfseApi->ConsultarMetadados");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseCidadeMetadados> localVarResponse = await ConsultarMetadadosWithHttpInfoAsync(codigoIbge, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NfseCidadeMetadados)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<NfseCidadeMetadados>> ConsultarMetadadosWithHttpInfoAsync(string codigoIbge, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'codigoIbge' is set
            if (codigoIbge == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'codigoIbge' when calling NfseApi->ConsultarMetadados");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Nfse> localVarResponse = ConsultarNfseWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<Nfse> ConsultarNfseWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->ConsultarNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Nfse> localVarResponse = await ConsultarNfseWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of RpsLote</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<RpsLote> EmitirLoteNfseDpsWithHttpInfo(NfseLoteDpsPedidoEmissao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfseApi->EmitirLoteNfseDps");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<RpsLote> localVarResponse = await EmitirLoteNfseDpsWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RpsLote)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<RpsLote>> EmitirLoteNfseDpsWithHttpInfoAsync(NfseLoteDpsPedidoEmissao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfseApi->EmitirLoteNfseDps");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Nfse> localVarResponse = EmitirNfseDpsWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Nfse</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<Nfse> EmitirNfseDpsWithHttpInfo(NfseDpsPedidoEmissao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfseApi->EmitirNfseDps");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Nfse> localVarResponse = await EmitirNfseDpsWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Nfse)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<Nfse>> EmitirNfseDpsWithHttpInfoAsync(NfseDpsPedidoEmissao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfseApi->EmitirNfseDps");
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>EmailStatusResponse</returns>
        public EmailStatusResponse EnviarEmailNfse(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail))
        {
            ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse> localVarResponse = EnviarEmailNfseWithHttpInfo(id, logotipo, mensagemRodape, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of EmailStatusResponse</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse> EnviarEmailNfseWithHttpInfo(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->EnviarEmailNfse");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<EmailStatusResponse>("/nfse/{id}/email", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EnviarEmailNfse", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EmailStatusResponse</returns>
        public async System.Threading.Tasks.Task<EmailStatusResponse> EnviarEmailNfseAsync(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse> localVarResponse = await EnviarEmailNfseWithHttpInfoAsync(id, logotipo, mensagemRodape, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse>> EnviarEmailNfseWithHttpInfoAsync(string id, bool? logotipo = default(bool?), string mensagemRodape = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<EmailStatusResponse>("/nfse/{id}/email", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<RpsLoteListagem> localVarResponse = ListarLotesNfseWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia);
            return localVarResponse.Data;
        }
        ...
        /// <param name="referencia"> (optional)</param>
        /// <returns>ApiResponse of RpsLoteListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<RpsLoteListagem> ListarLotesNfseWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfseApi->ListarLotesNfse");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling NfseApi->ListarLotesNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<RpsLoteListagem> localVarResponse = await ListarLotesNfseWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, referencia, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RpsLoteListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<RpsLoteListagem>> ListarLotesNfseWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfseApi->ListarLotesNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseListagem> localVarResponse = ListarNfseWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie);
            return localVarResponse.Data;
        }
        ...
        /// <param name="serie">Série do DF-e. (optional)</param>
        /// <returns>ApiResponse of NfseListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<NfseListagem> ListarNfseWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfseApi->ListarNfse");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling NfseApi->ListarNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseListagem> localVarResponse = await ListarNfseWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NfseListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<NfseListagem>> ListarNfseWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfseApi->ListarNfse");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseSincronizacao> localVarResponse = SincronizarNfseWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<NfseSincronizacao> SincronizarNfseWithHttpInfo(string id, NfsePedidoSincronizacao body = default(NfsePedidoSincronizacao))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->SincronizarNfse");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<NfseSincronizacao>("/nfse/{id}/sincronizar", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("SincronizarNfse", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<NfseSincronizacao> localVarResponse = await SincronizarNfseWithHttpInfoAsync(id, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NfseSincronizacao)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<NfseSincronizacao>> SincronizarNfseWithHttpInfoAsync(string id, NfsePedidoSincronizacao body = default(NfsePedidoSincronizacao), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfseApi->SincronizarNfse");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<NfseSincronizacao>("/nfse/{id}/sincronizar", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
