...
namespace ACBrAPI.Sdk.Api
{
    ...
    public partial class CteOsApi : IDisposable, ICteOsApi
    {
        ...
        /// <returns></returns>
        public CteOsApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public CteOsApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public CteOsApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfCancelamentoCteOsWithHttpInfo(id);
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfCancelamentoCteOsWithHttpInfo(string id)
        {
            ...
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarPdfCancelamentoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfCancelamentoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfCartaCorrecaoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfCartaCorrecaoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarPdfCartaCorrecaoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfCartaCorrecaoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfCteOsWithHttpInfo(id, logotipo);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfCteOsWithHttpInfo(string id, bool? logotipo = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarPdfCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfCteOsWithHttpInfoAsync(id, logotipo, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfCteOsWithHttpInfoAsync(string id, bool? logotipo = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarPdfCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfEventoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfEventoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarPdfEventoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfEventoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCancelamentoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCancelamentoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarXmlCancelamentoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCancelamentoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCartaCorrecaoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCartaCorrecaoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarXmlCartaCorrecaoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCartaCorrecaoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <summary>
        /// Baixar XML do CT-e OS processado Utilize esse endpoint para obter o XML do conhecimento enviado para a SEFAZ, complementado com a informação do protocolo de autorização de uso (TAG raiz &#x60;cteProc&#x60;).    O XML só estará disponível nesse endpoint caso o conhecimento tenha sido autorizado pela SEFAZ. Para obter o XML nos demais casos, utilize o endpoint &#x60;GET /cteos/{id}/xml/conhecimento&#x60;.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único do CT-e OS gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarXmlCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <summary>
        /// Baixar XML do CT-e OS Utilize esse endpoint para obter o XML do conhecimento enviado para a SEFAZ.    O XML estará disponível nesse endpoint mesmo em casos que o conhecimento tenha sido rejeitado.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da CT-e OS gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCteOsConhecimentoWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCteOsConhecimentoWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarXmlCteOsConhecimento");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCteOsConhecimentoWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCteOsProtocoloWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCteOsProtocoloWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarXmlCteOsProtocolo");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCteOsProtocoloWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlEventoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlEventoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->BaixarXmlEventoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlEventoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <summary>
        /// Cancelar um CT-e OS autorizado **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único do CT-e OS gerado pela API.</param>
        /// <param name="body"> (optional)</param>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = CancelarCteOsWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> CancelarCteOsWithHttpInfo(string id, CteOsPedidoCancelamento body = default(CteOsPedidoCancelamento))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->CancelarCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = await CancelarCteOsWithHttpInfoAsync(id, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeCancelamento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento>> CancelarCteOsWithHttpInfoAsync(string id, CteOsPedidoCancelamento body = default(CteOsPedidoCancelamento), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->CancelarCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = ConsultarCancelamentoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> ConsultarCancelamentoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->ConsultarCancelamentoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = await ConsultarCancelamentoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao> localVarResponse = ConsultarCartaCorrecaoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao> ConsultarCartaCorrecaoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->ConsultarCartaCorrecaoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao> localVarResponse = await ConsultarCartaCorrecaoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = ConsultarCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<Dfe> ConsultarCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->ConsultarCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = await ConsultarCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeEvento> localVarResponse = ConsultarEventoCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<DfeEvento> ConsultarEventoCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->ConsultarEventoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeEvento> localVarResponse = await ConsultarEventoCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> localVarResponse = ConsultarStatusSefazCteOsWithHttpInfo(cpfCnpj, autorizador);
            return localVarResponse.Data;
        }
        ...
        /// <param name="autorizador">Ambiente Autorizador.    Autorizadores disponíveis: &#x60;MT&#x60;, &#x60;MS&#x60;, &#x60;MG&#x60;, &#x60;PR&#x60;, &#x60;RS&#x60;, &#x60;SP&#x60;, &#x60;SVRS&#x60;, &#x60;SVSP&#x60;, &#x60;AN&#x60;.    *Caso não seja informado, será utilizado o ambiente autorizador da UF do emitente.* (optional)</param>
        /// <returns>ApiResponse of DfeSefazStatus</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> ConsultarStatusSefazCteOsWithHttpInfo(string cpfCnpj, string autorizador = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling CteOsApi->ConsultarStatusSefazCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> localVarResponse = await ConsultarStatusSefazCteOsWithHttpInfoAsync(cpfCnpj, autorizador, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeSefazStatus)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus>> ConsultarStatusSefazCteOsWithHttpInfoAsync(string cpfCnpj, string autorizador = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling CteOsApi->ConsultarStatusSefazCteOs");
        ...
        /// <summary>
        /// Solicitar correção do CT-e OS É possível enviar até 20 correções diferentes, sendo que será válido sempre a última correção enviada.    **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único do CT-e OS gerado pela API.</param>
        /// <param name="body"></param>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao> localVarResponse = CriarCartaCorrecaoCteOsWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao> CriarCartaCorrecaoCteOsWithHttpInfo(string id, CteOsPedidoCartaCorrecao body)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->CriarCartaCorrecaoCteOs");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling CteOsApi->CriarCartaCorrecaoCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao> localVarResponse = await CriarCartaCorrecaoCteOsWithHttpInfoAsync(id, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CteOsCartaCorrecao)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<CteOsCartaCorrecao>> CriarCartaCorrecaoCteOsWithHttpInfoAsync(string id, CteOsPedidoCartaCorrecao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->CriarCartaCorrecaoCteOs");
        ...
        /// <summary>
        /// Emitir CT-e OS **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <returns>Dfe</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = EmitirCteOsWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Dfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<Dfe> EmitirCteOsWithHttpInfo(CteOsPedidoEmissao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling CteOsApi->EmitirCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = await EmitirCteOsWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<Dfe>> EmitirCteOsWithHttpInfoAsync(CteOsPedidoEmissao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling CteOsApi->EmitirCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> localVarResponse = ListarCteOsWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie);
            return localVarResponse.Data;
        }
        ...
        /// <param name="serie">Série do DF-e. (optional)</param>
        /// <returns>ApiResponse of DfeListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> ListarCteOsWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling CteOsApi->ListarCteOs");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling CteOsApi->ListarCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> localVarResponse = await ListarCteOsWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeListagem>> ListarCteOsWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling CteOsApi->ListarCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao> localVarResponse = SincronizarCteOsWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao> SincronizarCteOsWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling CteOsApi->SincronizarCteOs");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao> localVarResponse = await SincronizarCteOsWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
