...
namespace ACBrAPI.Sdk.Api
{
    ...
    public interface INfceApiSync : IApiAccessor
    {
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        ApiResponse<FileParameter> BaixarPdfNfceWithHttpInfo(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string));
        /// <summary>
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>FileParameter</returns>
        FileParameter BaixarPreviaPdfNfce(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string));
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        ApiResponse<FileParameter> BaixarPreviaPdfNfceWithHttpInfo(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string));
        /// <summary>
        ...
        /// <param name="autorizador">Ambiente Autorizador.    Autorizadores disponíveis: &#x60;AM&#x60;, &#x60;BA&#x60;, &#x60;CE&#x60;, &#x60;GO&#x60;, &#x60;MG&#x60;, &#x60;MS&#x60;, &#x60;MT&#x60;, &#x60;PE&#x60;, &#x60;PR&#x60;, &#x60;RS&#x60;, &#x60;SP&#x60;, &#x60;SVRS&#x60;.    *Caso não seja informado, será utilizado o ambiente autorizador da UF do emitente.* (optional)</param>
        ...
        EmailStatusResponse EnviarEmailNfce(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail));
        ...
        ApiResponse<EmailStatusResponse> EnviarEmailNfceWithHttpInfo(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail));
        /// <summary>
    ...
    public interface INfceApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        System.Threading.Tasks.Task<FileParameter> BaixarPdfNfceAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> BaixarPdfNfceWithHttpInfoAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Prévia do PDF do DANFCE
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        System.Threading.Tasks.Task<FileParameter> BaixarPreviaPdfNfceAsync(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> BaixarPreviaPdfNfceWithHttpInfoAsync(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Prévia do XML da NFC-e
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<EmailStatusResponse> EnviarEmailNfceAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EmailStatusResponse>> EnviarEmailNfceWithHttpInfoAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Inutilizar uma sequência de numeração de NFC-e
        /// </summary>
        /// <remarks>
    ...
    public partial class NfceApi : IDisposable, INfceApi
    {
        ...
        /// <returns></returns>
        public NfceApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public NfceApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public NfceApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarEscPosNfceWithHttpInfo(id, modelo, colunas, qrcodeLateral);
        ...
        /// <param name="qrcodeLateral">Imprime o QRCode na lateral do DANFCe.    OBS: não suportado por alguns modelos de impressora. (optional, default to false)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarEscPosNfceWithHttpInfo(string id, int? modelo = default(int?), int? colunas = default(int?), bool? qrcodeLateral = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarEscPosNfce");
            ...
            if (modelo != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "modelo", modelo));
            }
            if (colunas != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "colunas", colunas));
            }
            if (qrcodeLateral != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "qrcode_lateral", qrcodeLateral));
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarEscPosNfceWithHttpInfoAsync(id, modelo, colunas, qrcodeLateral, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfCancelamentoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfCancelamentoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfCancelamentoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfCancelamentoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfCancelamentoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfCancelamentoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfEventoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfEventoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfEventoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfEventoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfEventoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfEventoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfInutilizacaoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfInutilizacaoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfInutilizacaoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfInutilizacaoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfInutilizacaoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfInutilizacaoNfce");
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>FileParameter</returns>
        public FileParameter BaixarPdfNfce(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string))
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfNfceWithHttpInfo(id, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem);
            return localVarResponse.Data;
        }
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfNfceWithHttpInfo(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfNfce");
            ...
            if (resumido != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "resumido", resumido));
            }
            if (qrcodeLateral != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "qrcode_lateral", qrcodeLateral));
            ...
            if (largura != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "largura", largura));
            }
            if (margem != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "margem", margem));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> BaixarPdfNfceAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfNfceWithHttpInfoAsync(id, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfNfceWithHttpInfoAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarPdfNfce");
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>FileParameter</returns>
        public FileParameter BaixarPreviaPdfNfce(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string))
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPreviaPdfNfceWithHttpInfo(body, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem);
            return localVarResponse.Data;
        }
        ...
        /// <param name="margem">Define as margens do DANFE NFC-e (em milímetros).    Essa propriedade pode ser especificada usando um, dois, três ou quatro valores (separados por vírgulas). Cada valor deve ser um número entre &#x60;0&#x60; e &#x60;9&#x60;.  * Quando **um** valor é especificado, a mesma margem é aplicada para **todos os quatro lados**.  * Quando **dois** valores são especificados, a primeira margem é aplicada aos **lados esquerdo e direito**, e a segunda aos **lados superior e inferior**.  * Quando **três** valores são especificados, a primeira margem é aplicada ao **lado esquerdo**, a segunda aos **lados superior e inferior**, e a terceira ao **lado direito**.  * Quando **quatro** valores são especificados, as margens são aplicadas aos lados **esquerdo**, **superior**, **direito** e **inferior**, nesta ordem (sentido horário).    **Exemplos de uso**:  * &#x60;margem&#x3D;1&#x60;    - Margem esquerda: 1mm    - Margem superior: 1mm    - Margem direita: 1mm    - Margem inferior: 1mm  * &#x60;margem&#x3D;1,2&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 1mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 2mm  * &#x60;margem&#x3D;1,2,3,4&#x60;    - Margem esquerda: 1mm    - Margem superior: 2mm    - Margem direita: 3mm    - Margem inferior: 4mm (optional, default to &quot;2&quot;)</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPreviaPdfNfceWithHttpInfo(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->BaixarPreviaPdfNfce");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> BaixarPreviaPdfNfceAsync(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPreviaPdfNfceWithHttpInfoAsync(body, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPreviaPdfNfceWithHttpInfoAsync(NfePedidoEmissao body, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->BaixarPreviaPdfNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPreviaXmlNfceWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPreviaXmlNfceWithHttpInfo(NfePedidoEmissao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->BaixarPreviaXmlNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPreviaXmlNfceWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPreviaXmlNfceWithHttpInfoAsync(NfePedidoEmissao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->BaixarPreviaXmlNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCancelamentoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCancelamentoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlCancelamentoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCancelamentoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlCancelamentoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlCancelamentoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlEventoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlEventoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlEventoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlEventoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlEventoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlEventoNfce");
        ...
        /// <summary>
        /// Baixar XML da inutilização **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlInutilizacaoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlInutilizacaoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlInutilizacaoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlInutilizacaoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlInutilizacaoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlInutilizacaoNfce");
        ...
        /// <summary>
        /// Baixar XML da NFC-e processada Utilize esse endpoint para obter o XML da nota enviado para a SEFAZ, complementado com a informação do protocolo de autorização ou denegação de uso (TAG raiz &#x60;nfeProc&#x60;).    O XML só estará disponível nesse endpoint caso a nota tenha sido autorizada ou denegada pela SEFAZ. Para obter o XML nos demais casos, utilize o endpoint &#x60;GET /nfce/{id}/xml/nota&#x60;.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlNfce");
        ...
        /// <summary>
        /// Baixar XML da NFC-e Utilize esse endpoint para obter o XML da nota enviado para a SEFAZ.    O XML estará disponível nesse endpoint mesmo em casos que a nota tenha sido rejeitada.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlNfceNotaWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlNfceNotaWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlNfceNota");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlNfceNotaWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlNfceNotaWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlNfceNota");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlNfceProtocoloWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlNfceProtocoloWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlNfceProtocolo");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlNfceProtocoloWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlNfceProtocoloWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->BaixarXmlNfceProtocolo");
        ...
        /// <summary>
        /// Cancelar uma NFC-e autorizada **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <param name="body"> (optional)</param>
        ...
        public ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> CancelarNfceWithHttpInfo(string id, NfePedidoCancelamento body = default(NfePedidoCancelamento))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->CancelarNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = ConsultarCancelamentoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of DfeCancelamento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> ConsultarCancelamentoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarCancelamentoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = await ConsultarCancelamentoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeCancelamento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento>> ConsultarCancelamentoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarCancelamentoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeEvento> localVarResponse = ConsultarEventoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>ApiResponse of DfeEvento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeEvento> ConsultarEventoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarEventoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeEvento> localVarResponse = await ConsultarEventoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeEvento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeEvento>> ConsultarEventoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarEventoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao> localVarResponse = ConsultarInutilizacaoNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do evento gerado pela API.</param>
        /// <returns>ApiResponse of DfeInutilizacao</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao> ConsultarInutilizacaoNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarInutilizacaoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao> localVarResponse = await ConsultarInutilizacaoNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeInutilizacao)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao>> ConsultarInutilizacaoNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarInutilizacaoNfce");
        ...
        /// <summary>
        /// Consultar lote de NFC-e Consulta os detalhes de um lote já existente. Forneça o ID único obtido de uma requisição de emissão ou de listagem de lotes e a API irá retornar as informações do lote correspondente.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único do lote gerado pela API.</param>
        /// <returns>DfeLote</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeLote> localVarResponse = ConsultarLoteNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único do lote gerado pela API.</param>
        /// <returns>ApiResponse of DfeLote</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeLote> ConsultarLoteNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarLoteNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeLote> localVarResponse = await ConsultarLoteNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeLote)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeLote>> ConsultarLoteNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarLoteNfce");
        ...
        /// <summary>
        /// Consultar NFC-e Consulta os detalhes de uma NFC-e já existente. Forneça o ID único obtido de uma requisição de emissão ou de listagem de notas e a API irá retornar as informações da nota correspondente.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>Dfe</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = ConsultarNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of Dfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<Dfe> ConsultarNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = await ConsultarNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<Dfe>> ConsultarNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->ConsultarNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> localVarResponse = ConsultarStatusSefazNfceWithHttpInfo(cpfCnpj, autorizador);
            return localVarResponse.Data;
        }
        ...
        /// <param name="autorizador">Ambiente Autorizador.    Autorizadores disponíveis: &#x60;AM&#x60;, &#x60;BA&#x60;, &#x60;CE&#x60;, &#x60;GO&#x60;, &#x60;MG&#x60;, &#x60;MS&#x60;, &#x60;MT&#x60;, &#x60;PE&#x60;, &#x60;PR&#x60;, &#x60;RS&#x60;, &#x60;SP&#x60;, &#x60;SVRS&#x60;.    *Caso não seja informado, será utilizado o ambiente autorizador da UF do emitente.* (optional)</param>
        /// <returns>ApiResponse of DfeSefazStatus</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> ConsultarStatusSefazNfceWithHttpInfo(string cpfCnpj, string autorizador = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfceApi->ConsultarStatusSefazNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> localVarResponse = await ConsultarStatusSefazNfceWithHttpInfoAsync(cpfCnpj, autorizador, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeSefazStatus)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus>> ConsultarStatusSefazNfceWithHttpInfoAsync(string cpfCnpj, string autorizador = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfceApi->ConsultarStatusSefazNfce");
        ...
        /// <summary>
        /// Emitir lote de NFC-e **Informações adicionais**:  - Consumo: 1 unidade por NFC-e.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <returns>DfeLote</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeLote> localVarResponse = EmitirLoteNfceWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of DfeLote</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeLote> EmitirLoteNfceWithHttpInfo(NfePedidoEmissaoLote body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->EmitirLoteNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeLote> localVarResponse = await EmitirLoteNfceWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeLote)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeLote>> EmitirLoteNfceWithHttpInfoAsync(NfePedidoEmissaoLote body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->EmitirLoteNfce");
        ...
        /// <summary>
        /// Emitir NFC-e **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <returns>Dfe</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = EmitirNfceWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Dfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<Dfe> EmitirNfceWithHttpInfo(NfePedidoEmissao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->EmitirNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = await EmitirNfceWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<Dfe>> EmitirNfceWithHttpInfoAsync(NfePedidoEmissao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->EmitirNfce");
        ...
        /// <summary>
        /// Enviar e-mail Envia o XML e PDF da nota via email.    **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <param name="logotipo">Imprime o documento com logotipo, desde que esteja cadastrado na empresa. (optional, default to false)</param>
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>EmailStatusResponse</returns>
        public EmailStatusResponse EnviarEmailNfce(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail))
        {
            ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse> localVarResponse = EnviarEmailNfceWithHttpInfo(id, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of EmailStatusResponse</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse> EnviarEmailNfceWithHttpInfo(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->EnviarEmailNfce");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<EmailStatusResponse>("/nfce/{id}/email", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("EnviarEmailNfce", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EmailStatusResponse</returns>
        public async System.Threading.Tasks.Task<EmailStatusResponse> EnviarEmailNfceAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse> localVarResponse = await EnviarEmailNfceWithHttpInfoAsync(id, logotipo, nomeFantasia, mensagemRodape, resumido, qrcodeLateral, largura, margem, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<EmailStatusResponse>> EnviarEmailNfceWithHttpInfoAsync(string id, bool? logotipo = default(bool?), bool? nomeFantasia = default(bool?), string mensagemRodape = default(string), bool? resumido = default(bool?), bool? qrcodeLateral = default(bool?), int? largura = default(int?), string margem = default(string), DfePedidoEnvioEmail body = default(DfePedidoEnvioEmail), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<EmailStatusResponse>("/nfce/{id}/email", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Inutilizar uma sequência de numeração de NFC-e **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <returns>DfeInutilizacao</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao> localVarResponse = InutilizarNumeracaoNfceWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of DfeInutilizacao</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao> InutilizarNumeracaoNfceWithHttpInfo(DfePedidoInutilizacao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->InutilizarNumeracaoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao> localVarResponse = await InutilizarNumeracaoNfceWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeInutilizacao)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeInutilizacao>> InutilizarNumeracaoNfceWithHttpInfoAsync(DfePedidoInutilizacao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling NfceApi->InutilizarNumeracaoNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeEventoListagem> localVarResponse = ListarEventosNfceWithHttpInfo(dfeId, top, skip, inlinecount);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inlinecount">Inclui no JSON de resposta, na propriedade &#x60;@count&#x60;, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (optional, default to false)</param>
        /// <returns>ApiResponse of DfeEventoListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeEventoListagem> ListarEventosNfceWithHttpInfo(string dfeId, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?))
        {
            // verify the required parameter 'dfeId' is set
            if (dfeId == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'dfeId' when calling NfceApi->ListarEventosNfce");
            ...
            localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "dfe_id", dfeId));
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeEventoListagem> localVarResponse = await ListarEventosNfceWithHttpInfoAsync(dfeId, top, skip, inlinecount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeLoteListagem> localVarResponse = ListarLotesNfceWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia);
            return localVarResponse.Data;
        }
        ...
        /// <param name="referencia"> (optional)</param>
        /// <returns>ApiResponse of DfeLoteListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeLoteListagem> ListarLotesNfceWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfceApi->ListarLotesNfce");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling NfceApi->ListarLotesNfce");
            ...
            if (referencia != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "referencia", referencia));
            }
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeLoteListagem> localVarResponse = await ListarLotesNfceWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, referencia, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeLoteListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeLoteListagem>> ListarLotesNfceWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfceApi->ListarLotesNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> localVarResponse = ListarNfceWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie);
            return localVarResponse.Data;
        }
        ...
        /// <param name="serie">Série do DF-e. (optional)</param>
        /// <returns>ApiResponse of DfeListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> ListarNfceWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfceApi->ListarNfce");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling NfceApi->ListarNfce");
            ...
            if (chave != null)
            {
                localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "chave", chave));
            }
            if (serie != null)
            {
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> localVarResponse = await ListarNfceWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeListagem>> ListarNfceWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling NfceApi->ListarNfce");
        ...
        /// <summary>
        /// Sincroniza dados na NFC-e a partir da SEFAZ Realiza a sincronização dos dados a partir da consulta da situação atual da NFC-e na Base de Dados do Portal da Secretaria de Fazenda Estadual.    **Cenários de uso**:  * Sincronizar uma nota que se encontra com o status &#x60;erro&#x60; na API, mas está autorizada na SEFAZ (útil em casos de erros de transmissão com a SEFAZ, como instabilidades e timeouts).  * Sincronizar uma nota que se encontra com o status &#x60;autorizado&#x60;na API, mas está cancelada na SEFAZ.  * Sincronizar todos os eventos de Cancelamento, Carta de Correção e EPEC de uma nota que porventura não tenham sido feitos a partir da API.    **Informações adicionais**:  - Consumo: 1 unidade por evento sincronizado ou requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>DfeSincronizacao</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao> localVarResponse = SincronizarNfceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da NFC-e gerado pela API.</param>
        /// <returns>ApiResponse of DfeSincronizacao</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao> SincronizarNfceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->SincronizarNfce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao> localVarResponse = await SincronizarNfceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeSincronizacao)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeSincronizacao>> SincronizarNfceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NfceApi->SincronizarNfce");
