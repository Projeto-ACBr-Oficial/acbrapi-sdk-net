...
namespace ACBrAPI.Sdk.Api
{
    ...
    public partial class CnpjApi : IDisposable, ICnpjApi
    {
        ...
        /// <returns></returns>
        public CnpjApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public CnpjApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public CnpjApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CnpjEmpresa> localVarResponse = ConsultarCnpjWithHttpInfo(cnpj);
        ...
        /// <param name="cnpj">CNPJ sem máscara.</param>
        /// <returns>ApiResponse of CnpjEmpresa</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<CnpjEmpresa> ConsultarCnpjWithHttpInfo(string cnpj)
        {
            // verify the required parameter 'cnpj' is set
            if (cnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cnpj' when calling CnpjApi->ConsultarCnpj");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CnpjEmpresa> localVarResponse = await ConsultarCnpjWithHttpInfoAsync(cnpj, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CnpjEmpresa)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<CnpjEmpresa>> ConsultarCnpjWithHttpInfoAsync(string cnpj, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cnpj' is set
            if (cnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cnpj' when calling CnpjApi->ConsultarCnpj");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CnpjListagem> localVarResponse = ListarCnpjWithHttpInfo(cnaePrincipal, municipio, naturezaJuridica, top, skip, inlinecount);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inlinecount">Inclui no JSON de resposta, na propriedade &#x60;@count&#x60;, o número total de registros que o filtro retornaria, independente dos filtros de paginação. (optional, default to false)</param>
        /// <returns>ApiResponse of CnpjListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<CnpjListagem> ListarCnpjWithHttpInfo(string cnaePrincipal, string municipio, string naturezaJuridica, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?))
        {
            // verify the required parameter 'cnaePrincipal' is set
            if (cnaePrincipal == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cnaePrincipal' when calling CnpjApi->ListarCnpj");

            // verify the required parameter 'municipio' is set
            if (municipio == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'municipio' when calling CnpjApi->ListarCnpj");

            // verify the required parameter 'naturezaJuridica' is set
            if (naturezaJuridica == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'naturezaJuridica' when calling CnpjApi->ListarCnpj");
            ...
            localVarRequestOptions.QueryParameters.Add(ACBrAPI.Sdk.Client.ClientUtils.ParameterToMultiMap("", "cnae_principal", cnaePrincipal));
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CnpjListagem> localVarResponse = await ListarCnpjWithHttpInfoAsync(cnaePrincipal, municipio, naturezaJuridica, top, skip, inlinecount, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CnpjListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<CnpjListagem>> ListarCnpjWithHttpInfoAsync(string cnaePrincipal, string municipio, string naturezaJuridica, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cnaePrincipal' is set
            if (cnaePrincipal == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cnaePrincipal' when calling CnpjApi->ListarCnpj");
