...
namespace ACBrAPI.Sdk.Api
{
    ...
    public partial class CepApi : IDisposable, ICepApi
    {
        ...
        /// <returns></returns>
        public CepApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public CepApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public CepApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CepEndereco> localVarResponse = ConsultarCepWithHttpInfo(cep);
        ...
        /// <param name="cep">CEP sem máscara.</param>
        /// <returns>ApiResponse of CepEndereco</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<CepEndereco> ConsultarCepWithHttpInfo(string cep)
        {
            // verify the required parameter 'cep' is set
            if (cep == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cep' when calling CepApi->ConsultarCep");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<CepEndereco> localVarResponse = await ConsultarCepWithHttpInfoAsync(cep, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CepEndereco)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<CepEndereco>> ConsultarCepWithHttpInfoAsync(string cep, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cep' is set
            if (cep == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cep' when calling CepApi->ConsultarCep");
