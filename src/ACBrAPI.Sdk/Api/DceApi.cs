...
namespace ACBrAPI.Sdk.Api
{
    ...
    public interface IDceApiSync : IApiAccessor
    {
        ...
        /// <param name="id">ID único da DC-e gerado pela API.</param>
        ...
        /// </remarks>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>FileParameter</returns>
    ...
    public partial class DceApi : IDisposable, IDceApi
    {
        ...
        /// <returns></returns>
        public DceApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DceApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DceApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarPdfDceWithHttpInfo(id);
        ...
        /// <param name="id">ID único da DC-e gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarPdfDceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarPdfDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarPdfDceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarPdfDceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarPdfDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlCancelamentoDceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlCancelamentoDceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlCancelamentoDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlCancelamentoDceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlCancelamentoDceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlCancelamentoDce");
        ...
        /// <summary>
        /// Baixar XML da DC-e processada Utilize esse endpoint para obter o XML da DC-e enviada para a SEFAZ, complementado com a informação do protocolo de autorização de uso (TAG raiz &#x60;dceProc&#x60;).    O XML só estará disponível nesse endpoint caso a DC-e tenha sido autorizada pela SEFAZ. Para obter o XML nos demais casos, utilize o endpoint &#x60;GET /dce/{id}/xml/declaracao&#x60;.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlDceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlDceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlDceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlDceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlDce");
        ...
        /// <summary>
        /// Baixar XML da DC-e Utilize esse endpoint para obter o XML da DC-e enviada para a SEFAZ.    O XML estará disponível nesse endpoint mesmo em casos que a declaração tenha sido rejeitada.    **Informações adicionais**:  - Consumo: Primeira requisição isenta, posteriores 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlDceDeclaracaoWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlDceDeclaracaoWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlDceDeclaracao");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlDceDeclaracaoWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlDceDeclaracaoWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlDceDeclaracao");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = BaixarXmlDceProtocoloWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> BaixarXmlDceProtocoloWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlDceProtocolo");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await BaixarXmlDceProtocoloWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> BaixarXmlDceProtocoloWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->BaixarXmlDceProtocolo");
        ...
        /// <summary>
        /// Cancelar uma DC-e autorizada **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <param name="body"> (optional)</param>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = CancelarDceWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of DfeCancelamento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> CancelarDceWithHttpInfo(string id, DcePedidoCancelamento body = default(DcePedidoCancelamento))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->CancelarDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = await CancelarDceWithHttpInfoAsync(id, body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeCancelamento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento>> CancelarDceWithHttpInfoAsync(string id, DcePedidoCancelamento body = default(DcePedidoCancelamento), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->CancelarDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = ConsultarCancelamentoDceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>ApiResponse of DfeCancelamento</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> ConsultarCancelamentoDceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->ConsultarCancelamentoDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento> localVarResponse = await ConsultarCancelamentoDceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeCancelamento)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeCancelamento>> ConsultarCancelamentoDceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->ConsultarCancelamentoDce");
        ...
        /// <summary>
        /// Consultar DC-e Consulta os detalhes de uma DC-e já existente. Forneça o ID único obtido de uma requisição de emissão ou de listagem de DC-e e a API irá retornar as informações da DC-e correspondente.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>Dfe</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = ConsultarDceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID único da DC-e gerada pela API.</param>
        /// <returns>ApiResponse of Dfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<Dfe> ConsultarDceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->ConsultarDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = await ConsultarDceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<Dfe>> ConsultarDceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DceApi->ConsultarDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> localVarResponse = ConsultarStatusSefazDceWithHttpInfo(cpfCnpj, autorizador);
            return localVarResponse.Data;
        }
        ...
        /// <param name="autorizador">Ambiente Autorizador.    Autorizadores disponíveis: &#x60;AN&#x60;.    *Caso não seja informado, será utilizado o ambiente autorizador da UF do emitente.* (optional)</param>
        /// <returns>ApiResponse of DfeSefazStatus</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> ConsultarStatusSefazDceWithHttpInfo(string cpfCnpj, string autorizador = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DceApi->ConsultarStatusSefazDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus> localVarResponse = await ConsultarStatusSefazDceWithHttpInfoAsync(cpfCnpj, autorizador, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeSefazStatus)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeSefazStatus>> ConsultarStatusSefazDceWithHttpInfoAsync(string cpfCnpj, string autorizador = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DceApi->ConsultarStatusSefazDce");
        ...
        /// <summary>
        /// Emitir DC-e **Informações adicionais**:  - Consumo: 1 unidade por requisição.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <returns>Dfe</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = EmitirDceWithHttpInfo(body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Dfe</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<Dfe> EmitirDceWithHttpInfo(DcePedidoEmissao body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling DceApi->EmitirDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<Dfe> localVarResponse = await EmitirDceWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dfe)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<Dfe>> EmitirDceWithHttpInfoAsync(DcePedidoEmissao body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling DceApi->EmitirDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> localVarResponse = ListarDceWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie);
            return localVarResponse.Data;
        }
        ...
        /// <param name="serie">Série do DF-e. (optional)</param>
        /// <returns>ApiResponse of DfeListagem</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> ListarDceWithHttpInfo(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DceApi->ListarDce");

            // verify the required parameter 'ambiente' is set
            if (ambiente == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'ambiente' when calling DceApi->ListarDce");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeListagem> localVarResponse = await ListarDceWithHttpInfoAsync(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeListagem)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeListagem>> ListarDceWithHttpInfoAsync(string cpfCnpj, string ambiente, int? top = default(int?), int? skip = default(int?), bool? inlinecount = default(bool?), string referencia = default(string), string chave = default(string), string serie = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'cpfCnpj' is set
            if (cpfCnpj == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'cpfCnpj' when calling DceApi->ListarDce");
