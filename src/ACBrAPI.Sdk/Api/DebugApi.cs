...
namespace ACBrAPI.Sdk.Api
{
    ...
    public interface IDebugApiSync : IApiAccessor
    {
        ...
        /// <param name="id">ID único do documento fiscal gerado pela API.</param>
        ...
        /// </remarks>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID do documento fiscal gerado pela API.</param>
    ...
    public partial class DebugApi : IDisposable, IDebugApi
    {
        ...
        /// <returns></returns>
        public DebugApi(ACBrAPI.Sdk.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DebugApi(HttpClient client, ACBrAPI.Sdk.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DebugApi(ACBrAPI.Sdk.Client.ISynchronousClient client, ACBrAPI.Sdk.Client.IAsynchronousClient asyncClient, ACBrAPI.Sdk.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeDebug> localVarResponse = DebugDfeWithHttpInfo(id);
        ...
        /// <param name="id">ID único do documento fiscal gerado pela API.</param>
        /// <returns>ApiResponse of DfeDebug</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<DfeDebug> DebugDfeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugDfe");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<DfeDebug> localVarResponse = await DebugDfeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DfeDebug)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<DfeDebug>> DebugDfeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugDfe");
        ...
        /// <summary>
        /// Payload original recebido Este endpoint retorna o conteúdo original recebido pela API no momento da criação do documento fiscal.    **Cenários de uso**:  - Inspeção detalhada dos dados enviados à API.  - Verificação de divergências entre o payload fornecido e o processado.  - Encaminhamento do conteúdo original ao suporte da API.
        /// </summary>
        /// <exception cref="ACBrAPI.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID do documento fiscal gerado pela API.</param>
        /// <returns>FileParameter</returns>
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = DebugDfeOriginalPayloadWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID do documento fiscal gerado pela API.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> DebugDfeOriginalPayloadWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugDfeOriginalPayload");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await DebugDfeOriginalPayloadWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> DebugDfeOriginalPayloadWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugDfeOriginalPayload");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = DebugHttpRequestContentWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID da requisição HTTP.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> DebugHttpRequestContentWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugHttpRequestContent");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await DebugHttpRequestContentWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> DebugHttpRequestContentWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugHttpRequestContent");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = DebugHttpResponseContentWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID da requisição HTTP.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public ACBrAPI.Sdk.Client.ApiResponse<FileParameter> DebugHttpResponseContentWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugHttpResponseContent");
        ...
        {
            ACBrAPI.Sdk.Client.ApiResponse<FileParameter> localVarResponse = await DebugHttpResponseContentWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<ACBrAPI.Sdk.Client.ApiResponse<FileParameter>> DebugHttpResponseContentWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ACBrAPI.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling DebugApi->DebugHttpResponseContent");
