...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazEstornoCredOS")]
    public partial class CteOsSefazEstornoCredOS : IEquatable<CteOsSefazEstornoCredOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazEstornoCredOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazEstornoCredOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazEstornoCredOS" /> class.
        /// </summary>
        ...
        public CteOsSefazEstornoCredOS(decimal? vIBSEstCred = default(decimal?), decimal? vCBSEstCred = default(decimal?))
        {
            // to ensure "vIBSEstCred" is required (not null)
            if (vIBSEstCred == null)
            {
                throw new ArgumentNullException("vIBSEstCred is a required property for CteOsSefazEstornoCredOS and cannot be null");
            }
            this.vIBSEstCred = vIBSEstCred;
            // to ensure "vCBSEstCred" is required (not null)
            if (vCBSEstCred == null)
            {
                throw new ArgumentNullException("vCBSEstCred is a required property for CteOsSefazEstornoCredOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazEstornoCredOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazEstornoCredOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazEstornoCredOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazEstornoCredOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazEstornoCredOS input)
        {
            if (input == null)
            {
                return false;
