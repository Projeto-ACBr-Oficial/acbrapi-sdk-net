...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Totalização da CBS.
    /// </summary>
    [DataContract(Name = "NfeSefazIBSCBSMonoTot_GCBS")]
    public partial class NfeSefazIBSCBSMonoTotGCBS : IEquatable<NfeSefazIBSCBSMonoTotGCBS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazIBSCBSMonoTotGCBS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazIBSCBSMonoTotGCBS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazIBSCBSMonoTotGCBS" /> class.
        /// </summary>
        ...
        public NfeSefazIBSCBSMonoTotGCBS(decimal? vDif = default(decimal?), decimal? vDevTrib = default(decimal?), decimal? vCBS = default(decimal?), decimal? vCredPres = default(decimal?), decimal? vCredPresCondSus = default(decimal?))
        {
            // to ensure "vDif" is required (not null)
            if (vDif == null)
            {
                throw new ArgumentNullException("vDif is a required property for NfeSefazIBSCBSMonoTotGCBS and cannot be null");
            }
            this.vDif = vDif;
            // to ensure "vDevTrib" is required (not null)
            if (vDevTrib == null)
            {
                throw new ArgumentNullException("vDevTrib is a required property for NfeSefazIBSCBSMonoTotGCBS and cannot be null");
            }
            this.vDevTrib = vDevTrib;
            // to ensure "vCBS" is required (not null)
            if (vCBS == null)
            {
                throw new ArgumentNullException("vCBS is a required property for NfeSefazIBSCBSMonoTotGCBS and cannot be null");
            }
            this.vCBS = vCBS;
            // to ensure "vCredPres" is required (not null)
            if (vCredPres == null)
            {
                throw new ArgumentNullException("vCredPres is a required property for NfeSefazIBSCBSMonoTotGCBS and cannot be null");
            }
            this.vCredPres = vCredPres;
            // to ensure "vCredPresCondSus" is required (not null)
            if (vCredPresCondSus == null)
            {
                throw new ArgumentNullException("vCredPresCondSus is a required property for NfeSefazIBSCBSMonoTotGCBS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazIBSCBSMonoTotGCBS {\n");
        ...
        {
            return this.Equals(input as NfeSefazIBSCBSMonoTotGCBS);
        }

        /// <summary>
        /// Returns true if NfeSefazIBSCBSMonoTotGCBS instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazIBSCBSMonoTotGCBS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazIBSCBSMonoTotGCBS input)
        {
            if (input == null)
            {
                return false;
