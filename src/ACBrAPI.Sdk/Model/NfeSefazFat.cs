...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Dados da fatura.
    /// </summary>
    [DataContract(Name = "NfeSefazFat")]
    public partial class NfeSefazFat : IEquatable<NfeSefazFat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazFat" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NfeSefazFat);
        }

        /// <summary>
        /// Returns true if NfeSefazFat instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazFat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazFat input)
        {
            if (input == null)
            {
                return false;
