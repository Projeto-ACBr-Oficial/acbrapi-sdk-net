...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazICMS00")]
    public partial class NfcomSefazICMS00 : IEquatable<NfcomSefazICMS00>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazICMS00" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazICMS00() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazICMS00" /> class.
        /// </summary>
        ...
        public NfcomSefazICMS00(string cST = default(string), decimal? vBC = default(decimal?), decimal? pICMS = default(decimal?), decimal? vICMS = default(decimal?), decimal? pFCP = default(decimal?), decimal? vFCP = default(decimal?))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for NfcomSefazICMS00 and cannot be null");
            }
            this.CST = cST;
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for NfcomSefazICMS00 and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "pICMS" is required (not null)
            if (pICMS == null)
            {
                throw new ArgumentNullException("pICMS is a required property for NfcomSefazICMS00 and cannot be null");
            }
            this.pICMS = pICMS;
            // to ensure "vICMS" is required (not null)
            if (vICMS == null)
            {
                throw new ArgumentNullException("vICMS is a required property for NfcomSefazICMS00 and cannot be null");
            }
            this.vICMS = vICMS;
            this.pFCP = pFCP;
            this.vFCP = vFCP;
        ...
        {
            return this.Equals(input as NfcomSefazICMS00);
        }

        /// <summary>
        /// Returns true if NfcomSefazICMS00 instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazICMS00 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazICMS00 input)
        {
            if (input == null)
            {
                return false;
