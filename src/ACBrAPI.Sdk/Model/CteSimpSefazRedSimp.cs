...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazRedSimp")]
    public partial class CteSimpSefazRedSimp : IEquatable<CteSimpSefazRedSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazRedSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazRedSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazRedSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazRedSimp(decimal? pRedAliq = default(decimal?), decimal? pAliqEfet = default(decimal?))
        {
            // to ensure "pRedAliq" is required (not null)
            if (pRedAliq == null)
            {
                throw new ArgumentNullException("pRedAliq is a required property for CteSimpSefazRedSimp and cannot be null");
            }
            this.pRedAliq = pRedAliq;
            // to ensure "pAliqEfet" is required (not null)
            if (pAliqEfet == null)
            {
                throw new ArgumentNullException("pAliqEfet is a required property for CteSimpSefazRedSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazRedSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazRedSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazRedSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazRedSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazRedSimp input)
        {
            if (input == null)
            {
                return false;
