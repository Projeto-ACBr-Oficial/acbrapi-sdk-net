...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteSefazTribCTe : IEquatable<CteSefazTribCTe>, IValidatableObject
    {
        ...
        public CteSefazTribCTe(string cST = default(string), string cClassTrib = default(string), int? indDoacao = default(int?), CteSefazCIBS gIBSCBS = default(CteSefazCIBS), CteSefazEstornoCred gEstornoCred = default(CteSefazEstornoCred))
        {
        ...
        public CteSefazEstornoCred gEstornoCred { get; set; }
