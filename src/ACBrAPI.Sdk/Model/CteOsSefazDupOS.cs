...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazDupOS")]
    public partial class CteOsSefazDupOS : IEquatable<CteOsSefazDupOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazDupOS" /> class.
        /// </summary>
        ...
        public CteOsSefazDupOS(string nDup = default(string), DateTime? dVenc = default(DateTime?), decimal? vDup = default(decimal?))
        {
            this.nDup = nDup;
            this.dVenc = dVenc;
            this.vDup = vDup;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazDupOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazDupOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazDupOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazDupOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazDupOS input)
        {
            if (input == null)
            {
                return false;
