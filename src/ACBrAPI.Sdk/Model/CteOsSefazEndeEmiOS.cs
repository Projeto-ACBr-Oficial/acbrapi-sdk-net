...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazEndeEmiOS")]
    public partial class CteOsSefazEndeEmiOS : IEquatable<CteOsSefazEndeEmiOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazEndeEmiOS" /> class.
        /// </summary>
        ...
        public CteOsSefazEndeEmiOS(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string cEP = default(string), string uF = default(string), string fone = default(string))
        {
            this.xLgr = xLgr;
            this.nro = nro;
            this.xCpl = xCpl;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazEndeEmiOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazEndeEmiOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazEndeEmiOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazEndeEmiOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazEndeEmiOS input)
        {
            if (input == null)
            {
                return false;
