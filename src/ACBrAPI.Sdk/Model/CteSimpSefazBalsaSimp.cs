...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazBalsaSimp")]
    public partial class CteSimpSefazBalsaSimp : IEquatable<CteSimpSefazBalsaSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazBalsaSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazBalsaSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazBalsaSimp" /> class.
        /// </summary>
        /// <param name="xBalsa">Identificador da Balsa. (required).</param>
        public CteSimpSefazBalsaSimp(string xBalsa = default(string))
        {
            // to ensure "xBalsa" is required (not null)
            if (xBalsa == null)
            {
                throw new ArgumentNullException("xBalsa is a required property for CteSimpSefazBalsaSimp and cannot be null");
            }
            this.xBalsa = xBalsa;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazBalsaSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazBalsaSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazBalsaSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazBalsaSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazBalsaSimp input)
        {
            if (input == null)
            {
                return false;
