...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazTribCTeSimp")]
    public partial class CteSimpSefazTribCTeSimp : IEquatable<CteSimpSefazTribCTeSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazTribCTeSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazTribCTeSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazTribCTeSimp" /> class.
        /// </summary>
        /// <param name="cST">Código Situação Tributária do IBS/CBS. (required).</param>
        /// <param name="cClassTrib">cClassTrib.</param>
        /// <param name="indDoacao">indDoacao.</param>
        /// <param name="gIBSCBS">gIBSCBS.</param>
        /// <param name="gEstornoCred">gEstornoCred.</param>
        public CteSimpSefazTribCTeSimp(string cST = default(string), string cClassTrib = default(string), int? indDoacao = default(int?), CteSimpSefazCIBSSimp gIBSCBS = default(CteSimpSefazCIBSSimp), CteSimpSefazEstornoCredSimp gEstornoCred = default(CteSimpSefazEstornoCredSimp))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for CteSimpSefazTribCTeSimp and cannot be null");
            }
            this.CST = cST;
        ...
        public CteSimpSefazCIBSSimp gIBSCBS { get; set; }

        /// <summary>
        /// Gets or Sets gEstornoCred
        /// </summary>
        [DataMember(Name = "gEstornoCred", EmitDefaultValue = false)]
        public CteSimpSefazEstornoCredSimp gEstornoCred { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazTribCTeSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazTribCTeSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazTribCTeSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazTribCTeSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazTribCTeSimp input)
        {
            if (input == null)
            {
                return false;
