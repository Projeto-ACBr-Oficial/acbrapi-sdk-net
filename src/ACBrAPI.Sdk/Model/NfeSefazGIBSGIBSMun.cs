...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazGIBS_GIBSMun")]
    public partial class NfeSefazGIBSGIBSMun : IEquatable<NfeSefazGIBSGIBSMun>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGIBSGIBSMun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazGIBSGIBSMun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGIBSGIBSMun" /> class.
        /// </summary>
        ...
        public NfeSefazGIBSGIBSMun(decimal? vDif = default(decimal?), decimal? vDevTrib = default(decimal?), decimal? vIBSMun = default(decimal?))
        {
            // to ensure "vDif" is required (not null)
            if (vDif == null)
            {
                throw new ArgumentNullException("vDif is a required property for NfeSefazGIBSGIBSMun and cannot be null");
            }
            this.vDif = vDif;
            // to ensure "vDevTrib" is required (not null)
            if (vDevTrib == null)
            {
                throw new ArgumentNullException("vDevTrib is a required property for NfeSefazGIBSGIBSMun and cannot be null");
            }
            this.vDevTrib = vDevTrib;
            // to ensure "vIBSMun" is required (not null)
            if (vIBSMun == null)
            {
                throw new ArgumentNullException("vIBSMun is a required property for NfeSefazGIBSGIBSMun and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazGIBSGIBSMun {\n");
        ...
        {
            return this.Equals(input as NfeSefazGIBSGIBSMun);
        }

        /// <summary>
        /// Returns true if NfeSefazGIBSGIBSMun instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazGIBSGIBSMun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazGIBSGIBSMun input)
        {
            if (input == null)
            {
                return false;
