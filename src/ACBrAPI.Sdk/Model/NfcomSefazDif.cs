...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazDif")]
    public partial class NfcomSefazDif : IEquatable<NfcomSefazDif>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazDif" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazDif() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazDif" /> class.
        /// </summary>
        /// <param name="pDif">Percentual do diferimento. (required).</param>
        /// <param name="vDif">Valor do diferimento. (required).</param>
        public NfcomSefazDif(decimal? pDif = default(decimal?), decimal? vDif = default(decimal?))
        {
            // to ensure "pDif" is required (not null)
            if (pDif == null)
            {
                throw new ArgumentNullException("pDif is a required property for NfcomSefazDif and cannot be null");
            }
            this.pDif = pDif;
            // to ensure "vDif" is required (not null)
            if (vDif == null)
            {
                throw new ArgumentNullException("vDif is a required property for NfcomSefazDif and cannot be null");
            }
            this.vDif = vDif;
        }
        ...
        {
            return this.Equals(input as NfcomSefazDif);
        }

        /// <summary>
        /// Returns true if NfcomSefazDif instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazDif to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazDif input)
        {
            if (input == null)
            {
                return false;
