...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// DfeEvento
    /// </summary>
    [DataContract(Name = "DfeEvento")]
    public partial class DfeEvento : IEquatable<DfeEvento>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DfeEvento);
        }

        /// <summary>
        /// Returns true if DfeEvento instances are equal
        /// </summary>
        /// <param name="input">Instance of DfeEvento to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DfeEvento input)
        {
            if (input == null)
            {
                return false;
