...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// EmpresaConfigCteOs
    /// </summary>
    [DataContract(Name = "EmpresaConfigCteOs")]
    public partial class EmpresaConfigCteOs : IEquatable<EmpresaConfigCteOs>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmpresaConfigCteOs" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmpresaConfigCteOs() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmpresaConfigCteOs" /> class.
        /// </summary>
        ...
        public EmpresaConfigCteOs(int cRT = default(int), AmbienteEnum ambiente = default(AmbienteEnum))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmpresaConfigCteOs {\n");
        ...
        {
            return this.Equals(input as EmpresaConfigCteOs);
        }

        /// <summary>
        /// Returns true if EmpresaConfigCteOs instances are equal
        /// </summary>
        /// <param name="input">Instance of EmpresaConfigCteOs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmpresaConfigCteOs input)
        {
            if (input == null)
            {
                return false;
