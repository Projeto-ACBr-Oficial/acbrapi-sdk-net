...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazGIBSUFOS")]
    public partial class CteOsSefazGIBSUFOS : IEquatable<CteOsSefazGIBSUFOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGIBSUFOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazGIBSUFOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGIBSUFOS" /> class.
        /// </summary>
        ...
        public CteOsSefazGIBSUFOS(decimal? pIBSUF = default(decimal?), CteOsSefazDifOS gDif = default(CteOsSefazDifOS), CteOsSefazDevTribOS gDevTrib = default(CteOsSefazDevTribOS), CteOsSefazRedOS gRed = default(CteOsSefazRedOS), decimal? vIBSUF = default(decimal?))
        {
            // to ensure "pIBSUF" is required (not null)
            if (pIBSUF == null)
            {
                throw new ArgumentNullException("pIBSUF is a required property for CteOsSefazGIBSUFOS and cannot be null");
            }
            this.pIBSUF = pIBSUF;
            // to ensure "vIBSUF" is required (not null)
            if (vIBSUF == null)
            {
                throw new ArgumentNullException("vIBSUF is a required property for CteOsSefazGIBSUFOS and cannot be null");
            }
            this.vIBSUF = vIBSUF;
            this.gDif = gDif;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazGIBSUFOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazGIBSUFOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazGIBSUFOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazGIBSUFOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazGIBSUFOS input)
        {
            if (input == null)
            {
                return false;
