...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazCredPres")]
    public partial class NfeSefazCredPres : IEquatable<NfeSefazCredPres>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazCredPres" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazCredPres() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazCredPres" /> class.
        /// </summary>
        ...
        public NfeSefazCredPres(string cCredPres = default(string), decimal? pCredPres = default(decimal?), decimal? vCredPres = default(decimal?), decimal? vCredPresCondSus = default(decimal?))
        {
            ...
            if (pCredPres == null)
            {
                throw new ArgumentNullException("pCredPres is a required property for NfeSefazCredPres and cannot be null");
            }
        ...
        {
            return this.Equals(input as NfeSefazCredPres);
        }

        /// <summary>
        /// Returns true if NfeSefazCredPres instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazCredPres to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazCredPres input)
        {
            if (input == null)
            {
                return false;
