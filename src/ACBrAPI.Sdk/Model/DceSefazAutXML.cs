...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DceSefazAutXML")]
    public partial class DceSefazAutXML : IEquatable<DceSefazAutXML>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazAutXML" /> class.
        /// </summary>
        ...
        public DceSefazAutXML(string cNPJ = default(string), string cPF = default(string))
        {
            this.CNPJ = cNPJ;
            this.CPF = cPF;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DceSefazAutXML {\n");
        ...
        {
            return this.Equals(input as DceSefazAutXML);
        }

        /// <summary>
        /// Returns true if DceSefazAutXML instances are equal
        /// </summary>
        /// <param name="input">Instance of DceSefazAutXML to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DceSefazAutXML input)
        {
            if (input == null)
            {
                return false;
