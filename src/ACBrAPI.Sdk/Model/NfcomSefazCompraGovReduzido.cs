...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazCompraGovReduzido")]
    public partial class NfcomSefazCompraGovReduzido : IEquatable<NfcomSefazCompraGovReduzido>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazCompraGovReduzido" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazCompraGovReduzido() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazCompraGovReduzido" /> class.
        /// </summary>
        ...
        public NfcomSefazCompraGovReduzido(int? tpEnteGov = default(int?), decimal? pRedutor = default(decimal?), int? tpOperGov = default(int?), List<string> refDFeAnt = default(List<string>))
        {
            // to ensure "tpEnteGov" is required (not null)
            if (tpEnteGov == null)
            {
                throw new ArgumentNullException("tpEnteGov is a required property for NfcomSefazCompraGovReduzido and cannot be null");
            }
            this.tpEnteGov = tpEnteGov;
            // to ensure "pRedutor" is required (not null)
            if (pRedutor == null)
            {
                throw new ArgumentNullException("pRedutor is a required property for NfcomSefazCompraGovReduzido and cannot be null");
            }
            this.pRedutor = pRedutor;
            // to ensure "tpOperGov" is required (not null)
            if (tpOperGov == null)
            {
                throw new ArgumentNullException("tpOperGov is a required property for NfcomSefazCompraGovReduzido and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazCompraGovReduzido {\n");
        ...
        {
            return this.Equals(input as NfcomSefazCompraGovReduzido);
        }

        /// <summary>
        /// Returns true if NfcomSefazCompraGovReduzido instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazCompraGovReduzido to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazCompraGovReduzido input)
        {
            if (input == null)
            {
                return false;
