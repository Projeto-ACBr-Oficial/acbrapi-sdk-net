...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazTribRegular")]
    public partial class CteSefazTribRegular : IEquatable<CteSefazTribRegular>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazTribRegular" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazTribRegular() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazTribRegular" /> class.
        /// </summary>
        ...
        public CteSefazTribRegular(string cSTReg = default(string), string cClassTribReg = default(string), decimal? pAliqEfetRegIBSUF = default(decimal?), decimal? vTribRegIBSUF = default(decimal?), decimal? pAliqEfetRegIBSMun = default(decimal?), decimal? vTribRegIBSMun = default(decimal?), decimal? pAliqEfetRegCBS = default(decimal?), decimal? vTribRegCBS = default(decimal?))
        {
            // to ensure "cSTReg" is required (not null)
            if (cSTReg == null)
            {
                throw new ArgumentNullException("cSTReg is a required property for CteSefazTribRegular and cannot be null");
            }
            this.CSTReg = cSTReg;
            // to ensure "cClassTribReg" is required (not null)
            if (cClassTribReg == null)
            {
                throw new ArgumentNullException("cClassTribReg is a required property for CteSefazTribRegular and cannot be null");
            }
            this.cClassTribReg = cClassTribReg;
            // to ensure "pAliqEfetRegIBSUF" is required (not null)
            if (pAliqEfetRegIBSUF == null)
            {
                throw new ArgumentNullException("pAliqEfetRegIBSUF is a required property for CteSefazTribRegular and cannot be null");
            }
            this.pAliqEfetRegIBSUF = pAliqEfetRegIBSUF;
            // to ensure "vTribRegIBSUF" is required (not null)
            if (vTribRegIBSUF == null)
            {
                throw new ArgumentNullException("vTribRegIBSUF is a required property for CteSefazTribRegular and cannot be null");
            }
            this.vTribRegIBSUF = vTribRegIBSUF;
            // to ensure "pAliqEfetRegIBSMun" is required (not null)
            if (pAliqEfetRegIBSMun == null)
            {
                throw new ArgumentNullException("pAliqEfetRegIBSMun is a required property for CteSefazTribRegular and cannot be null");
            }
            this.pAliqEfetRegIBSMun = pAliqEfetRegIBSMun;
            // to ensure "vTribRegIBSMun" is required (not null)
            if (vTribRegIBSMun == null)
            {
                throw new ArgumentNullException("vTribRegIBSMun is a required property for CteSefazTribRegular and cannot be null");
            }
            this.vTribRegIBSMun = vTribRegIBSMun;
            // to ensure "pAliqEfetRegCBS" is required (not null)
            if (pAliqEfetRegCBS == null)
            {
                throw new ArgumentNullException("pAliqEfetRegCBS is a required property for CteSefazTribRegular and cannot be null");
            }
            this.pAliqEfetRegCBS = pAliqEfetRegCBS;
            // to ensure "vTribRegCBS" is required (not null)
            if (vTribRegCBS == null)
            {
                throw new ArgumentNullException("vTribRegCBS is a required property for CteSefazTribRegular and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazTribRegular {\n");
        ...
        {
            return this.Equals(input as CteSefazTribRegular);
        }

        /// <summary>
        /// Returns true if CteSefazTribRegular instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazTribRegular to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazTribRegular input)
        {
            if (input == null)
            {
                return false;
