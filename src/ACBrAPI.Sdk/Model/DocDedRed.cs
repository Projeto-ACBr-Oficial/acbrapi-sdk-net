...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class DocDedRed : IEquatable<DocDedRed>, IValidatableObject
    {
        ...
        /// <param name="tpDedRed">Identificação da Dedução/Redução:  * 1 - Alimentação e bebidas/frigobar  * 2 - Materiais  * 3 - Produção Externa  * 4 - Reembolso de despesas  * 5 - Repasse consorciado  * 6 - Repasse plano de saúde  * 7 - Serviços  * 8 - Subempreitada de mão de obra  * 9 - Profissional parceiro  * 99 - Outras deduções (required).</param>
        ...
        /// <summary>
        /// Identificação da Dedução/Redução:  * 1 - Alimentação e bebidas/frigobar  * 2 - Materiais  * 3 - Produção Externa  * 4 - Reembolso de despesas  * 5 - Repasse consorciado  * 6 - Repasse plano de saúde  * 7 - Serviços  * 8 - Subempreitada de mão de obra  * 9 - Profissional parceiro  * 99 - Outras deduções
        /// </summary>
        /// <value>Identificação da Dedução/Redução:  * 1 - Alimentação e bebidas/frigobar  * 2 - Materiais  * 3 - Produção Externa  * 4 - Reembolso de despesas  * 5 - Repasse consorciado  * 6 - Repasse plano de saúde  * 7 - Serviços  * 8 - Subempreitada de mão de obra  * 9 - Profissional parceiro  * 99 - Outras deduções</value>
