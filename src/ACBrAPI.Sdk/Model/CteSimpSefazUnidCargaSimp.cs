...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazUnidCargaSimp")]
    public partial class CteSimpSefazUnidCargaSimp : IEquatable<CteSimpSefazUnidCargaSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazUnidCargaSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazUnidCargaSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazUnidCargaSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazUnidCargaSimp(int? tpUnidCarga = default(int?), string idUnidCarga = default(string), List<CteSimpSefazLacUnidCargaSimp> lacUnidCarga = default(List<CteSimpSefazLacUnidCargaSimp>), decimal? qtdRat = default(decimal?))
        {
            // to ensure "tpUnidCarga" is required (not null)
            if (tpUnidCarga == null)
            {
                throw new ArgumentNullException("tpUnidCarga is a required property for CteSimpSefazUnidCargaSimp and cannot be null");
            }
            this.tpUnidCarga = tpUnidCarga;
            // to ensure "idUnidCarga" is required (not null)
            if (idUnidCarga == null)
            {
                throw new ArgumentNullException("idUnidCarga is a required property for CteSimpSefazUnidCargaSimp and cannot be null");
            }
        ...
        public List<CteSimpSefazLacUnidCargaSimp> lacUnidCarga { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazUnidCargaSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazUnidCargaSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazUnidCargaSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazUnidCargaSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazUnidCargaSimp input)
        {
            if (input == null)
            {
                return false;
