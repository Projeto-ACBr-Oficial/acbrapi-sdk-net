...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteSefazCIBS : IEquatable<CteSefazCIBS>, IValidatableObject
    {
        ...
        public CteSefazCIBS(decimal? vBC = default(decimal?), CteSefazGIBSUF gIBSUF = default(CteSefazGIBSUF), CteSefazGIBSMun gIBSMun = default(CteSefazGIBSMun), decimal? vIBS = default(decimal?), CteSefazGCBS gCBS = default(CteSefazGCBS), CteSefazTribRegular gTribRegular = default(CteSefazTribRegular), CteSefazTribCompraGov gTribCompraGov = default(CteSefazTribCompraGov))
        {
