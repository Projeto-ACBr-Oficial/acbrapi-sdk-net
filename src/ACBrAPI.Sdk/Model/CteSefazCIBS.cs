...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// CteSefazCIBS
    /// </summary>
    [DataContract(Name = "CteSefazCIBS")]
    public partial class CteSefazCIBS : IEquatable<CteSefazCIBS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazCIBS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazCIBS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazCIBS" /> class.
        /// </summary>
        ...
        public CteSefazCIBS(decimal? vBC = default(decimal?), CteSefazGIBSUF gIBSUF = default(CteSefazGIBSUF), CteSefazGIBSMun gIBSMun = default(CteSefazGIBSMun), decimal? vIBS = default(decimal?), CteSefazGCBS gCBS = default(CteSefazGCBS), CteSefazTribRegular gTribRegular = default(CteSefazTribRegular), CteSefazCredPres gIBSCredPres = default(CteSefazCredPres), CteSefazCredPres gCBSCredPres = default(CteSefazCredPres), CteSefazTribCompraGov gTribCompraGov = default(CteSefazTribCompraGov))
        {
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for CteSefazCIBS and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "gIBSUF" is required (not null)
            if (gIBSUF == null)
            {
                throw new ArgumentNullException("gIBSUF is a required property for CteSefazCIBS and cannot be null");
            }
            this.gIBSUF = gIBSUF;
            // to ensure "gIBSMun" is required (not null)
            if (gIBSMun == null)
            {
                throw new ArgumentNullException("gIBSMun is a required property for CteSefazCIBS and cannot be null");
            }
            this.gIBSMun = gIBSMun;
            // to ensure "vIBS" is required (not null)
            if (vIBS == null)
            {
                throw new ArgumentNullException("vIBS is a required property for CteSefazCIBS and cannot be null");
            }
            this.vIBS = vIBS;
            // to ensure "gCBS" is required (not null)
            if (gCBS == null)
            {
                throw new ArgumentNullException("gCBS is a required property for CteSefazCIBS and cannot be null");
            }
            this.gCBS = gCBS;
        ...
        {
            return this.Equals(input as CteSefazCIBS);
        }

        /// <summary>
        /// Returns true if CteSefazCIBS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazCIBS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazCIBS input)
        {
            if (input == null)
            {
                return false;
