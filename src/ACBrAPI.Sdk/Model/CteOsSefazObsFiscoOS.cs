...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazObsFiscoOS")]
    public partial class CteOsSefazObsFiscoOS : IEquatable<CteOsSefazObsFiscoOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazObsFiscoOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazObsFiscoOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazObsFiscoOS" /> class.
        /// </summary>
        /// <param name="xCampo">Identificação do campo. (required).</param>
        /// <param name="xTexto">Conteúdo do campo. (required).</param>
        public CteOsSefazObsFiscoOS(string xCampo = default(string), string xTexto = default(string))
        {
            // to ensure "xCampo" is required (not null)
            if (xCampo == null)
            {
                throw new ArgumentNullException("xCampo is a required property for CteOsSefazObsFiscoOS and cannot be null");
            }
            this.xCampo = xCampo;
            // to ensure "xTexto" is required (not null)
            if (xTexto == null)
            {
                throw new ArgumentNullException("xTexto is a required property for CteOsSefazObsFiscoOS and cannot be null");
            }
            this.xTexto = xTexto;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazObsFiscoOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazObsFiscoOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazObsFiscoOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazObsFiscoOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazObsFiscoOS input)
        {
            if (input == null)
            {
                return false;
