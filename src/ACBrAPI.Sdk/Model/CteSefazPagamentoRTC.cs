...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazPagamentoRTC")]
    public partial class CteSefazPagamentoRTC : IEquatable<CteSefazPagamentoRTC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazPagamentoRTC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazPagamentoRTC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazPagamentoRTC" /> class.
        /// </summary>
        ...
        public CteSefazPagamentoRTC(string nPag = default(string), string idTransacao = default(string), string tpMeioPgto = default(string), string cNPJReceb = default(string), string cNPJBasePSP = default(string))
        {
            // to ensure "nPag" is required (not null)
            if (nPag == null)
            {
                throw new ArgumentNullException("nPag is a required property for CteSefazPagamentoRTC and cannot be null");
            }
            this.nPag = nPag;
            // to ensure "idTransacao" is required (not null)
            if (idTransacao == null)
            {
                throw new ArgumentNullException("idTransacao is a required property for CteSefazPagamentoRTC and cannot be null");
            }
            this.idTransacao = idTransacao;
            // to ensure "tpMeioPgto" is required (not null)
            if (tpMeioPgto == null)
            {
                throw new ArgumentNullException("tpMeioPgto is a required property for CteSefazPagamentoRTC and cannot be null");
            }
            this.tpMeioPgto = tpMeioPgto;
            // to ensure "cNPJReceb" is required (not null)
            if (cNPJReceb == null)
            {
                throw new ArgumentNullException("cNPJReceb is a required property for CteSefazPagamentoRTC and cannot be null");
            }
            this.CNPJReceb = cNPJReceb;
            // to ensure "cNPJBasePSP" is required (not null)
            if (cNPJBasePSP == null)
            {
                throw new ArgumentNullException("cNPJBasePSP is a required property for CteSefazPagamentoRTC and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazPagamentoRTC {\n");
        ...
        {
            return this.Equals(input as CteSefazPagamentoRTC);
        }

        /// <summary>
        /// Returns true if CteSefazPagamentoRTC instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazPagamentoRTC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazPagamentoRTC input)
        {
            if (input == null)
            {
                return false;
