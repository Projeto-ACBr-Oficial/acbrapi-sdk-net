...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazEmiOccSimp")]
    public partial class CteSimpSefazEmiOccSimp : IEquatable<CteSimpSefazEmiOccSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEmiOccSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazEmiOccSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEmiOccSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazEmiOccSimp(string cNPJ = default(string), string cInt = default(string), string iE = default(string), string uF = default(string), string fone = default(string))
        {
            // to ensure "cNPJ" is required (not null)
            if (cNPJ == null)
            {
                throw new ArgumentNullException("cNPJ is a required property for CteSimpSefazEmiOccSimp and cannot be null");
            }
            this.CNPJ = cNPJ;
            // to ensure "iE" is required (not null)
            if (iE == null)
            {
                throw new ArgumentNullException("iE is a required property for CteSimpSefazEmiOccSimp and cannot be null");
            }
            this.IE = iE;
            // to ensure "uF" is required (not null)
            if (uF == null)
            {
                throw new ArgumentNullException("uF is a required property for CteSimpSefazEmiOccSimp and cannot be null");
            }
            this.UF = uF;
            this.cInt = cInt;
            this.fone = fone;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazEmiOccSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazEmiOccSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazEmiOccSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazEmiOccSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazEmiOccSimp input)
        {
            if (input == null)
            {
                return false;
