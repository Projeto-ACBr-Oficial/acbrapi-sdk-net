...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazGIBSMunOS")]
    public partial class CteOsSefazGIBSMunOS : IEquatable<CteOsSefazGIBSMunOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGIBSMunOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazGIBSMunOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGIBSMunOS" /> class.
        /// </summary>
        ...
        public CteOsSefazGIBSMunOS(decimal? pIBSMun = default(decimal?), CteOsSefazDifOS gDif = default(CteOsSefazDifOS), CteOsSefazDevTribOS gDevTrib = default(CteOsSefazDevTribOS), CteOsSefazRedOS gRed = default(CteOsSefazRedOS), decimal? vIBSMun = default(decimal?))
        {
            // to ensure "pIBSMun" is required (not null)
            if (pIBSMun == null)
            {
                throw new ArgumentNullException("pIBSMun is a required property for CteOsSefazGIBSMunOS and cannot be null");
            }
            this.pIBSMun = pIBSMun;
            // to ensure "vIBSMun" is required (not null)
            if (vIBSMun == null)
            {
                throw new ArgumentNullException("vIBSMun is a required property for CteOsSefazGIBSMunOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazGIBSMunOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazGIBSMunOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazGIBSMunOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazGIBSMunOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazGIBSMunOS input)
        {
            if (input == null)
            {
                return false;
