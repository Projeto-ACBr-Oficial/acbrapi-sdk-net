...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazCIBSSimp")]
    public partial class CteSimpSefazCIBSSimp : IEquatable<CteSimpSefazCIBSSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazCIBSSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazCIBSSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazCIBSSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazCIBSSimp(decimal? vBC = default(decimal?), CteSimpSefazGIBSUFSimp gIBSUF = default(CteSimpSefazGIBSUFSimp), CteSimpSefazGIBSMunSimp gIBSMun = default(CteSimpSefazGIBSMunSimp), decimal? vIBS = default(decimal?), CteSimpSefazGCBSSimp gCBS = default(CteSimpSefazGCBSSimp), CteSimpSefazTribRegularSimp gTribRegular = default(CteSimpSefazTribRegularSimp), CteSimpSefazCredPresSimp gIBSCredPres = default(CteSimpSefazCredPresSimp), CteSimpSefazCredPresSimp gCBSCredPres = default(CteSimpSefazCredPresSimp), CteSimpSefazTribCompraGovSimp gTribCompraGov = default(CteSimpSefazTribCompraGovSimp))
        {
            ...
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for CteSimpSefazCIBSSimp and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "gIBSUF" is required (not null)
            if (gIBSUF == null)
            {
                throw new ArgumentNullException("gIBSUF is a required property for CteSimpSefazCIBSSimp and cannot be null");
            }
            this.gIBSUF = gIBSUF;
            // to ensure "gIBSMun" is required (not null)
            if (gIBSMun == null)
            {
                throw new ArgumentNullException("gIBSMun is a required property for CteSimpSefazCIBSSimp and cannot be null");
            }
            this.gIBSMun = gIBSMun;
            // to ensure "vIBS" is required (not null)
            if (vIBS == null)
            {
                throw new ArgumentNullException("vIBS is a required property for CteSimpSefazCIBSSimp and cannot be null");
            }
            this.vIBS = vIBS;
            // to ensure "gCBS" is required (not null)
            if (gCBS == null)
            {
                throw new ArgumentNullException("gCBS is a required property for CteSimpSefazCIBSSimp and cannot be null");
            }
            this.gCBS = gCBS;
        ...
        public CteSimpSefazGIBSUFSimp gIBSUF { get; set; }
        ...
        public CteSimpSefazGCBSSimp gCBS { get; set; }
        ...
        public CteSimpSefazTribCompraGovSimp gTribCompraGov { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazCIBSSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazCIBSSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazCIBSSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazCIBSSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazCIBSSimp input)
        {
            if (input == null)
            {
                return false;
