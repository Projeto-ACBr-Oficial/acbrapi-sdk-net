...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class NfcomSefazGCBS : IEquatable<NfcomSefazGCBS>, IValidatableObject
    {
        ...
        public NfcomSefazGCBS(decimal? pCBS = default(decimal?), NfcomSefazDif gDif = default(NfcomSefazDif), NfcomSefazDevTrib gDevTrib = default(NfcomSefazDevTrib), NfcomSefazRed gRed = default(NfcomSefazRed), decimal? vCBS = default(decimal?))
        {
