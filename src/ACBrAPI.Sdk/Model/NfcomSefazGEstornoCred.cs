...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazGEstornoCred")]
    public partial class NfcomSefazGEstornoCred : IEquatable<NfcomSefazGEstornoCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazGEstornoCred" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazGEstornoCred() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazGEstornoCred" /> class.
        /// </summary>
        /// <param name="vIBSEstCred">Valor total do IBS estornado. (required).</param>
        /// <param name="vCBSEstCred">Valor total da CBS estornada. (required).</param>
        public NfcomSefazGEstornoCred(decimal? vIBSEstCred = default(decimal?), decimal? vCBSEstCred = default(decimal?))
        {
            // to ensure "vIBSEstCred" is required (not null)
            if (vIBSEstCred == null)
            {
                throw new ArgumentNullException("vIBSEstCred is a required property for NfcomSefazGEstornoCred and cannot be null");
            }
            this.vIBSEstCred = vIBSEstCred;
            // to ensure "vCBSEstCred" is required (not null)
            if (vCBSEstCred == null)
            {
                throw new ArgumentNullException("vCBSEstCred is a required property for NfcomSefazGEstornoCred and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Valor total do IBS estornado.</value>
        ...
        /// </summary>
        /// <value>Valor total da CBS estornada.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazGEstornoCred {\n");
        ...
        {
            return this.Equals(input as NfcomSefazGEstornoCred);
        }

        /// <summary>
        /// Returns true if NfcomSefazGEstornoCred instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazGEstornoCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazGEstornoCred input)
        {
            if (input == null)
            {
                return false;
