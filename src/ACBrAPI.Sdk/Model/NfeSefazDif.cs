...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazDif")]
    public partial class NfeSefazDif : IEquatable<NfeSefazDif>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazDif" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazDif() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazDif" /> class.
        /// </summary>
        /// <param name="pDif">Percentual do diferimento. (required).</param>
        /// <param name="vDif">Valor do diferimento. (required).</param>
        public NfeSefazDif(decimal? pDif = default(decimal?), decimal? vDif = default(decimal?))
        {
            // to ensure "pDif" is required (not null)
            if (pDif == null)
            {
                throw new ArgumentNullException("pDif is a required property for NfeSefazDif and cannot be null");
            }
            this.pDif = pDif;
            // to ensure "vDif" is required (not null)
            if (vDif == null)
            {
                throw new ArgumentNullException("vDif is a required property for NfeSefazDif and cannot be null");
            }
            this.vDif = vDif;
        }
        ...
        {
            return this.Equals(input as NfeSefazDif);
        }

        /// <summary>
        /// Returns true if NfeSefazDif instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazDif to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazDif input)
        {
            if (input == null)
            {
                return false;
