...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class DceSefazInfSolicDCe : IEquatable<DceSefazInfSolicDCe>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for xSolic, length must be less than 2000.", new [] { "xSolic" });
            }

            // xSolic (string) minLength
            if (this.xSolic != null && this.xSolic.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for xSolic, length must be greater than 0.", new [] { "xSolic" });
            }
