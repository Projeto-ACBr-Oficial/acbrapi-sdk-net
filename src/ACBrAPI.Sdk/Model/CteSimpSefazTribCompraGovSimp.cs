...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazTribCompraGovSimp")]
    public partial class CteSimpSefazTribCompraGovSimp : IEquatable<CteSimpSefazTribCompraGovSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazTribCompraGovSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazTribCompraGovSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazTribCompraGovSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazTribCompraGovSimp(decimal? pAliqIBSUF = default(decimal?), decimal? vTribIBSUF = default(decimal?), decimal? pAliqIBSMun = default(decimal?), decimal? vTribIBSMun = default(decimal?), decimal? pAliqCBS = default(decimal?), decimal? vTribCBS = default(decimal?))
        {
            // to ensure "vTribIBSUF" is required (not null)
            if (vTribIBSUF == null)
            {
                throw new ArgumentNullException("vTribIBSUF is a required property for CteSimpSefazTribCompraGovSimp and cannot be null");
            }
            this.vTribIBSUF = vTribIBSUF;
            // to ensure "vTribIBSMun" is required (not null)
            if (vTribIBSMun == null)
            {
                throw new ArgumentNullException("vTribIBSMun is a required property for CteSimpSefazTribCompraGovSimp and cannot be null");
            }
            this.vTribIBSMun = vTribIBSMun;
            // to ensure "vTribCBS" is required (not null)
            if (vTribCBS == null)
            {
                throw new ArgumentNullException("vTribCBS is a required property for CteSimpSefazTribCompraGovSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazTribCompraGovSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazTribCompraGovSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazTribCompraGovSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazTribCompraGovSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazTribCompraGovSimp input)
        {
            if (input == null)
            {
                return false;
