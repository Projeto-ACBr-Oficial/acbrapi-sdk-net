...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazTribCompraGovOS")]
    public partial class CteOsSefazTribCompraGovOS : IEquatable<CteOsSefazTribCompraGovOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazTribCompraGovOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazTribCompraGovOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazTribCompraGovOS" /> class.
        /// </summary>
        ...
        public CteOsSefazTribCompraGovOS(decimal? pAliqIBSUF = default(decimal?), decimal? vTribIBSUF = default(decimal?), decimal? pAliqIBSMun = default(decimal?), decimal? vTribIBSMun = default(decimal?), decimal? pAliqCBS = default(decimal?), decimal? vTribCBS = default(decimal?))
        {
            // to ensure "vTribIBSUF" is required (not null)
            if (vTribIBSUF == null)
            {
                throw new ArgumentNullException("vTribIBSUF is a required property for CteOsSefazTribCompraGovOS and cannot be null");
            }
            this.vTribIBSUF = vTribIBSUF;
            // to ensure "vTribIBSMun" is required (not null)
            if (vTribIBSMun == null)
            {
                throw new ArgumentNullException("vTribIBSMun is a required property for CteOsSefazTribCompraGovOS and cannot be null");
            }
            this.vTribIBSMun = vTribIBSMun;
            // to ensure "vTribCBS" is required (not null)
            if (vTribCBS == null)
            {
                throw new ArgumentNullException("vTribCBS is a required property for CteOsSefazTribCompraGovOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazTribCompraGovOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazTribCompraGovOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazTribCompraGovOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazTribCompraGovOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazTribCompraGovOS input)
        {
            if (input == null)
            {
                return false;
