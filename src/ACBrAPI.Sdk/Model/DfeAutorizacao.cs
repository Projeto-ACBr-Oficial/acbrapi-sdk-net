...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// DfeAutorizacao
    /// </summary>
    [DataContract(Name = "DfeAutorizacao")]
    public partial class DfeAutorizacao : IEquatable<DfeAutorizacao>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DfeAutorizacao" /> class.
        /// </summary>
        /// <param name="digestValue">Digest Value do DF-e processado. Utilizado para conferir a integridade do DF-e original..</param>
        ...
        /// </summary>
        /// <value>Digest Value do DF-e processado. Utilizado para conferir a integridade do DF-e original.</value>
        [DataMember(Name = "digest_value", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DfeAutorizacao {\n");
        ...
        {
            return this.Equals(input as DfeAutorizacao);
        }

        /// <summary>
        /// Returns true if DfeAutorizacao instances are equal
        /// </summary>
        /// <param name="input">Instance of DfeAutorizacao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DfeAutorizacao input)
        {
            if (input == null)
            {
                return false;
