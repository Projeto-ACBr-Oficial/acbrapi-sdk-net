...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazAutXMLSimp")]
    public partial class CteSimpSefazAutXMLSimp : IEquatable<CteSimpSefazAutXMLSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazAutXMLSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazAutXMLSimp(string cNPJ = default(string), string cPF = default(string))
        {
            this.CNPJ = cNPJ;
            this.CPF = cPF;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazAutXMLSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazAutXMLSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazAutXMLSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazAutXMLSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazAutXMLSimp input)
        {
            if (input == null)
            {
                return false;
