...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class EmpresaConfigRps : IEquatable<EmpresaConfigRps>, IValidatableObject
    {
        ...
        public EmpresaConfigRps(long lote = default(long), string serie = default(string), long numero = default(long))
        {
            this.lote = lote;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.serie != null && this.serie.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for serie, length must be less than 20.", new [] { "serie" });
            }
