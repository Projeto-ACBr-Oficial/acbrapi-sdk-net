...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazALCZFMCBSOS")]
    public partial class CteOsSefazALCZFMCBSOS : IEquatable<CteOsSefazALCZFMCBSOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazALCZFMCBSOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazALCZFMCBSOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazALCZFMCBSOS" /> class.
        /// </summary>
        ...
        public CteOsSefazALCZFMCBSOS(decimal? pAliqEfetRegCBS = default(decimal?), decimal? vTribRegCBS = default(decimal?))
        {
            // to ensure "pAliqEfetRegCBS" is required (not null)
            if (pAliqEfetRegCBS == null)
            {
                throw new ArgumentNullException("pAliqEfetRegCBS is a required property for CteOsSefazALCZFMCBSOS and cannot be null");
            }
            this.pAliqEfetRegCBS = pAliqEfetRegCBS;
            // to ensure "vTribRegCBS" is required (not null)
            if (vTribRegCBS == null)
            {
                throw new ArgumentNullException("vTribRegCBS is a required property for CteOsSefazALCZFMCBSOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazALCZFMCBSOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazALCZFMCBSOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazALCZFMCBSOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazALCZFMCBSOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazALCZFMCBSOS input)
        {
            if (input == null)
            {
                return false;
