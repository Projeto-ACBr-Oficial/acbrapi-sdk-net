...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazTribCompraGov")]
    public partial class NfcomSefazTribCompraGov : IEquatable<NfcomSefazTribCompraGov>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazTribCompraGov" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazTribCompraGov() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazTribCompraGov" /> class.
        /// </summary>
        ...
        public NfcomSefazTribCompraGov(decimal? pAliqIBSUF = default(decimal?), decimal? vTribIBSUF = default(decimal?), decimal? pAliqIBSMun = default(decimal?), decimal? vTribIBSMun = default(decimal?), decimal? pAliqCBS = default(decimal?), decimal? vTribCBS = default(decimal?))
        {
            // to ensure "vTribIBSUF" is required (not null)
            if (vTribIBSUF == null)
            {
                throw new ArgumentNullException("vTribIBSUF is a required property for NfcomSefazTribCompraGov and cannot be null");
            }
            this.vTribIBSUF = vTribIBSUF;
            // to ensure "vTribIBSMun" is required (not null)
            if (vTribIBSMun == null)
            {
                throw new ArgumentNullException("vTribIBSMun is a required property for NfcomSefazTribCompraGov and cannot be null");
            }
            this.vTribIBSMun = vTribIBSMun;
            // to ensure "vTribCBS" is required (not null)
            if (vTribCBS == null)
            {
                throw new ArgumentNullException("vTribCBS is a required property for NfcomSefazTribCompraGov and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazTribCompraGov {\n");
        ...
        {
            return this.Equals(input as NfcomSefazTribCompraGov);
        }

        /// <summary>
        /// Returns true if NfcomSefazTribCompraGov instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazTribCompraGov to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazTribCompraGov input)
        {
            if (input == null)
            {
                return false;
