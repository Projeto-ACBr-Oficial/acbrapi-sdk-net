...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazALCZFMCBSSimp")]
    public partial class CteSimpSefazALCZFMCBSSimp : IEquatable<CteSimpSefazALCZFMCBSSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazALCZFMCBSSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazALCZFMCBSSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazALCZFMCBSSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazALCZFMCBSSimp(decimal? pAliqEfetRegCBS = default(decimal?), decimal? vTribRegCBS = default(decimal?))
        {
            // to ensure "pAliqEfetRegCBS" is required (not null)
            if (pAliqEfetRegCBS == null)
            {
                throw new ArgumentNullException("pAliqEfetRegCBS is a required property for CteSimpSefazALCZFMCBSSimp and cannot be null");
            }
            this.pAliqEfetRegCBS = pAliqEfetRegCBS;
            // to ensure "vTribRegCBS" is required (not null)
            if (vTribRegCBS == null)
            {
                throw new ArgumentNullException("vTribRegCBS is a required property for CteSimpSefazALCZFMCBSSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazALCZFMCBSSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazALCZFMCBSSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazALCZFMCBSSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazALCZFMCBSSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazALCZFMCBSSimp input)
        {
            if (input == null)
            {
                return false;
