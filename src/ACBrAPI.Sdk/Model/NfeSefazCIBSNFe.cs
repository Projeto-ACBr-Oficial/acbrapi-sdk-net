...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// NfeSefazCIBSNFe
    /// </summary>
    [DataContract(Name = "NfeSefazCIBSNFe")]
    public partial class NfeSefazCIBSNFe : IEquatable<NfeSefazCIBSNFe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazCIBSNFe" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazCIBSNFe() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazCIBSNFe" /> class.
        /// </summary>
        ...
        public NfeSefazCIBSNFe(decimal? vBC = default(decimal?), NfeSefazGIBSUF gIBSUF = default(NfeSefazGIBSUF), NfeSefazGIBSMun gIBSMun = default(NfeSefazGIBSMun), decimal? vIBS = default(decimal?), NfeSefazGCBS gCBS = default(NfeSefazGCBS), NfeSefazTribRegular gTribRegular = default(NfeSefazTribRegular), NfeSefazTribCompraGov gTribCompraGov = default(NfeSefazTribCompraGov))
        {
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for NfeSefazCIBSNFe and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "gIBSUF" is required (not null)
            if (gIBSUF == null)
            {
                throw new ArgumentNullException("gIBSUF is a required property for NfeSefazCIBSNFe and cannot be null");
            }
            this.gIBSUF = gIBSUF;
            // to ensure "gIBSMun" is required (not null)
            if (gIBSMun == null)
            {
                throw new ArgumentNullException("gIBSMun is a required property for NfeSefazCIBSNFe and cannot be null");
            }
            this.gIBSMun = gIBSMun;
            // to ensure "vIBS" is required (not null)
            if (vIBS == null)
            {
                throw new ArgumentNullException("vIBS is a required property for NfeSefazCIBSNFe and cannot be null");
            }
            this.vIBS = vIBS;
            // to ensure "gCBS" is required (not null)
            if (gCBS == null)
            {
                throw new ArgumentNullException("gCBS is a required property for NfeSefazCIBSNFe and cannot be null");
            }
            this.gCBS = gCBS;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazCIBSNFe {\n");
        ...
        {
            return this.Equals(input as NfeSefazCIBSNFe);
        }

        /// <summary>
        /// Returns true if NfeSefazCIBSNFe instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazCIBSNFe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazCIBSNFe input)
        {
            if (input == null)
            {
                return false;
