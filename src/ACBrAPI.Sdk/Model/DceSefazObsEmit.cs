...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DceSefazObsEmit")]
    public partial class DceSefazObsEmit : IEquatable<DceSefazObsEmit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazObsEmit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DceSefazObsEmit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazObsEmit" /> class.
        /// </summary>
        /// <param name="xCampo">xCampo.</param>
        /// <param name="xTexto">Conteúdo do Campo. (required).</param>
        public DceSefazObsEmit(string xCampo = default(string), string xTexto = default(string))
        {
            // to ensure "xTexto" is required (not null)
            if (xTexto == null)
            {
                throw new ArgumentNullException("xTexto is a required property for DceSefazObsEmit and cannot be null");
            }
            this.xTexto = xTexto;
            this.xCampo = xCampo;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DceSefazObsEmit {\n");
        ...
        {
            return this.Equals(input as DceSefazObsEmit);
        }

        /// <summary>
        /// Returns true if DceSefazObsEmit instances are equal
        /// </summary>
        /// <param name="input">Instance of DceSefazObsEmit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DceSefazObsEmit input)
        {
            if (input == null)
            {
                return false;
