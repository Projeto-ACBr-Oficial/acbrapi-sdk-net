...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Dados da fatura.
    /// </summary>
    [DataContract(Name = "CteOsSefazFatOS")]
    public partial class CteOsSefazFatOS : IEquatable<CteOsSefazFatOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazFatOS" /> class.
        /// </summary>
        ...
        public CteOsSefazFatOS(string nFat = default(string), decimal? vOrig = default(decimal?), decimal? vDesc = default(decimal?), decimal? vLiq = default(decimal?))
        {
            this.nFat = nFat;
            this.vOrig = vOrig;
            this.vDesc = vDesc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazFatOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazFatOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazFatOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazFatOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazFatOS input)
        {
            if (input == null)
            {
                return false;
