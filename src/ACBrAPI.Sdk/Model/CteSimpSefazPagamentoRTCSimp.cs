...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazPagamentoRTCSimp")]
    public partial class CteSimpSefazPagamentoRTCSimp : IEquatable<CteSimpSefazPagamentoRTCSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazPagamentoRTCSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazPagamentoRTCSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazPagamentoRTCSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazPagamentoRTCSimp(string nPag = default(string), string idTransacao = default(string), string tpMeioPgto = default(string), string cNPJReceb = default(string), string cNPJBasePSP = default(string))
        {
            // to ensure "nPag" is required (not null)
            if (nPag == null)
            {
                throw new ArgumentNullException("nPag is a required property for CteSimpSefazPagamentoRTCSimp and cannot be null");
            }
            this.nPag = nPag;
            // to ensure "idTransacao" is required (not null)
            if (idTransacao == null)
            {
                throw new ArgumentNullException("idTransacao is a required property for CteSimpSefazPagamentoRTCSimp and cannot be null");
            }
            this.idTransacao = idTransacao;
            // to ensure "tpMeioPgto" is required (not null)
            if (tpMeioPgto == null)
            {
                throw new ArgumentNullException("tpMeioPgto is a required property for CteSimpSefazPagamentoRTCSimp and cannot be null");
            }
            this.tpMeioPgto = tpMeioPgto;
            // to ensure "cNPJReceb" is required (not null)
            if (cNPJReceb == null)
            {
                throw new ArgumentNullException("cNPJReceb is a required property for CteSimpSefazPagamentoRTCSimp and cannot be null");
            }
            this.CNPJReceb = cNPJReceb;
            // to ensure "cNPJBasePSP" is required (not null)
            if (cNPJBasePSP == null)
            {
                throw new ArgumentNullException("cNPJBasePSP is a required property for CteSimpSefazPagamentoRTCSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazPagamentoRTCSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazPagamentoRTCSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazPagamentoRTCSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazPagamentoRTCSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazPagamentoRTCSimp input)
        {
            if (input == null)
            {
                return false;
