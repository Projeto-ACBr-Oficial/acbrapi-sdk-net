...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class NfeSefazICMSSN201 : IEquatable<NfeSefazICMSSN201>, IValidatableObject
    {
        ...
        public NfeSefazICMSSN201(int? orig = default(int?), string cSOSN = default(string), int? modBCST = default(int?), decimal? pMVAST = default(decimal?), decimal? pRedBCST = default(decimal?), decimal? vBCST = default(decimal?), decimal? pICMSST = default(decimal?), decimal? vICMSST = default(decimal?), decimal? vBCFCPST = default(decimal?), decimal? pFCPST = default(decimal?), decimal? vFCPST = default(decimal?), decimal? pCredSN = default(decimal?), decimal? vCredICMSSN = default(decimal?))
        {
            ...
            if (orig == null)
            {
                throw new ArgumentNullException("orig is a required property for NfeSefazICMSSN201 and cannot be null");
            }
            this.orig = orig;
            ...
            if (modBCST == null)
            {
                throw new ArgumentNullException("modBCST is a required property for NfeSefazICMSSN201 and cannot be null");
            }
            this.modBCST = modBCST;
            // to ensure "vBCST" is required (not null)
            if (vBCST == null)
            {
                throw new ArgumentNullException("vBCST is a required property for NfeSefazICMSSN201 and cannot be null");
            }
            this.vBCST = vBCST;
            // to ensure "pICMSST" is required (not null)
            if (pICMSST == null)
            {
                throw new ArgumentNullException("pICMSST is a required property for NfeSefazICMSSN201 and cannot be null");
            }
            this.pICMSST = pICMSST;
            // to ensure "vICMSST" is required (not null)
            if (vICMSST == null)
            {
                throw new ArgumentNullException("vICMSST is a required property for NfeSefazICMSSN201 and cannot be null");
            }
            this.vICMSST = vICMSST;
            // to ensure "pCredSN" is required (not null)
            if (pCredSN == null)
            {
                throw new ArgumentNullException("pCredSN is a required property for NfeSefazICMSSN201 and cannot be null");
            }
            this.pCredSN = pCredSN;
            // to ensure "vCredICMSSN" is required (not null)
            if (vCredICMSSN == null)
            {
                throw new ArgumentNullException("vCredICMSSN is a required property for NfeSefazICMSSN201 and cannot be null");
            }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for pCredSN, must be a value greater than or equal to 0.", new [] { "pCredSN" });
            }

            // vCredICMSSN (decimal?) minimum
            if (this.vCredICMSSN < (decimal?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for vCredICMSSN, must be a value greater than or equal to 0.", new [] { "vCredICMSSN" });
            }
