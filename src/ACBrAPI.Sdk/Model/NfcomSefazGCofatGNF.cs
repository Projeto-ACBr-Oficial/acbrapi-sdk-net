...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazGCofat_GNF")]
    public partial class NfcomSefazGCofatGNF : IEquatable<NfcomSefazGCofatGNF>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazGCofatGNF" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazGCofatGNF() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazGCofatGNF" /> class.
        /// </summary>
        ...
        public NfcomSefazGCofatGNF(string cNPJ = default(string), int? mod = default(int?), string serie = default(string), int? nNF = default(int?), string competEmis = default(string), string hash115 = default(string))
        {
            // to ensure "cNPJ" is required (not null)
            if (cNPJ == null)
            {
                throw new ArgumentNullException("cNPJ is a required property for NfcomSefazGCofatGNF and cannot be null");
            }
            this.CNPJ = cNPJ;
            // to ensure "mod" is required (not null)
            if (mod == null)
            {
                throw new ArgumentNullException("mod is a required property for NfcomSefazGCofatGNF and cannot be null");
            }
            this.mod = mod;
            // to ensure "serie" is required (not null)
            if (serie == null)
            {
                throw new ArgumentNullException("serie is a required property for NfcomSefazGCofatGNF and cannot be null");
            }
            this.serie = serie;
            // to ensure "nNF" is required (not null)
            if (nNF == null)
            {
                throw new ArgumentNullException("nNF is a required property for NfcomSefazGCofatGNF and cannot be null");
            }
            this.nNF = nNF;
            // to ensure "competEmis" is required (not null)
            if (competEmis == null)
            {
                throw new ArgumentNullException("competEmis is a required property for NfcomSefazGCofatGNF and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazGCofatGNF {\n");
        ...
        {
            return this.Equals(input as NfcomSefazGCofatGNF);
        }

        /// <summary>
        /// Returns true if NfcomSefazGCofatGNF instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazGCofatGNF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazGCofatGNF input)
        {
            if (input == null)
            {
                return false;
