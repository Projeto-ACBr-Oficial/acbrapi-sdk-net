...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazIdeOS")]
    public partial class CteOsSefazIdeOS : IEquatable<CteOsSefazIdeOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazIdeOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazIdeOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazIdeOS" /> class.
        /// </summary>
        ...
        /// <param name="mod">Modelo do documento fiscal.  Utilizar o código 67 para identificação do CT-e Outros Serviços, emitido em substituição a Nota Fiscal Modelo 7 para transporte de pessoas, valores e excesso de bagagem..</param>
        /// <param name="serie">Série do CT-e OS.  Preencher com \&quot;0\&quot; no caso de série única. (required).</param>
        /// <param name="nCT">Número do CT-e OS. (required).</param>
        /// <param name="dhEmi">Data e hora de emissão do CT-e OS.  Formato AAAA-MM-DDTHH:MM:DD TZD. (required).</param>
        /// <param name="tpImp">Formato de impressão do DACTE:  * 1 - Retrato  * 2 - Paisagem (required).</param>
        /// <param name="tpEmis">Forma de emissão do CT-e.  Preencher com:  * 1 - Normal  * 5 - Contingência FSDA  * 7 - Autorização pela SVC-RS  * 8 - Autorização pela SVC-SP (required).</param>
        ...
        /// <param name="tpCTe">Tipo do CT-e OS.  Preencher com:  * 0 - CT-e Normal  * 1 - CT-e Complementar  * 3 - CT-e de Substituição (required).</param>
        /// <param name="procEmi">Identificador do processo de emissão do CT-e OS.  Preencher com:  * 0 - emissão de CT-e com aplicativo do contribuinte  * 3 - emissão CT-e pelo contribuinte com aplicativo fornecido pelo Fisco (required).</param>
        ...
        /// <param name="modal">Modal. Preencher com:  * 01 - Rodoviário  * 02 - Aéreo  * 03 - Aquaviário  * 04 - Ferroviário (required).</param>
        /// <param name="tpServ">Tipo do Serviço.  Preencher com:  * 6 - Transporte de Pessoas  * 7 - Transporte de Valores  * 8 - Excesso de Bagagem (required).</param>
        /// <param name="indIEToma">Indicador da IE do tomador:  * 1 - Contribuinte ICMS  * 2 - Contribuinte isento de inscrição  * 9 - Não Contribuinte  Aplica-se ao tomador que for indicado no toma3 ou toma4. (required).</param>
        /// <param name="cMunIni">Código do Município de início da prestação.  Utilizar a tabela do IBGE. Informar 9999999 para operações com o exterior..</param>
        /// <param name="xMunIni">Nome do Município do início da prestação.  Informar &#39;EXTERIOR&#39; para operações com o exterior..</param>
        /// <param name="uFIni">UF do início da prestação.  Informar &#39;EX&#39; para operações com o exterior..</param>
        /// <param name="cMunFim">Código do Município de término da prestação.  Utilizar a tabela do IBGE. Informar 9999999 para operações com o exterior..</param>
        /// <param name="xMunFim">Nome do Município do término da prestação.  Informar &#39;EXTERIOR&#39; para operações com o exterior..</param>
        /// <param name="uFFim">UF do término da prestação.  Informar &#39;EX&#39; para operações com o exterior..</param>
        ...
        public CteOsSefazIdeOS(int? cUF = default(int?), string cCT = default(string), string cFOP = default(string), string natOp = default(string), int? mod = default(int?), int? serie = default(int?), int? nCT = default(int?), DateTime? dhEmi = default(DateTime?), int? tpImp = default(int?), int? tpEmis = default(int?), int? cDV = default(int?), int? tpAmb = default(int?), int? tpCTe = default(int?), int? procEmi = default(int?), string verProc = default(string), string cMunEnv = default(string), string xMunEnv = default(string), string uFEnv = default(string), string modal = default(string), int? tpServ = default(int?), int? indIEToma = default(int?), string cMunIni = default(string), string xMunIni = default(string), string uFIni = default(string), string cMunFim = default(string), string xMunFim = default(string), string uFFim = default(string), List<CteOsSefazInfPercursoOS> infPercurso = default(List<CteOsSefazInfPercursoOS>), DateTime? dhCont = default(DateTime?), string xJust = default(string))
        {
            ...
            if (cUF == null)
            {
                throw new ArgumentNullException("cUF is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.cUF = cUF;
            // to ensure "cFOP" is required (not null)
            if (cFOP == null)
            {
                throw new ArgumentNullException("cFOP is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.CFOP = cFOP;
            // to ensure "natOp" is required (not null)
            if (natOp == null)
            {
                throw new ArgumentNullException("natOp is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.natOp = natOp;
            // to ensure "serie" is required (not null)
            if (serie == null)
            {
                throw new ArgumentNullException("serie is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.serie = serie;
            // to ensure "nCT" is required (not null)
            if (nCT == null)
            {
                throw new ArgumentNullException("nCT is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.nCT = nCT;
            // to ensure "dhEmi" is required (not null)
            if (dhEmi == null)
            {
                throw new ArgumentNullException("dhEmi is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.dhEmi = dhEmi;
            // to ensure "tpImp" is required (not null)
            if (tpImp == null)
            {
                throw new ArgumentNullException("tpImp is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.tpImp = tpImp;
            // to ensure "tpEmis" is required (not null)
            if (tpEmis == null)
            {
                throw new ArgumentNullException("tpEmis is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.tpEmis = tpEmis;
            // to ensure "tpCTe" is required (not null)
            if (tpCTe == null)
            {
                throw new ArgumentNullException("tpCTe is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.tpCTe = tpCTe;
            // to ensure "procEmi" is required (not null)
            if (procEmi == null)
            {
                throw new ArgumentNullException("procEmi is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.procEmi = procEmi;
            // to ensure "verProc" is required (not null)
            if (verProc == null)
            {
                throw new ArgumentNullException("verProc is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.verProc = verProc;
            // to ensure "cMunEnv" is required (not null)
            if (cMunEnv == null)
            {
                throw new ArgumentNullException("cMunEnv is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.cMunEnv = cMunEnv;
            // to ensure "xMunEnv" is required (not null)
            if (xMunEnv == null)
            {
                throw new ArgumentNullException("xMunEnv is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.xMunEnv = xMunEnv;
            // to ensure "uFEnv" is required (not null)
            if (uFEnv == null)
            {
                throw new ArgumentNullException("uFEnv is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.UFEnv = uFEnv;
            // to ensure "modal" is required (not null)
            if (modal == null)
            {
                throw new ArgumentNullException("modal is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.modal = modal;
            // to ensure "tpServ" is required (not null)
            if (tpServ == null)
            {
                throw new ArgumentNullException("tpServ is a required property for CteOsSefazIdeOS and cannot be null");
            }
            this.tpServ = tpServ;
            // to ensure "indIEToma" is required (not null)
            if (indIEToma == null)
            {
                throw new ArgumentNullException("indIEToma is a required property for CteOsSefazIdeOS and cannot be null");
            }
        ...
        /// <summary>
        /// Modelo do documento fiscal.  Utilizar o código 67 para identificação do CT-e Outros Serviços, emitido em substituição a Nota Fiscal Modelo 7 para transporte de pessoas, valores e excesso de bagagem.
        /// </summary>
        /// <value>Modelo do documento fiscal.  Utilizar o código 67 para identificação do CT-e Outros Serviços, emitido em substituição a Nota Fiscal Modelo 7 para transporte de pessoas, valores e excesso de bagagem.</value>
        [DataMember(Name = "mod", EmitDefaultValue = true)]
        public int? mod { get; set; }

        /// <summary>
        /// Série do CT-e OS.  Preencher com \&quot;0\&quot; no caso de série única.
        /// </summary>
        /// <value>Série do CT-e OS.  Preencher com \&quot;0\&quot; no caso de série única.</value>
        ...
        /// Número do CT-e OS.
        /// </summary>
        /// <value>Número do CT-e OS.</value>
        [DataMember(Name = "nCT", IsRequired = true, EmitDefaultValue = true)]
        public int? nCT { get; set; }

        /// <summary>
        /// Data e hora de emissão do CT-e OS.  Formato AAAA-MM-DDTHH:MM:DD TZD.
        /// </summary>
        /// <value>Data e hora de emissão do CT-e OS.  Formato AAAA-MM-DDTHH:MM:DD TZD.</value>
        ...
        /// <summary>
        /// Forma de emissão do CT-e.  Preencher com:  * 1 - Normal  * 5 - Contingência FSDA  * 7 - Autorização pela SVC-RS  * 8 - Autorização pela SVC-SP
        /// </summary>
        /// <value>Forma de emissão do CT-e.  Preencher com:  * 1 - Normal  * 5 - Contingência FSDA  * 7 - Autorização pela SVC-RS  * 8 - Autorização pela SVC-SP</value>
        ...
        /// <summary>
        /// Tipo do CT-e OS.  Preencher com:  * 0 - CT-e Normal  * 1 - CT-e Complementar  * 3 - CT-e de Substituição
        /// </summary>
        /// <value>Tipo do CT-e OS.  Preencher com:  * 0 - CT-e Normal  * 1 - CT-e Complementar  * 3 - CT-e de Substituição</value>
        [DataMember(Name = "tpCTe", IsRequired = true, EmitDefaultValue = true)]
        public int? tpCTe { get; set; }

        /// <summary>
        /// Identificador do processo de emissão do CT-e OS.  Preencher com:  * 0 - emissão de CT-e com aplicativo do contribuinte  * 3 - emissão CT-e pelo contribuinte com aplicativo fornecido pelo Fisco
        /// </summary>
        /// <value>Identificador do processo de emissão do CT-e OS.  Preencher com:  * 0 - emissão de CT-e com aplicativo do contribuinte  * 3 - emissão CT-e pelo contribuinte com aplicativo fornecido pelo Fisco</value>
        ...
        /// <summary>
        /// Modal. Preencher com:  * 01 - Rodoviário  * 02 - Aéreo  * 03 - Aquaviário  * 04 - Ferroviário
        /// </summary>
        /// <value>Modal. Preencher com:  * 01 - Rodoviário  * 02 - Aéreo  * 03 - Aquaviário  * 04 - Ferroviário</value>
        [DataMember(Name = "modal", IsRequired = true, EmitDefaultValue = true)]
        public string modal { get; set; }

        /// <summary>
        /// Tipo do Serviço.  Preencher com:  * 6 - Transporte de Pessoas  * 7 - Transporte de Valores  * 8 - Excesso de Bagagem
        /// </summary>
        /// <value>Tipo do Serviço.  Preencher com:  * 6 - Transporte de Pessoas  * 7 - Transporte de Valores  * 8 - Excesso de Bagagem</value>
        [DataMember(Name = "tpServ", IsRequired = true, EmitDefaultValue = true)]
        public int? tpServ { get; set; }

        /// <summary>
        /// Indicador da IE do tomador:  * 1 - Contribuinte ICMS  * 2 - Contribuinte isento de inscrição  * 9 - Não Contribuinte  Aplica-se ao tomador que for indicado no toma3 ou toma4.
        /// </summary>
        /// <value>Indicador da IE do tomador:  * 1 - Contribuinte ICMS  * 2 - Contribuinte isento de inscrição  * 9 - Não Contribuinte  Aplica-se ao tomador que for indicado no toma3 ou toma4.</value>
        ...
        [DataMember(Name = "cMunIni", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "xMunIni", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "UFIni", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "cMunFim", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "xMunFim", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "UFFim", EmitDefaultValue = true)]
        ...
        public List<CteOsSefazInfPercursoOS> infPercurso { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazIdeOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazIdeOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazIdeOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazIdeOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazIdeOS input)
        {
            if (input == null)
            {
                return false;
