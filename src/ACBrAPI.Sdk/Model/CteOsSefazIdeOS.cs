...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteOsSefazIdeOS : IEquatable<CteOsSefazIdeOS>, IValidatableObject
    {
        ...
        /// <param name="procEmi">Identificador do processo de emissão do CTe OS.  Preencher com:         0 - emissão de CTe com aplicativo do contribuinte  * 3 - emissão CTe pelo contribuinte com aplicativo fornecido pelo Fisco (required).</param>
        ...
        /// <summary>
        /// Identificador do processo de emissão do CTe OS.  Preencher com:         0 - emissão de CTe com aplicativo do contribuinte  * 3 - emissão CTe pelo contribuinte com aplicativo fornecido pelo Fisco
        /// </summary>
        /// <value>Identificador do processo de emissão do CTe OS.  Preencher com:         0 - emissão de CTe com aplicativo do contribuinte  * 3 - emissão CTe pelo contribuinte com aplicativo fornecido pelo Fisco</value>
