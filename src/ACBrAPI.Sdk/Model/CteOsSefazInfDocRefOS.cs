...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteOsSefazInfDocRefOS : IEquatable<CteOsSefazInfDocRefOS>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for subserie, length must be less than 3.", new [] { "subserie" });
            }

            // subserie (string) minLength
            if (this.subserie != null && this.subserie.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for subserie, length must be greater than 1.", new [] { "subserie" });
            }

            // vDoc (decimal?) minimum
            if (this.vDoc < (decimal?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for vDoc, must be a value greater than or equal to 0.", new [] { "vDoc" });
            }
