...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazAutXMLOS")]
    public partial class CteOsSefazAutXMLOS : IEquatable<CteOsSefazAutXMLOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazAutXMLOS" /> class.
        /// </summary>
        ...
        public CteOsSefazAutXMLOS(string cNPJ = default(string), string cPF = default(string))
        {
            this.CNPJ = cNPJ;
            this.CPF = cPF;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazAutXMLOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazAutXMLOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazAutXMLOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazAutXMLOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazAutXMLOS input)
        {
            if (input == null)
            {
                return false;
