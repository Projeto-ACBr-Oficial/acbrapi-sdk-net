...
namespace ACBrAPI.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazInfAdicObsFisco" /> class.
        /// </summary>
        /// <param name="xCampo">xCampo.</param>
        /// <param name="xTexto">xTexto.</param>
        public NfeSefazInfAdicObsFisco(string xCampo = default(string), string xTexto = default(string))
        {
            this.xCampo = xCampo;
            this.xTexto = xTexto;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazInfAdicObsFisco {\n");
        ...
        {
            return this.Equals(input as NfeSefazInfAdicObsFisco);
        }

        /// <summary>
        /// Returns true if NfeSefazInfAdicObsFisco instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazInfAdicObsFisco to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazInfAdicObsFisco input)
        {
            if (input == null)
            {
                return false;
