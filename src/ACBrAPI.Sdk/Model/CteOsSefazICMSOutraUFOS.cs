...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazICMSOutraUFOS")]
    public partial class CteOsSefazICMSOutraUFOS : IEquatable<CteOsSefazICMSOutraUFOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazICMSOutraUFOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazICMSOutraUFOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazICMSOutraUFOS" /> class.
        /// </summary>
        ...
        public CteOsSefazICMSOutraUFOS(string cST = default(string), decimal? pRedBCOutraUF = default(decimal?), decimal? vBCOutraUF = default(decimal?), decimal? pICMSOutraUF = default(decimal?), decimal? vICMSOutraUF = default(decimal?), decimal? vICMSDeson = default(decimal?), string cBenef = default(string))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for CteOsSefazICMSOutraUFOS and cannot be null");
            }
            this.CST = cST;
            // to ensure "vBCOutraUF" is required (not null)
            if (vBCOutraUF == null)
            {
                throw new ArgumentNullException("vBCOutraUF is a required property for CteOsSefazICMSOutraUFOS and cannot be null");
            }
            this.vBCOutraUF = vBCOutraUF;
            // to ensure "pICMSOutraUF" is required (not null)
            if (pICMSOutraUF == null)
            {
                throw new ArgumentNullException("pICMSOutraUF is a required property for CteOsSefazICMSOutraUFOS and cannot be null");
            }
            this.pICMSOutraUF = pICMSOutraUF;
            // to ensure "vICMSOutraUF" is required (not null)
            if (vICMSOutraUF == null)
            {
                throw new ArgumentNullException("vICMSOutraUF is a required property for CteOsSefazICMSOutraUFOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazICMSOutraUFOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazICMSOutraUFOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazICMSOutraUFOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazICMSOutraUFOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazICMSOutraUFOS input)
        {
            if (input == null)
            {
                return false;
