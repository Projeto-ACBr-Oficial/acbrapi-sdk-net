...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Dados do endereço.
    /// </summary>
    [DataContract(Name = "NfeSefazEndereco")]
    public partial class NfeSefazEndereco : IEquatable<NfeSefazEndereco>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazEndereco" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazEndereco() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazEndereco" /> class.
        /// </summary>
        ...
        public NfeSefazEndereco(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string uF = default(string), string cEP = default(string), string cPais = default(string), string xPais = default(string), string fone = default(string))
        {
            // to ensure "xLgr" is required (not null)
            if (xLgr == null)
            {
                throw new ArgumentNullException("xLgr is a required property for NfeSefazEndereco and cannot be null");
            }
            this.xLgr = xLgr;
            // to ensure "nro" is required (not null)
            if (nro == null)
            {
                throw new ArgumentNullException("nro is a required property for NfeSefazEndereco and cannot be null");
            }
            this.nro = nro;
            ...
            if (xMun == null)
            {
                throw new ArgumentNullException("xMun is a required property for NfeSefazEndereco and cannot be null");
            }
            this.xMun = xMun;
            // to ensure "uF" is required (not null)
            if (uF == null)
            {
                throw new ArgumentNullException("uF is a required property for NfeSefazEndereco and cannot be null");
            }
            this.UF = uF;
            this.xCpl = xCpl;
            this.CEP = cEP;
        ...
        {
            return this.Equals(input as NfeSefazEndereco);
        }

        /// <summary>
        /// Returns true if NfeSefazEndereco instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazEndereco to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazEndereco input)
        {
            if (input == null)
            {
                return false;
