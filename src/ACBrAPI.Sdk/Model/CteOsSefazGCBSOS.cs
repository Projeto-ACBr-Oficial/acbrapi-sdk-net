...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazGCBSOS")]
    public partial class CteOsSefazGCBSOS : IEquatable<CteOsSefazGCBSOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGCBSOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazGCBSOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGCBSOS" /> class.
        /// </summary>
        ...
        public CteOsSefazGCBSOS(decimal? pCBS = default(decimal?), CteOsSefazDifOS gDif = default(CteOsSefazDifOS), CteOsSefazDevTribOS gDevTrib = default(CteOsSefazDevTribOS), CteOsSefazRedOS gRed = default(CteOsSefazRedOS), CteOsSefazALCZFMCBSOS gALCZFMCBS = default(CteOsSefazALCZFMCBSOS), decimal? vCBS = default(decimal?))
        {
            // to ensure "pCBS" is required (not null)
            if (pCBS == null)
            {
                throw new ArgumentNullException("pCBS is a required property for CteOsSefazGCBSOS and cannot be null");
            }
            this.pCBS = pCBS;
            // to ensure "vCBS" is required (not null)
            if (vCBS == null)
            {
                throw new ArgumentNullException("vCBS is a required property for CteOsSefazGCBSOS and cannot be null");
            }
            this.vCBS = vCBS;
            this.gDif = gDif;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazGCBSOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazGCBSOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazGCBSOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazGCBSOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazGCBSOS input)
        {
            if (input == null)
            {
                return false;
