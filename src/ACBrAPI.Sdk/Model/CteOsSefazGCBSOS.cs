...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteOsSefazGCBSOS : IEquatable<CteOsSefazGCBSOS>, IValidatableObject
    {
        ...
        public CteOsSefazGCBSOS(decimal? pCBS = default(decimal?), CteOsSefazDifOS gDif = default(CteOsSefazDifOS), CteOsSefazDevTribOS gDevTrib = default(CteOsSefazDevTribOS), CteOsSefazRedOS gRed = default(CteOsSefazRedOS), decimal? vCBS = default(decimal?))
        {
