...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazICMS45Simp")]
    public partial class CteSimpSefazICMS45Simp : IEquatable<CteSimpSefazICMS45Simp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMS45Simp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazICMS45Simp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMS45Simp" /> class.
        /// </summary>
        ...
        public CteSimpSefazICMS45Simp(string cST = default(string), decimal? vICMSDeson = default(decimal?), string cBenef = default(string))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for CteSimpSefazICMS45Simp and cannot be null");
            }
            this.CST = cST;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazICMS45Simp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazICMS45Simp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazICMS45Simp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazICMS45Simp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazICMS45Simp input)
        {
            if (input == null)
            {
                return false;
