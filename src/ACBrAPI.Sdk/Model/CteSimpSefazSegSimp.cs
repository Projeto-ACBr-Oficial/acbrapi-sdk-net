...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazSegSimp")]
    public partial class CteSimpSefazSegSimp : IEquatable<CteSimpSefazSegSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazSegSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazSegSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazSegSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazSegSimp(CteSimpSefazInfSegSimp infSeg = default(CteSimpSefazInfSegSimp), string nApol = default(string), string nAver = default(string))
        {
            // to ensure "infSeg" is required (not null)
            if (infSeg == null)
            {
                throw new ArgumentNullException("infSeg is a required property for CteSimpSefazSegSimp and cannot be null");
            }
            this.infSeg = infSeg;
            // to ensure "nApol" is required (not null)
            if (nApol == null)
            {
                throw new ArgumentNullException("nApol is a required property for CteSimpSefazSegSimp and cannot be null");
            }
            this.nApol = nApol;
            // to ensure "nAver" is required (not null)
            if (nAver == null)
            {
                throw new ArgumentNullException("nAver is a required property for CteSimpSefazSegSimp and cannot be null");
            }
            this.nAver = nAver;
        }
        ...
        public CteSimpSefazInfSegSimp infSeg { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazSegSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazSegSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazSegSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazSegSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazSegSimp input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for nAver, length must be less than 20.", new [] { "nAver" });
            }

            // nAver (string) minLength
            if (this.nAver != null && this.nAver.Length < 1)
            {
                yield return new ValidationResult("Invalid value for nAver, length must be greater than 1.", new [] { "nAver" });
            }
