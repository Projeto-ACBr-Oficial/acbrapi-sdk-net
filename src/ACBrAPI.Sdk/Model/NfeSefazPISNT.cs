...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class NfeSefazPISNT : IEquatable<NfeSefazPISNT>, IValidatableObject
    {
        ...
        public NfeSefazPISNT(string cST = default(string))
        {
            ...
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for NfeSefazPISNT and cannot be null");
            }
            this.CST = cST;
        }
        ...
        {
            return this.Equals(input as NfeSefazPISNT);
        }

        /// <summary>
        /// Returns true if NfeSefazPISNT instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazPISNT to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazPISNT input)
        {
            if (input == null)
            {
                return false;
