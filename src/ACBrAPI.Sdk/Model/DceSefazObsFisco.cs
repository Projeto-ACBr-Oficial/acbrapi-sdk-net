...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DceSefazObsFisco")]
    public partial class DceSefazObsFisco : IEquatable<DceSefazObsFisco>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazObsFisco" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DceSefazObsFisco() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazObsFisco" /> class.
        /// </summary>
        /// <param name="xCampo">xCampo.</param>
        /// <param name="xTexto">Conteúdo do Campo. (required).</param>
        public DceSefazObsFisco(string xCampo = default(string), string xTexto = default(string))
        {
            // to ensure "xTexto" is required (not null)
            if (xTexto == null)
            {
                throw new ArgumentNullException("xTexto is a required property for DceSefazObsFisco and cannot be null");
            }
            this.xTexto = xTexto;
            this.xCampo = xCampo;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DceSefazObsFisco {\n");
        ...
        {
            return this.Equals(input as DceSefazObsFisco);
        }

        /// <summary>
        /// Returns true if DceSefazObsFisco instances are equal
        /// </summary>
        /// <param name="input">Instance of DceSefazObsFisco to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DceSefazObsFisco input)
        {
            if (input == null)
            {
                return false;
