...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// CteOsCartaCorrecao
    /// </summary>
    [DataContract(Name = "CteOsCartaCorrecao")]
    public partial class CteOsCartaCorrecao : IEquatable<CteOsCartaCorrecao>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsCartaCorrecao" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsCartaCorrecao() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsCartaCorrecao" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsCartaCorrecao {\n");
        ...
        {
            return this.Equals(input as CteOsCartaCorrecao);
        }

        /// <summary>
        /// Returns true if CteOsCartaCorrecao instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsCartaCorrecao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsCartaCorrecao input)
        {
            if (input == null)
            {
                return false;
