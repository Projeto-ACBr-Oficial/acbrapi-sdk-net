...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazObsContSimp")]
    public partial class CteSimpSefazObsContSimp : IEquatable<CteSimpSefazObsContSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazObsContSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazObsContSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazObsContSimp" /> class.
        /// </summary>
        /// <param name="xCampo">Identificação do campo. (required).</param>
        /// <param name="xTexto">Conteúdo do campo. (required).</param>
        public CteSimpSefazObsContSimp(string xCampo = default(string), string xTexto = default(string))
        {
            // to ensure "xCampo" is required (not null)
            if (xCampo == null)
            {
                throw new ArgumentNullException("xCampo is a required property for CteSimpSefazObsContSimp and cannot be null");
            }
            this.xCampo = xCampo;
            // to ensure "xTexto" is required (not null)
            if (xTexto == null)
            {
                throw new ArgumentNullException("xTexto is a required property for CteSimpSefazObsContSimp and cannot be null");
            }
            this.xTexto = xTexto;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazObsContSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazObsContSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazObsContSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazObsContSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazObsContSimp input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for xTexto, length must be less than 160.", new [] { "xTexto" });
            }
