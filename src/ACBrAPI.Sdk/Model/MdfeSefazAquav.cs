...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class MdfeSefazAquav : IEquatable<MdfeSefazAquav>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MMSI, length must be less than 9.", new [] { "MMSI" });
            }

            // MMSI (string) minLength
            if (this.MMSI != null && this.MMSI.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MMSI, length must be greater than 1.", new [] { "MMSI" });
            }
