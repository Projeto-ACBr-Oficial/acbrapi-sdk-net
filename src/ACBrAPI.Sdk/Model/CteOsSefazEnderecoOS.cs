...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Dados do endereço.
    /// </summary>
    [DataContract(Name = "CteOsSefazEnderecoOS")]
    public partial class CteOsSefazEnderecoOS : IEquatable<CteOsSefazEnderecoOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazEnderecoOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazEnderecoOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazEnderecoOS" /> class.
        /// </summary>
        ...
        public CteOsSefazEnderecoOS(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string cEP = default(string), string uF = default(string), string cPais = default(string), string xPais = default(string))
        {
            // to ensure "xLgr" is required (not null)
            if (xLgr == null)
            {
                throw new ArgumentNullException("xLgr is a required property for CteOsSefazEnderecoOS and cannot be null");
            }
            this.xLgr = xLgr;
            // to ensure "nro" is required (not null)
            if (nro == null)
            {
                throw new ArgumentNullException("nro is a required property for CteOsSefazEnderecoOS and cannot be null");
            }
            this.nro = nro;
            // to ensure "xBairro" is required (not null)
            if (xBairro == null)
            {
                throw new ArgumentNullException("xBairro is a required property for CteOsSefazEnderecoOS and cannot be null");
            }
            this.xBairro = xBairro;
            // to ensure "cMun" is required (not null)
            if (cMun == null)
            {
                throw new ArgumentNullException("cMun is a required property for CteOsSefazEnderecoOS and cannot be null");
            }
            this.cMun = cMun;
            // to ensure "xMun" is required (not null)
            if (xMun == null)
            {
                throw new ArgumentNullException("xMun is a required property for CteOsSefazEnderecoOS and cannot be null");
            }
            this.xMun = xMun;
            // to ensure "uF" is required (not null)
            if (uF == null)
            {
                throw new ArgumentNullException("uF is a required property for CteOsSefazEnderecoOS and cannot be null");
            }
            this.UF = uF;
            this.xCpl = xCpl;
            this.CEP = cEP;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazEnderecoOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazEnderecoOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazEnderecoOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazEnderecoOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazEnderecoOS input)
        {
            if (input == null)
            {
                return false;
