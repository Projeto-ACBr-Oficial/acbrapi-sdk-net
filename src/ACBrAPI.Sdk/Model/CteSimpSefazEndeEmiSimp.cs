...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazEndeEmiSimp")]
    public partial class CteSimpSefazEndeEmiSimp : IEquatable<CteSimpSefazEndeEmiSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEndeEmiSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazEndeEmiSimp(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string cEP = default(string), string uF = default(string), string fone = default(string))
        {
            this.xLgr = xLgr;
            this.nro = nro;
            this.xCpl = xCpl;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazEndeEmiSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazEndeEmiSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazEndeEmiSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazEndeEmiSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazEndeEmiSimp input)
        {
            if (input == null)
            {
                return false;
