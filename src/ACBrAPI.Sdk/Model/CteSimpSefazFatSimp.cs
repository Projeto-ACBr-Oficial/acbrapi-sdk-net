...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Dados da fatura.
    /// </summary>
    [DataContract(Name = "CteSimpSefazFatSimp")]
    public partial class CteSimpSefazFatSimp : IEquatable<CteSimpSefazFatSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazFatSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazFatSimp(string nFat = default(string), decimal? vOrig = default(decimal?), decimal? vDesc = default(decimal?), decimal? vLiq = default(decimal?))
        {
            this.nFat = nFat;
            this.vOrig = vOrig;
            this.vDesc = vDesc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazFatSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazFatSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazFatSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazFatSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazFatSimp input)
        {
            if (input == null)
            {
                return false;
