...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazTrafMutSimp")]
    public partial class CteSimpSefazTrafMutSimp : IEquatable<CteSimpSefazTrafMutSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazTrafMutSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazTrafMutSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazTrafMutSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazTrafMutSimp(int? respFat = default(int?), int? ferrEmi = default(int?), decimal? vFrete = default(decimal?), string chCTeFerroOrigem = default(string), List<CteSimpSefazFerroEnvSimp> ferroEnv = default(List<CteSimpSefazFerroEnvSimp>))
        {
            // to ensure "respFat" is required (not null)
            if (respFat == null)
            {
                throw new ArgumentNullException("respFat is a required property for CteSimpSefazTrafMutSimp and cannot be null");
            }
            this.respFat = respFat;
            // to ensure "ferrEmi" is required (not null)
            if (ferrEmi == null)
            {
                throw new ArgumentNullException("ferrEmi is a required property for CteSimpSefazTrafMutSimp and cannot be null");
            }
            this.ferrEmi = ferrEmi;
            // to ensure "vFrete" is required (not null)
            if (vFrete == null)
            {
                throw new ArgumentNullException("vFrete is a required property for CteSimpSefazTrafMutSimp and cannot be null");
            }
            this.vFrete = vFrete;
        ...
        public List<CteSimpSefazFerroEnvSimp> ferroEnv { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazTrafMutSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazTrafMutSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazTrafMutSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazTrafMutSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazTrafMutSimp input)
        {
            if (input == null)
            {
                return false;
