...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class TribMunicipal : IEquatable<TribMunicipal>, IValidatableObject
    {
        ...
        /// <param name="cLocIncid">Código do município de incidência do ISSQN (tabela do IBGE).    Caso o envio seja pelo Sistema Nacional NFS-e, essa propriedade - ignorada e o município de incidência do ISSQN - determinado automaticamente pela SEFIN nacional, conforme regras do aspecto espacial da lei complementar federal (LC 116/03) que são válidas para todos os municípios..</param>
        ...
        public TribMunicipal(int? tribISSQN = default(int?), string cPaisResult = default(string), int? tpImunidade = default(int?), ExigSuspensa exigSusp = default(ExigSuspensa), BeneficioMunicipal bM = default(BeneficioMunicipal), int? tpRetISSQN = default(int?), decimal? pAliq = default(decimal?), string cLocIncid = default(string), decimal? vBC = default(decimal?), decimal? vISSQN = default(decimal?), decimal? vLiq = default(decimal?))
        {
        ...
        /// <summary>
        /// Código do município de incidência do ISSQN (tabela do IBGE).    Caso o envio seja pelo Sistema Nacional NFS-e, essa propriedade - ignorada e o município de incidência do ISSQN - determinado automaticamente pela SEFIN nacional, conforme regras do aspecto espacial da lei complementar federal (LC 116/03) que são válidas para todos os municípios.
        /// </summary>
        /// <value>Código do município de incidência do ISSQN (tabela do IBGE).    Caso o envio seja pelo Sistema Nacional NFS-e, essa propriedade - ignorada e o município de incidência do ISSQN - determinado automaticamente pela SEFIN nacional, conforme regras do aspecto espacial da lei complementar federal (LC 116/03) que são válidas para todos os municípios.</value>
