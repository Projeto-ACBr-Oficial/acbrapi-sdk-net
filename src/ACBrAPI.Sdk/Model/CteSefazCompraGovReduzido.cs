...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazCompraGovReduzido")]
    public partial class CteSefazCompraGovReduzido : IEquatable<CteSefazCompraGovReduzido>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazCompraGovReduzido" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazCompraGovReduzido() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazCompraGovReduzido" /> class.
        /// </summary>
        ...
        public CteSefazCompraGovReduzido(int? tpEnteGov = default(int?), decimal? pRedutor = default(decimal?), int? tpOperGov = default(int?), List<string> refDFeAnt = default(List<string>))
        {
            // to ensure "tpEnteGov" is required (not null)
            if (tpEnteGov == null)
            {
                throw new ArgumentNullException("tpEnteGov is a required property for CteSefazCompraGovReduzido and cannot be null");
            }
            this.tpEnteGov = tpEnteGov;
            // to ensure "pRedutor" is required (not null)
            if (pRedutor == null)
            {
                throw new ArgumentNullException("pRedutor is a required property for CteSefazCompraGovReduzido and cannot be null");
            }
            this.pRedutor = pRedutor;
            // to ensure "tpOperGov" is required (not null)
            if (tpOperGov == null)
            {
                throw new ArgumentNullException("tpOperGov is a required property for CteSefazCompraGovReduzido and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazCompraGovReduzido {\n");
        ...
        {
            return this.Equals(input as CteSefazCompraGovReduzido);
        }

        /// <summary>
        /// Returns true if CteSefazCompraGovReduzido instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazCompraGovReduzido to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazCompraGovReduzido input)
        {
            if (input == null)
            {
                return false;
