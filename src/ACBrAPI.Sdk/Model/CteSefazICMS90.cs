...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteSefazICMS90 : IEquatable<CteSefazICMS90>, IValidatableObject
    {
        ...
        public CteSefazICMS90(string cST = default(string), decimal? pRedBC = default(decimal?), decimal? vBC = default(decimal?), decimal? pICMS = default(decimal?), decimal? vICMS = default(decimal?), decimal? vCred = default(decimal?), decimal? vICMSDeson = default(decimal?), string cBenef = default(string))
        {
