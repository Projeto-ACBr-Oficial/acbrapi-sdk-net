...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteSimpSefazGCBSSimp : IEquatable<CteSimpSefazGCBSSimp>, IValidatableObject
    {
        ...
        public CteSimpSefazGCBSSimp(decimal? pCBS = default(decimal?), CteSimpSefazDifSimp gDif = default(CteSimpSefazDifSimp), CteSimpSefazDevTribSimp gDevTrib = default(CteSimpSefazDevTribSimp), CteSimpSefazRedSimp gRed = default(CteSimpSefazRedSimp), decimal? vCBS = default(decimal?))
        {
