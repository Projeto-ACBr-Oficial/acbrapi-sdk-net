...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazGCBSSimp")]
    public partial class CteSimpSefazGCBSSimp : IEquatable<CteSimpSefazGCBSSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazGCBSSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazGCBSSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazGCBSSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazGCBSSimp(decimal? pCBS = default(decimal?), CteSimpSefazDifSimp gDif = default(CteSimpSefazDifSimp), CteSimpSefazDevTribSimp gDevTrib = default(CteSimpSefazDevTribSimp), CteSimpSefazRedSimp gRed = default(CteSimpSefazRedSimp), CteSimpSefazALCZFMCBSSimp gALCZFMCBS = default(CteSimpSefazALCZFMCBSSimp), decimal? vCBS = default(decimal?))
        {
            // to ensure "pCBS" is required (not null)
            if (pCBS == null)
            {
                throw new ArgumentNullException("pCBS is a required property for CteSimpSefazGCBSSimp and cannot be null");
            }
            this.pCBS = pCBS;
            // to ensure "vCBS" is required (not null)
            if (vCBS == null)
            {
                throw new ArgumentNullException("vCBS is a required property for CteSimpSefazGCBSSimp and cannot be null");
            }
            this.vCBS = vCBS;
            this.gDif = gDif;
        ...
        public CteSimpSefazALCZFMCBSSimp gALCZFMCBS { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazGCBSSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazGCBSSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazGCBSSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazGCBSSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazGCBSSimp input)
        {
            if (input == null)
            {
                return false;
