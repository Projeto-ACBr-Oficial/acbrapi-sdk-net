...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazCredPresOS")]
    public partial class CteOsSefazCredPresOS : IEquatable<CteOsSefazCredPresOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazCredPresOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazCredPresOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazCredPresOS" /> class.
        /// </summary>
        ...
        public CteOsSefazCredPresOS(string cCredPres = default(string), decimal? pCredPres = default(decimal?), decimal? vCredPres = default(decimal?), decimal? vCredPresCondSus = default(decimal?))
        {
            // to ensure "cCredPres" is required (not null)
            if (cCredPres == null)
            {
                throw new ArgumentNullException("cCredPres is a required property for CteOsSefazCredPresOS and cannot be null");
            }
            this.cCredPres = cCredPres;
            // to ensure "pCredPres" is required (not null)
            if (pCredPres == null)
            {
                throw new ArgumentNullException("pCredPres is a required property for CteOsSefazCredPresOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazCredPresOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazCredPresOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazCredPresOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazCredPresOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazCredPresOS input)
        {
            if (input == null)
            {
                return false;
