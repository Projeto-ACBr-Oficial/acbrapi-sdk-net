...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazGPagAntecipadoOS")]
    public partial class CteOsSefazGPagAntecipadoOS : IEquatable<CteOsSefazGPagAntecipadoOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGPagAntecipadoOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazGPagAntecipadoOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazGPagAntecipadoOS" /> class.
        /// </summary>
        ...
        public CteOsSefazGPagAntecipadoOS(string chCTePagAnt = default(string))
        {
            // to ensure "chCTePagAnt" is required (not null)
            if (chCTePagAnt == null)
            {
                throw new ArgumentNullException("chCTePagAnt is a required property for CteOsSefazGPagAntecipadoOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazGPagAntecipadoOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazGPagAntecipadoOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazGPagAntecipadoOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazGPagAntecipadoOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazGPagAntecipadoOS input)
        {
            if (input == null)
            {
                return false;
