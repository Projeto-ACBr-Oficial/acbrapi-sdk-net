...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazRed")]
    public partial class NfcomSefazRed : IEquatable<NfcomSefazRed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazRed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazRed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazRed" /> class.
        /// </summary>
        ...
        public NfcomSefazRed(decimal? pRedAliq = default(decimal?), decimal? pAliqEfet = default(decimal?))
        {
            // to ensure "pRedAliq" is required (not null)
            if (pRedAliq == null)
            {
                throw new ArgumentNullException("pRedAliq is a required property for NfcomSefazRed and cannot be null");
            }
            this.pRedAliq = pRedAliq;
            // to ensure "pAliqEfet" is required (not null)
            if (pAliqEfet == null)
            {
                throw new ArgumentNullException("pAliqEfet is a required property for NfcomSefazRed and cannot be null");
            }
        ...
        {
            return this.Equals(input as NfcomSefazRed);
        }

        /// <summary>
        /// Returns true if NfcomSefazRed instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazRed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazRed input)
        {
            if (input == null)
            {
                return false;
