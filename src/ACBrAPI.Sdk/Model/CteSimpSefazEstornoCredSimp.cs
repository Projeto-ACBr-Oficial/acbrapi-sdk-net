...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazEstornoCredSimp")]
    public partial class CteSimpSefazEstornoCredSimp : IEquatable<CteSimpSefazEstornoCredSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEstornoCredSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazEstornoCredSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEstornoCredSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazEstornoCredSimp(decimal? vIBSEstCred = default(decimal?), decimal? vCBSEstCred = default(decimal?))
        {
            // to ensure "vIBSEstCred" is required (not null)
            if (vIBSEstCred == null)
            {
                throw new ArgumentNullException("vIBSEstCred is a required property for CteSimpSefazEstornoCredSimp and cannot be null");
            }
            this.vIBSEstCred = vIBSEstCred;
            // to ensure "vCBSEstCred" is required (not null)
            if (vCBSEstCred == null)
            {
                throw new ArgumentNullException("vCBSEstCred is a required property for CteSimpSefazEstornoCredSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazEstornoCredSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazEstornoCredSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazEstornoCredSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazEstornoCredSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazEstornoCredSimp input)
        {
            if (input == null)
            {
                return false;
