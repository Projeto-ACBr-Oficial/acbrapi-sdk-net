...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazRed")]
    public partial class CteSefazRed : IEquatable<CteSefazRed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazRed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazRed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazRed" /> class.
        /// </summary>
        ...
        public CteSefazRed(decimal? pRedAliq = default(decimal?), decimal? pAliqEfet = default(decimal?))
        {
            // to ensure "pRedAliq" is required (not null)
            if (pRedAliq == null)
            {
                throw new ArgumentNullException("pRedAliq is a required property for CteSefazRed and cannot be null");
            }
            this.pRedAliq = pRedAliq;
            // to ensure "pAliqEfet" is required (not null)
            if (pAliqEfet == null)
            {
                throw new ArgumentNullException("pAliqEfet is a required property for CteSefazRed and cannot be null");
            }
        ...
        {
            return this.Equals(input as CteSefazRed);
        }

        /// <summary>
        /// Returns true if CteSefazRed instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazRed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazRed input)
        {
            if (input == null)
            {
                return false;
