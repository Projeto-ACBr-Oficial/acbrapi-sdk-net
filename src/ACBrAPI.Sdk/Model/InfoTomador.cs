...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class InfoTomador : IEquatable<InfoTomador>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InfoTomador" /> class.
        /// </summary>
        /// <param name="orgaoPublico">Indica se o tomador do serviço - um órgão público.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado. (default to false).</param>
        ...
        /// <summary>
        /// Indica se o tomador do serviço - um órgão público.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado.
        /// </summary>
        /// <value>Indica se o tomador do serviço - um órgão público.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado.</value>
