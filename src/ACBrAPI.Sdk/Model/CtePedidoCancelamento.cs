...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CtePedidoCancelamento")]
    public partial class CtePedidoCancelamento : IEquatable<CtePedidoCancelamento>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CtePedidoCancelamento" /> class.
        /// </summary>
        /// <param name="justificativa">Justificativa para o cancelamento. Preencheremos automaticamente, caso esteja em branco..</param>
        public CtePedidoCancelamento(string justificativa = default(string))
        {
        ...
        {
            return this.Equals(input as CtePedidoCancelamento);
        }

        /// <summary>
        /// Returns true if CtePedidoCancelamento instances are equal
        /// </summary>
        /// <param name="input">Instance of CtePedidoCancelamento to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CtePedidoCancelamento input)
        {
            if (input == null)
            {
                return false;
