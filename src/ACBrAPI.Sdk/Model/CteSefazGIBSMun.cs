...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazGIBSMun")]
    public partial class CteSefazGIBSMun : IEquatable<CteSefazGIBSMun>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazGIBSMun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazGIBSMun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazGIBSMun" /> class.
        /// </summary>
        ...
        public CteSefazGIBSMun(decimal? pIBSMun = default(decimal?), CteSefazDif gDif = default(CteSefazDif), CteSefazDevTrib gDevTrib = default(CteSefazDevTrib), CteSefazRed gRed = default(CteSefazRed), decimal? vIBSMun = default(decimal?))
        {
            // to ensure "pIBSMun" is required (not null)
            if (pIBSMun == null)
            {
                throw new ArgumentNullException("pIBSMun is a required property for CteSefazGIBSMun and cannot be null");
            }
            this.pIBSMun = pIBSMun;
            // to ensure "vIBSMun" is required (not null)
            if (vIBSMun == null)
            {
                throw new ArgumentNullException("vIBSMun is a required property for CteSefazGIBSMun and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazGIBSMun {\n");
        ...
        {
            return this.Equals(input as CteSefazGIBSMun);
        }

        /// <summary>
        /// Returns true if CteSefazGIBSMun instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazGIBSMun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazGIBSMun input)
        {
            if (input == null)
            {
                return false;
