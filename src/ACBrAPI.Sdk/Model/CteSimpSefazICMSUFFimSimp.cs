...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazICMSUFFimSimp")]
    public partial class CteSimpSefazICMSUFFimSimp : IEquatable<CteSimpSefazICMSUFFimSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMSUFFimSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazICMSUFFimSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMSUFFimSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazICMSUFFimSimp(decimal? vBCUFFim = default(decimal?), decimal? pFCPUFFim = default(decimal?), decimal? pICMSUFFim = default(decimal?), decimal? pICMSInter = default(decimal?), decimal? vFCPUFFim = default(decimal?), decimal? vICMSUFFim = default(decimal?), decimal? vICMSUFIni = default(decimal?))
        {
            // to ensure "vBCUFFim" is required (not null)
            if (vBCUFFim == null)
            {
                throw new ArgumentNullException("vBCUFFim is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
            this.vBCUFFim = vBCUFFim;
            // to ensure "pFCPUFFim" is required (not null)
            if (pFCPUFFim == null)
            {
                throw new ArgumentNullException("pFCPUFFim is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
            this.pFCPUFFim = pFCPUFFim;
            // to ensure "pICMSUFFim" is required (not null)
            if (pICMSUFFim == null)
            {
                throw new ArgumentNullException("pICMSUFFim is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
            this.pICMSUFFim = pICMSUFFim;
            // to ensure "pICMSInter" is required (not null)
            if (pICMSInter == null)
            {
                throw new ArgumentNullException("pICMSInter is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
            this.pICMSInter = pICMSInter;
            // to ensure "vFCPUFFim" is required (not null)
            if (vFCPUFFim == null)
            {
                throw new ArgumentNullException("vFCPUFFim is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
            this.vFCPUFFim = vFCPUFFim;
            // to ensure "vICMSUFFim" is required (not null)
            if (vICMSUFFim == null)
            {
                throw new ArgumentNullException("vICMSUFFim is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
            this.vICMSUFFim = vICMSUFFim;
            // to ensure "vICMSUFIni" is required (not null)
            if (vICMSUFIni == null)
            {
                throw new ArgumentNullException("vICMSUFIni is a required property for CteSimpSefazICMSUFFimSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazICMSUFFimSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazICMSUFFimSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazICMSUFFimSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazICMSUFFimSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazICMSUFFimSimp input)
        {
            if (input == null)
            {
                return false;
