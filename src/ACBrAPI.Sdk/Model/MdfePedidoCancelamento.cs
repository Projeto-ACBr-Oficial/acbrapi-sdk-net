...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MdfePedidoCancelamento")]
    public partial class MdfePedidoCancelamento : IEquatable<MdfePedidoCancelamento>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfePedidoCancelamento" /> class.
        /// </summary>
        /// <param name="justificativa">Justificativa para o cancelamento. Preencheremos automaticamente, caso esteja em branco..</param>
        public MdfePedidoCancelamento(string justificativa = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MdfePedidoCancelamento {\n");
        ...
        {
            return this.Equals(input as MdfePedidoCancelamento);
        }

        /// <summary>
        /// Returns true if MdfePedidoCancelamento instances are equal
        /// </summary>
        /// <param name="input">Instance of MdfePedidoCancelamento to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MdfePedidoCancelamento input)
        {
            if (input == null)
            {
                return false;
