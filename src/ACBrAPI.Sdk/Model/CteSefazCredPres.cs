...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazCredPres")]
    public partial class CteSefazCredPres : IEquatable<CteSefazCredPres>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazCredPres" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazCredPres() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazCredPres" /> class.
        /// </summary>
        ...
        public CteSefazCredPres(string cCredPres = default(string), decimal? pCredPres = default(decimal?), decimal? vCredPres = default(decimal?), decimal? vCredPresCondSus = default(decimal?))
        {
            // to ensure "cCredPres" is required (not null)
            if (cCredPres == null)
            {
                throw new ArgumentNullException("cCredPres is a required property for CteSefazCredPres and cannot be null");
            }
            this.cCredPres = cCredPres;
            // to ensure "pCredPres" is required (not null)
            if (pCredPres == null)
            {
                throw new ArgumentNullException("pCredPres is a required property for CteSefazCredPres and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazCredPres {\n");
        ...
        {
            return this.Equals(input as CteSefazCredPres);
        }

        /// <summary>
        /// Returns true if CteSefazCredPres instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazCredPres to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazCredPres input)
        {
            if (input == null)
            {
                return false;
