...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazICMS20OS")]
    public partial class CteOsSefazICMS20OS : IEquatable<CteOsSefazICMS20OS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazICMS20OS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazICMS20OS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazICMS20OS" /> class.
        /// </summary>
        ...
        public CteOsSefazICMS20OS(string cST = default(string), decimal? pRedBC = default(decimal?), decimal? vBC = default(decimal?), decimal? pICMS = default(decimal?), decimal? vICMS = default(decimal?), decimal? vICMSDeson = default(decimal?), string cBenef = default(string))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for CteOsSefazICMS20OS and cannot be null");
            }
            this.CST = cST;
            // to ensure "pRedBC" is required (not null)
            if (pRedBC == null)
            {
                throw new ArgumentNullException("pRedBC is a required property for CteOsSefazICMS20OS and cannot be null");
            }
            this.pRedBC = pRedBC;
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for CteOsSefazICMS20OS and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "pICMS" is required (not null)
            if (pICMS == null)
            {
                throw new ArgumentNullException("pICMS is a required property for CteOsSefazICMS20OS and cannot be null");
            }
            this.pICMS = pICMS;
            // to ensure "vICMS" is required (not null)
            if (vICMS == null)
            {
                throw new ArgumentNullException("vICMS is a required property for CteOsSefazICMS20OS and cannot be null");
            }
            this.vICMS = vICMS;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazICMS20OS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazICMS20OS);
        }

        /// <summary>
        /// Returns true if CteOsSefazICMS20OS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazICMS20OS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazICMS20OS input)
        {
            if (input == null)
            {
                return false;
