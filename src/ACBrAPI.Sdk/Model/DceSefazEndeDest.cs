...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DceSefazEndeDest")]
    public partial class DceSefazEndeDest : IEquatable<DceSefazEndeDest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazEndeDest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DceSefazEndeDest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DceSefazEndeDest" /> class.
        /// </summary>
        ...
        /// <param name="cPais">Código do país.  Utilizar a tabela do BACEN. (required).</param>
        /// <param name="xPais">Nome do país. (required).</param>
        /// <param name="fone">Telefone..</param>
        /// <param name="email">Endereço de E-mail..</param>
        public DceSefazEndeDest(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string uF = default(string), string cEP = default(string), string cPais = default(string), string xPais = default(string), string fone = default(string), string email = default(string))
        {
            // to ensure "xLgr" is required (not null)
            if (xLgr == null)
            {
                throw new ArgumentNullException("xLgr is a required property for DceSefazEndeDest and cannot be null");
            }
            this.xLgr = xLgr;
            // to ensure "nro" is required (not null)
            if (nro == null)
            {
                throw new ArgumentNullException("nro is a required property for DceSefazEndeDest and cannot be null");
            }
            this.nro = nro;
            // to ensure "xBairro" is required (not null)
            if (xBairro == null)
            {
                throw new ArgumentNullException("xBairro is a required property for DceSefazEndeDest and cannot be null");
            }
            this.xBairro = xBairro;
            // to ensure "cMun" is required (not null)
            if (cMun == null)
            {
                throw new ArgumentNullException("cMun is a required property for DceSefazEndeDest and cannot be null");
            }
            this.cMun = cMun;
            // to ensure "xMun" is required (not null)
            if (xMun == null)
            {
                throw new ArgumentNullException("xMun is a required property for DceSefazEndeDest and cannot be null");
            }
            this.xMun = xMun;
            // to ensure "uF" is required (not null)
            if (uF == null)
            {
                throw new ArgumentNullException("uF is a required property for DceSefazEndeDest and cannot be null");
            }
            this.UF = uF;
            // to ensure "cEP" is required (not null)
            if (cEP == null)
            {
                throw new ArgumentNullException("cEP is a required property for DceSefazEndeDest and cannot be null");
            }
            this.CEP = cEP;
            // to ensure "cPais" is required (not null)
            if (cPais == null)
            {
                throw new ArgumentNullException("cPais is a required property for DceSefazEndeDest and cannot be null");
            }
            this.cPais = cPais;
            // to ensure "xPais" is required (not null)
            if (xPais == null)
            {
                throw new ArgumentNullException("xPais is a required property for DceSefazEndeDest and cannot be null");
            }
            this.xPais = xPais;
            this.xCpl = xCpl;
            this.fone = fone;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DceSefazEndeDest {\n");
        ...
        {
            return this.Equals(input as DceSefazEndeDest);
        }

        /// <summary>
        /// Returns true if DceSefazEndeDest instances are equal
        /// </summary>
        /// <param name="input">Instance of DceSefazEndeDest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DceSefazEndeDest input)
        {
            if (input == null)
            {
                return false;
