...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazTribCompraGov")]
    public partial class NfeSefazTribCompraGov : IEquatable<NfeSefazTribCompraGov>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazTribCompraGov" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazTribCompraGov() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazTribCompraGov" /> class.
        /// </summary>
        ...
        public NfeSefazTribCompraGov(decimal? pAliqIBSUF = default(decimal?), decimal? vTribIBSUF = default(decimal?), decimal? pAliqIBSMun = default(decimal?), decimal? vTribIBSMun = default(decimal?), decimal? pAliqCBS = default(decimal?), decimal? vTribCBS = default(decimal?))
        {
            // to ensure "vTribIBSUF" is required (not null)
            if (vTribIBSUF == null)
            {
                throw new ArgumentNullException("vTribIBSUF is a required property for NfeSefazTribCompraGov and cannot be null");
            }
            this.vTribIBSUF = vTribIBSUF;
            // to ensure "vTribIBSMun" is required (not null)
            if (vTribIBSMun == null)
            {
                throw new ArgumentNullException("vTribIBSMun is a required property for NfeSefazTribCompraGov and cannot be null");
            }
            this.vTribIBSMun = vTribIBSMun;
            // to ensure "vTribCBS" is required (not null)
            if (vTribCBS == null)
            {
                throw new ArgumentNullException("vTribCBS is a required property for NfeSefazTribCompraGov and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazTribCompraGov {\n");
        ...
        {
            return this.Equals(input as NfeSefazTribCompraGov);
        }

        /// <summary>
        /// Returns true if NfeSefazTribCompraGov instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazTribCompraGov to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazTribCompraGov input)
        {
            if (input == null)
            {
                return false;
