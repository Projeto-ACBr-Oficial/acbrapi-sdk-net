...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazObsFiscoSimp")]
    public partial class CteSimpSefazObsFiscoSimp : IEquatable<CteSimpSefazObsFiscoSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazObsFiscoSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazObsFiscoSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazObsFiscoSimp" /> class.
        /// </summary>
        /// <param name="xCampo">Identificação do campo. (required).</param>
        /// <param name="xTexto">Conteúdo do campo. (required).</param>
        public CteSimpSefazObsFiscoSimp(string xCampo = default(string), string xTexto = default(string))
        {
            // to ensure "xCampo" is required (not null)
            if (xCampo == null)
            {
                throw new ArgumentNullException("xCampo is a required property for CteSimpSefazObsFiscoSimp and cannot be null");
            }
            this.xCampo = xCampo;
            // to ensure "xTexto" is required (not null)
            if (xTexto == null)
            {
                throw new ArgumentNullException("xTexto is a required property for CteSimpSefazObsFiscoSimp and cannot be null");
            }
            this.xTexto = xTexto;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazObsFiscoSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazObsFiscoSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazObsFiscoSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazObsFiscoSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazObsFiscoSimp input)
        {
            if (input == null)
            {
                return false;
