...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazInfCTeSuplOS")]
    public partial class CteOsSefazInfCTeSuplOS : IEquatable<CteOsSefazInfCTeSuplOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazInfCTeSuplOS" /> class.
        /// </summary>
        /// <param name="qrCodCTe">Texto com o QR-Code impresso no DACTE.    *Geramos automaticamente quando nenhum valor é informado.*.</param>
        public CteOsSefazInfCTeSuplOS(string qrCodCTe = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazInfCTeSuplOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazInfCTeSuplOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazInfCTeSuplOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazInfCTeSuplOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazInfCTeSuplOS input)
        {
            if (input == null)
            {
                return false;
