...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class NfeSefazGMonoRet : IEquatable<NfeSefazGMonoRet>, IValidatableObject
    {
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for adRemIBSRet, must be a value greater than or equal to 0.", new [] { "adRemIBSRet" });
            }

            // vIBSMonoRet (decimal?) minimum
            if (this.vIBSMonoRet < (decimal?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for vIBSMonoRet, must be a value greater than or equal to 0.", new [] { "vIBSMonoRet" });
            }

            // adRemCBSRet (decimal?) minimum
            if (this.adRemCBSRet < (decimal?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for adRemCBSRet, must be a value greater than or equal to 0.", new [] { "adRemCBSRet" });
            }

            // vCBSMonoRet (decimal?) minimum
            if (this.vCBSMonoRet < (decimal?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for vCBSMonoRet, must be a value greater than or equal to 0.", new [] { "vCBSMonoRet" });
            }
