...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InfoIntermediario")]
    public partial class InfoIntermediario : IEquatable<InfoIntermediario>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InfoIntermediario" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InfoIntermediario() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InfoIntermediario" /> class.
        /// </summary>
        ...
        /// <param name="iE">Número da inscrição estadual.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado..</param>
        ...
        public InfoIntermediario(string cNPJ = default(string), string cPF = default(string), string nIF = default(string), int? cNaoNIF = default(int?), string cAEPF = default(string), string iM = default(string), string iE = default(string), string xNome = default(string), Endereco end = default(Endereco), string fone = default(string), string email = default(string))
        {
            // to ensure "xNome" is required (not null)
            if (xNome == null)
            {
                throw new ArgumentNullException("xNome is a required property for InfoIntermediario and cannot be null");
            }
            this.xNome = xNome;
            this.CNPJ = cNPJ;
            this.CPF = cPF;
        ...
        /// </summary>
        /// <value>Número da inscrição estadual.    **Atenção**: Para emissões pelo Sistema Nacional NFS-e, esse campo é ignorado.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InfoIntermediario {\n");
        ...
        {
            return this.Equals(input as InfoIntermediario);
        }

        /// <summary>
        /// Returns true if InfoIntermediario instances are equal
        /// </summary>
        /// <param name="input">Instance of InfoIntermediario to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InfoIntermediario input)
        {
            if (input == null)
            {
                return false;
