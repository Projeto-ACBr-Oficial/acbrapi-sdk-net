...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazEstornoCred")]
    public partial class NfeSefazEstornoCred : IEquatable<NfeSefazEstornoCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazEstornoCred" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazEstornoCred() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazEstornoCred" /> class.
        /// </summary>
        ...
        public NfeSefazEstornoCred(decimal? vIBSEstCred = default(decimal?), decimal? vCBSEstCred = default(decimal?))
        {
            // to ensure "vIBSEstCred" is required (not null)
            if (vIBSEstCred == null)
            {
                throw new ArgumentNullException("vIBSEstCred is a required property for NfeSefazEstornoCred and cannot be null");
            }
            this.vIBSEstCred = vIBSEstCred;
            // to ensure "vCBSEstCred" is required (not null)
            if (vCBSEstCred == null)
            {
                throw new ArgumentNullException("vCBSEstCred is a required property for NfeSefazEstornoCred and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazEstornoCred {\n");
        ...
        {
            return this.Equals(input as NfeSefazEstornoCred);
        }

        /// <summary>
        /// Returns true if NfeSefazEstornoCred instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazEstornoCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazEstornoCred input)
        {
            if (input == null)
            {
                return false;
