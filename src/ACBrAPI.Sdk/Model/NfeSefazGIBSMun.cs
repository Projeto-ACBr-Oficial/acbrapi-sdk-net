...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazGIBSMun")]
    public partial class NfeSefazGIBSMun : IEquatable<NfeSefazGIBSMun>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGIBSMun" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazGIBSMun() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGIBSMun" /> class.
        /// </summary>
        ...
        public NfeSefazGIBSMun(decimal? pIBSMun = default(decimal?), NfeSefazDif gDif = default(NfeSefazDif), NfeSefazDevTrib gDevTrib = default(NfeSefazDevTrib), NfeSefazRed gRed = default(NfeSefazRed), decimal? vIBSMun = default(decimal?))
        {
            // to ensure "pIBSMun" is required (not null)
            if (pIBSMun == null)
            {
                throw new ArgumentNullException("pIBSMun is a required property for NfeSefazGIBSMun and cannot be null");
            }
            this.pIBSMun = pIBSMun;
            // to ensure "vIBSMun" is required (not null)
            if (vIBSMun == null)
            {
                throw new ArgumentNullException("vIBSMun is a required property for NfeSefazGIBSMun and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazGIBSMun {\n");
        ...
        {
            return this.Equals(input as NfeSefazGIBSMun);
        }

        /// <summary>
        /// Returns true if NfeSefazGIBSMun instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazGIBSMun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazGIBSMun input)
        {
            if (input == null)
            {
                return false;
