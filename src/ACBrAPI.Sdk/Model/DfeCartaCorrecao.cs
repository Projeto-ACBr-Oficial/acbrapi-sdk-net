...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// DfeCartaCorrecao
    /// </summary>
    [DataContract(Name = "DfeCartaCorrecao")]
    public partial class DfeCartaCorrecao : IEquatable<DfeCartaCorrecao>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DfeCartaCorrecao" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DfeCartaCorrecao);
        }

        /// <summary>
        /// Returns true if DfeCartaCorrecao instances are equal
        /// </summary>
        /// <param name="input">Instance of DfeCartaCorrecao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DfeCartaCorrecao input)
        {
            if (input == null)
            {
                return false;
