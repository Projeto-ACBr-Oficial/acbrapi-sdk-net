...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazEstornoCred")]
    public partial class NfcomSefazEstornoCred : IEquatable<NfcomSefazEstornoCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazEstornoCred" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazEstornoCred() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazEstornoCred" /> class.
        /// </summary>
        ...
        public NfcomSefazEstornoCred(decimal? vIBSEstCred = default(decimal?), decimal? vCBSEstCred = default(decimal?))
        {
            // to ensure "vIBSEstCred" is required (not null)
            if (vIBSEstCred == null)
            {
                throw new ArgumentNullException("vIBSEstCred is a required property for NfcomSefazEstornoCred and cannot be null");
            }
            this.vIBSEstCred = vIBSEstCred;
            // to ensure "vCBSEstCred" is required (not null)
            if (vCBSEstCred == null)
            {
                throw new ArgumentNullException("vCBSEstCred is a required property for NfcomSefazEstornoCred and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazEstornoCred {\n");
        ...
        {
            return this.Equals(input as NfcomSefazEstornoCred);
        }

        /// <summary>
        /// Returns true if NfcomSefazEstornoCred instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazEstornoCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazEstornoCred input)
        {
            if (input == null)
            {
                return false;
