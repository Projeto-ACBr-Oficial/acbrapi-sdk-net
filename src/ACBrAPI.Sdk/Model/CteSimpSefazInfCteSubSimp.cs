...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazInfCteSubSimp")]
    public partial class CteSimpSefazInfCteSubSimp : IEquatable<CteSimpSefazInfCteSubSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazInfCteSubSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazInfCteSubSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazInfCteSubSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazInfCteSubSimp(string chCte = default(string), int? indAlteraToma = default(int?))
        {
            // to ensure "chCte" is required (not null)
            if (chCte == null)
            {
                throw new ArgumentNullException("chCte is a required property for CteSimpSefazInfCteSubSimp and cannot be null");
            }
            this.chCte = chCte;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazInfCteSubSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazInfCteSubSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazInfCteSubSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazInfCteSubSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazInfCteSubSimp input)
        {
            if (input == null)
            {
                return false;
