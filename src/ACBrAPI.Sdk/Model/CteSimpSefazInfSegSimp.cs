...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazInfSegSimp")]
    public partial class CteSimpSefazInfSegSimp : IEquatable<CteSimpSefazInfSegSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazInfSegSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazInfSegSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazInfSegSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazInfSegSimp(string xSeg = default(string), string cNPJ = default(string))
        {
            // to ensure "xSeg" is required (not null)
            if (xSeg == null)
            {
                throw new ArgumentNullException("xSeg is a required property for CteSimpSefazInfSegSimp and cannot be null");
            }
            this.xSeg = xSeg;
            // to ensure "cNPJ" is required (not null)
            if (cNPJ == null)
            {
                throw new ArgumentNullException("cNPJ is a required property for CteSimpSefazInfSegSimp and cannot be null");
            }
            this.CNPJ = cNPJ;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazInfSegSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazInfSegSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazInfSegSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazInfSegSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazInfSegSimp input)
        {
            if (input == null)
            {
                return false;
