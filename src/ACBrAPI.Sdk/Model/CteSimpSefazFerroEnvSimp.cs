...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazFerroEnvSimp")]
    public partial class CteSimpSefazFerroEnvSimp : IEquatable<CteSimpSefazFerroEnvSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazFerroEnvSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazFerroEnvSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazFerroEnvSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazFerroEnvSimp(string cNPJ = default(string), string cInt = default(string), string iE = default(string), string xNome = default(string), CteSimpSefazEnderFerSimp enderFerro = default(CteSimpSefazEnderFerSimp))
        {
            // to ensure "cNPJ" is required (not null)
            if (cNPJ == null)
            {
                throw new ArgumentNullException("cNPJ is a required property for CteSimpSefazFerroEnvSimp and cannot be null");
            }
            this.CNPJ = cNPJ;
            // to ensure "xNome" is required (not null)
            if (xNome == null)
            {
                throw new ArgumentNullException("xNome is a required property for CteSimpSefazFerroEnvSimp and cannot be null");
            }
            this.xNome = xNome;
            // to ensure "enderFerro" is required (not null)
            if (enderFerro == null)
            {
                throw new ArgumentNullException("enderFerro is a required property for CteSimpSefazFerroEnvSimp and cannot be null");
            }
        ...
        public CteSimpSefazEnderFerSimp enderFerro { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazFerroEnvSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazFerroEnvSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazFerroEnvSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazFerroEnvSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazFerroEnvSimp input)
        {
            if (input == null)
            {
                return false;
