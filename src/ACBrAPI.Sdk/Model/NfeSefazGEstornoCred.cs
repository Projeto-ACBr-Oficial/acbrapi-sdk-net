...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazGEstornoCred")]
    public partial class NfeSefazGEstornoCred : IEquatable<NfeSefazGEstornoCred>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGEstornoCred" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazGEstornoCred() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGEstornoCred" /> class.
        /// </summary>
        ...
        public NfeSefazGEstornoCred(decimal? vIBSEstCred = default(decimal?), decimal? vCBSEstCred = default(decimal?))
        {
            // to ensure "vIBSEstCred" is required (not null)
            if (vIBSEstCred == null)
            {
                throw new ArgumentNullException("vIBSEstCred is a required property for NfeSefazGEstornoCred and cannot be null");
            }
            this.vIBSEstCred = vIBSEstCred;
            // to ensure "vCBSEstCred" is required (not null)
            if (vCBSEstCred == null)
            {
                throw new ArgumentNullException("vCBSEstCred is a required property for NfeSefazGEstornoCred and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazGEstornoCred {\n");
        ...
        {
            return this.Equals(input as NfeSefazGEstornoCred);
        }

        /// <summary>
        /// Returns true if NfeSefazGEstornoCred instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazGEstornoCred to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazGEstornoCred input)
        {
            if (input == null)
            {
                return false;
