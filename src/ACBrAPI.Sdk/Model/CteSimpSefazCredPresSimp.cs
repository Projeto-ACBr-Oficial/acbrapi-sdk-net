...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazCredPresSimp")]
    public partial class CteSimpSefazCredPresSimp : IEquatable<CteSimpSefazCredPresSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazCredPresSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazCredPresSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazCredPresSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazCredPresSimp(string cCredPres = default(string), decimal? pCredPres = default(decimal?), decimal? vCredPres = default(decimal?), decimal? vCredPresCondSus = default(decimal?))
        {
            // to ensure "cCredPres" is required (not null)
            if (cCredPres == null)
            {
                throw new ArgumentNullException("cCredPres is a required property for CteSimpSefazCredPresSimp and cannot be null");
            }
            this.cCredPres = cCredPres;
            // to ensure "pCredPres" is required (not null)
            if (pCredPres == null)
            {
                throw new ArgumentNullException("pCredPres is a required property for CteSimpSefazCredPresSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazCredPresSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazCredPresSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazCredPresSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazCredPresSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazCredPresSimp input)
        {
            if (input == null)
            {
                return false;
