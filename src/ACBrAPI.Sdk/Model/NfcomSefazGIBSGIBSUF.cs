...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazGIBS_GIBSUF")]
    public partial class NfcomSefazGIBSGIBSUF : IEquatable<NfcomSefazGIBSGIBSUF>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazGIBSGIBSUF" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazGIBSGIBSUF() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazGIBSGIBSUF" /> class.
        /// </summary>
        ...
        public NfcomSefazGIBSGIBSUF(decimal? vDif = default(decimal?), decimal? vDevTrib = default(decimal?), decimal? vIBSUF = default(decimal?))
        {
            // to ensure "vDif" is required (not null)
            if (vDif == null)
            {
                throw new ArgumentNullException("vDif is a required property for NfcomSefazGIBSGIBSUF and cannot be null");
            }
            this.vDif = vDif;
            // to ensure "vDevTrib" is required (not null)
            if (vDevTrib == null)
            {
                throw new ArgumentNullException("vDevTrib is a required property for NfcomSefazGIBSGIBSUF and cannot be null");
            }
            this.vDevTrib = vDevTrib;
            // to ensure "vIBSUF" is required (not null)
            if (vIBSUF == null)
            {
                throw new ArgumentNullException("vIBSUF is a required property for NfcomSefazGIBSGIBSUF and cannot be null");
            }
            this.vIBSUF = vIBSUF;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazGIBSGIBSUF {\n");
        ...
        {
            return this.Equals(input as NfcomSefazGIBSGIBSUF);
        }

        /// <summary>
        /// Returns true if NfcomSefazGIBSGIBSUF instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazGIBSGIBSUF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazGIBSGIBSUF input)
        {
            if (input == null)
            {
                return false;
