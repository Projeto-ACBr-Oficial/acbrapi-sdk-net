...
namespace ACBrAPI.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazInfSolicNFF" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MdfeSefazInfSolicNFF() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazInfSolicNFF" /> class.
        /// </summary>
        ...
        public MdfeSefazInfSolicNFF(string xSolic = default(string))
        {
            // to ensure "xSolic" is required (not null)
            if (xSolic == null)
            {
                throw new ArgumentNullException("xSolic is a required property for MdfeSefazInfSolicNFF and cannot be null");
            }
            this.xSolic = xSolic;
        }
        ...
        {
            return this.Equals(input as MdfeSefazInfSolicNFF);
        }

        /// <summary>
        /// Returns true if MdfeSefazInfSolicNFF instances are equal
        /// </summary>
        /// <param name="input">Instance of MdfeSefazInfSolicNFF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MdfeSefazInfSolicNFF input)
        {
            if (input == null)
            {
                return false;
