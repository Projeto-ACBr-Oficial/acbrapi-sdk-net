...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// CteCartaCorrecao
    /// </summary>
    [DataContract(Name = "CteCartaCorrecao")]
    public partial class CteCartaCorrecao : IEquatable<CteCartaCorrecao>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CteCartaCorrecao" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteCartaCorrecao() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteCartaCorrecao" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteCartaCorrecao {\n");
        ...
        {
            return this.Equals(input as CteCartaCorrecao);
        }

        /// <summary>
        /// Returns true if CteCartaCorrecao instances are equal
        /// </summary>
        /// <param name="input">Instance of CteCartaCorrecao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteCartaCorrecao input)
        {
            if (input == null)
            {
                return false;
