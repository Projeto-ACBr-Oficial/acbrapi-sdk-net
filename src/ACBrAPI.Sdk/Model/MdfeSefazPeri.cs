...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MdfeSefazPeri")]
    public partial class MdfeSefazPeri : IEquatable<MdfeSefazPeri>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazPeri" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MdfeSefazPeri() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazPeri" /> class.
        /// </summary>
        ...
        public MdfeSefazPeri(string nONU = default(string), string xNomeAE = default(string), string xClaRisco = default(string), string grEmb = default(string), string qTotProd = default(string), string qVolTipo = default(string))
        {
            // to ensure "nONU" is required (not null)
            if (nONU == null)
            {
                throw new ArgumentNullException("nONU is a required property for MdfeSefazPeri and cannot be null");
            }
            this.nONU = nONU;
            // to ensure "qTotProd" is required (not null)
            if (qTotProd == null)
            {
                throw new ArgumentNullException("qTotProd is a required property for MdfeSefazPeri and cannot be null");
            }
        ...
        {
            return this.Equals(input as MdfeSefazPeri);
        }

        /// <summary>
        /// Returns true if MdfeSefazPeri instances are equal
        /// </summary>
        /// <param name="input">Instance of MdfeSefazPeri to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MdfeSefazPeri input)
        {
            if (input == null)
            {
                return false;
