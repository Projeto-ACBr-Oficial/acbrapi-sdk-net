...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazALCZFMCBS")]
    public partial class NfcomSefazALCZFMCBS : IEquatable<NfcomSefazALCZFMCBS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazALCZFMCBS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazALCZFMCBS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazALCZFMCBS" /> class.
        /// </summary>
        ...
        public NfcomSefazALCZFMCBS(decimal? pAliqEfetRegCBS = default(decimal?), decimal? vTribRegCBS = default(decimal?))
        {
            // to ensure "pAliqEfetRegCBS" is required (not null)
            if (pAliqEfetRegCBS == null)
            {
                throw new ArgumentNullException("pAliqEfetRegCBS is a required property for NfcomSefazALCZFMCBS and cannot be null");
            }
            this.pAliqEfetRegCBS = pAliqEfetRegCBS;
            // to ensure "vTribRegCBS" is required (not null)
            if (vTribRegCBS == null)
            {
                throw new ArgumentNullException("vTribRegCBS is a required property for NfcomSefazALCZFMCBS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazALCZFMCBS {\n");
        ...
        {
            return this.Equals(input as NfcomSefazALCZFMCBS);
        }

        /// <summary>
        /// Returns true if NfcomSefazALCZFMCBS instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazALCZFMCBS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazALCZFMCBS input)
        {
            if (input == null)
            {
                return false;
