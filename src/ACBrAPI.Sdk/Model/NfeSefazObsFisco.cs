...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazObsFisco")]
    public partial class NfeSefazObsFisco : IEquatable<NfeSefazObsFisco>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazObsFisco" /> class.
        /// </summary>
        /// <param name="xCampo">xCampo.</param>
        /// <param name="xTexto">xTexto.</param>
        public NfeSefazObsFisco(string xCampo = default(string), string xTexto = default(string))
        {
            this.xCampo = xCampo;
            this.xTexto = xTexto;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazObsFisco {\n");
        ...
        {
            return this.Equals(input as NfeSefazObsFisco);
        }

        /// <summary>
        /// Returns true if NfeSefazObsFisco instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazObsFisco to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazObsFisco input)
        {
            if (input == null)
            {
                return false;
