...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazGCBS")]
    public partial class NfeSefazGCBS : IEquatable<NfeSefazGCBS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGCBS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazGCBS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGCBS" /> class.
        /// </summary>
        ...
        public NfeSefazGCBS(decimal? pCBS = default(decimal?), NfeSefazDif gDif = default(NfeSefazDif), NfeSefazDevTrib gDevTrib = default(NfeSefazDevTrib), NfeSefazRed gRed = default(NfeSefazRed), decimal? vCBS = default(decimal?))
        {
            ...
            if (pCBS == null)
            {
                throw new ArgumentNullException("pCBS is a required property for NfeSefazGCBS and cannot be null");
            }
            this.pCBS = pCBS;
            // to ensure "vCBS" is required (not null)
            if (vCBS == null)
            {
                throw new ArgumentNullException("vCBS is a required property for NfeSefazGCBS and cannot be null");
            }
            this.vCBS = vCBS;
            this.gDif = gDif;
        ...
        {
            return this.Equals(input as NfeSefazGCBS);
        }

        /// <summary>
        /// Returns true if NfeSefazGCBS instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazGCBS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazGCBS input)
        {
            if (input == null)
            {
                return false;
