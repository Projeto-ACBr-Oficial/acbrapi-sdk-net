...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// CteOsPedidoEmissao
    /// </summary>
    [DataContract(Name = "CteOsPedidoEmissao")]
    public partial class CteOsPedidoEmissao : IEquatable<CteOsPedidoEmissao>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsPedidoEmissao" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsPedidoEmissao() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsPedidoEmissao" /> class.
        /// </summary>
        ...
        public CteOsPedidoEmissao(CteOsSefazInfCteOS infCte = default(CteOsSefazInfCteOS), CteOsSefazInfCTeSuplOS infCTeSupl = default(CteOsSefazInfCTeSuplOS), AmbienteEnum ambiente = default(AmbienteEnum), string referencia = default(string))
        {
            // to ensure "infCte" is required (not null)
            if (infCte == null)
            {
                throw new ArgumentNullException("infCte is a required property for CteOsPedidoEmissao and cannot be null");
            }
            this.infCte = infCte;
        ...
        public CteOsSefazInfCteOS infCte { get; set; }

        /// <summary>
        /// Gets or Sets infCTeSupl
        /// </summary>
        [DataMember(Name = "infCTeSupl", EmitDefaultValue = false)]
        public CteOsSefazInfCTeSuplOS infCTeSupl { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsPedidoEmissao {\n");
        ...
        {
            return this.Equals(input as CteOsPedidoEmissao);
        }

        /// <summary>
        /// Returns true if CteOsPedidoEmissao instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsPedidoEmissao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsPedidoEmissao input)
        {
            if (input == null)
            {
                return false;
