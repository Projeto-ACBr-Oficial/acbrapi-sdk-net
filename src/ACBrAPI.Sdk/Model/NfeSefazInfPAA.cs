...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazInfPAA")]
    public partial class NfeSefazInfPAA : IEquatable<NfeSefazInfPAA>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazInfPAA" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazInfPAA() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazInfPAA" /> class.
        /// </summary>
        ...
        public NfeSefazInfPAA(string cNPJPAA = default(string), NfeSefazPAASignature pAASignature = default(NfeSefazPAASignature))
        {
            // to ensure "cNPJPAA" is required (not null)
            if (cNPJPAA == null)
            {
                throw new ArgumentNullException("cNPJPAA is a required property for NfeSefazInfPAA and cannot be null");
            }
            this.CNPJPAA = cNPJPAA;
            // to ensure "pAASignature" is required (not null)
            if (pAASignature == null)
            {
                throw new ArgumentNullException("pAASignature is a required property for NfeSefazInfPAA and cannot be null");
            }
        ...
        public NfeSefazPAASignature PAASignature { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfeSefazInfPAA {\n");
        ...
        {
            return this.Equals(input as NfeSefazInfPAA);
        }

        /// <summary>
        /// Returns true if NfeSefazInfPAA instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazInfPAA to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazInfPAA input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // CNPJPAA (string) maxLength
            if (this.CNPJPAA != null && this.CNPJPAA.Length > 14)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CNPJPAA, length must be less than 14.", new [] { "CNPJPAA" });
            }
