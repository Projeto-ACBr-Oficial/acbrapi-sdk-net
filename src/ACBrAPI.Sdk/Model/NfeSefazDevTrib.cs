...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfeSefazDevTrib")]
    public partial class NfeSefazDevTrib : IEquatable<NfeSefazDevTrib>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazDevTrib" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazDevTrib() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazDevTrib" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NfeSefazDevTrib);
        }

        /// <summary>
        /// Returns true if NfeSefazDevTrib instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazDevTrib to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazDevTrib input)
        {
            if (input == null)
            {
                return false;
