...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazDifSimp")]
    public partial class CteSimpSefazDifSimp : IEquatable<CteSimpSefazDifSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazDifSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazDifSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazDifSimp" /> class.
        /// </summary>
        /// <param name="pDif">Percentual do diferimento. (required).</param>
        /// <param name="vDif">Valor do diferimento. (required).</param>
        public CteSimpSefazDifSimp(decimal? pDif = default(decimal?), decimal? vDif = default(decimal?))
        {
            // to ensure "pDif" is required (not null)
            if (pDif == null)
            {
                throw new ArgumentNullException("pDif is a required property for CteSimpSefazDifSimp and cannot be null");
            }
            this.pDif = pDif;
            // to ensure "vDif" is required (not null)
            if (vDif == null)
            {
                throw new ArgumentNullException("vDif is a required property for CteSimpSefazDifSimp and cannot be null");
            }
            this.vDif = vDif;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazDifSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazDifSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazDifSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazDifSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazDifSimp input)
        {
            if (input == null)
            {
                return false;
