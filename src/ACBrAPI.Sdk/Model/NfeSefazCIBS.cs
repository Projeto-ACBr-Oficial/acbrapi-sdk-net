...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// NfeSefazCIBS
    /// </summary>
    [DataContract(Name = "NfeSefazCIBS")]
    public partial class NfeSefazCIBS : IEquatable<NfeSefazCIBS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazCIBS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazCIBS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazCIBS" /> class.
        /// </summary>
        ...
        public NfeSefazCIBS(decimal? vBC = default(decimal?), NfeSefazGIBSUF gIBSUF = default(NfeSefazGIBSUF), NfeSefazGIBSMun gIBSMun = default(NfeSefazGIBSMun), decimal? vIBS = default(decimal?), NfeSefazGCBS gCBS = default(NfeSefazGCBS), NfeSefazTribRegular gTribRegular = default(NfeSefazTribRegular), NfeSefazCredPres gIBSCredPres = default(NfeSefazCredPres), NfeSefazCredPres gCBSCredPres = default(NfeSefazCredPres), NfeSefazTribCompraGov gTribCompraGov = default(NfeSefazTribCompraGov))
        {
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for NfeSefazCIBS and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "gIBSUF" is required (not null)
            if (gIBSUF == null)
            {
                throw new ArgumentNullException("gIBSUF is a required property for NfeSefazCIBS and cannot be null");
            }
            this.gIBSUF = gIBSUF;
            // to ensure "gIBSMun" is required (not null)
            if (gIBSMun == null)
            {
                throw new ArgumentNullException("gIBSMun is a required property for NfeSefazCIBS and cannot be null");
            }
            this.gIBSMun = gIBSMun;
            // to ensure "vIBS" is required (not null)
            if (vIBS == null)
            {
                throw new ArgumentNullException("vIBS is a required property for NfeSefazCIBS and cannot be null");
            }
            this.vIBS = vIBS;
            // to ensure "gCBS" is required (not null)
            if (gCBS == null)
            {
                throw new ArgumentNullException("gCBS is a required property for NfeSefazCIBS and cannot be null");
            }
            this.gCBS = gCBS;
        ...
        public NfeSefazGCBS gCBS { get; set; }

        /// <summary>
        /// Gets or Sets gTribRegular
        /// </summary>
        [DataMember(Name = "gTribRegular", EmitDefaultValue = false)]
        public NfeSefazTribRegular gTribRegular { get; set; }
        ...
        public NfeSefazTribCompraGov gTribCompraGov { get; set; }
        ...
        {
            return this.Equals(input as NfeSefazCIBS);
        }

        /// <summary>
        /// Returns true if NfeSefazCIBS instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazCIBS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazCIBS input)
        {
            if (input == null)
            {
                return false;
