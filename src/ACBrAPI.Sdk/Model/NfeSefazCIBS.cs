...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class NfeSefazCIBS : IEquatable<NfeSefazCIBS>, IValidatableObject
    {
        ...
        public NfeSefazCIBS(decimal? vBC = default(decimal?), NfeSefazGIBSUF gIBSUF = default(NfeSefazGIBSUF), NfeSefazGIBSMun gIBSMun = default(NfeSefazGIBSMun), decimal? vIBS = default(decimal?), NfeSefazGCBS gCBS = default(NfeSefazGCBS), NfeSefazTribRegular gTribRegular = default(NfeSefazTribRegular), NfeSefazTribCompraGov gTribCompraGov = default(NfeSefazTribCompraGov))
        {
