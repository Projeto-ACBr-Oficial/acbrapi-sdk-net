...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MdfeSefazRespTec")]
    public partial class MdfeSefazRespTec : IEquatable<MdfeSefazRespTec>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazRespTec" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MdfeSefazRespTec() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazRespTec" /> class.
        /// </summary>
        ...
        public MdfeSefazRespTec(string cNPJ = default(string), string xContato = default(string), string email = default(string), string fone = default(string), int? idCSRT = default(int?), string cSRT = default(string), string hashCSRT = default(string))
        {
            // to ensure "cNPJ" is required (not null)
            if (cNPJ == null)
            {
                throw new ArgumentNullException("cNPJ is a required property for MdfeSefazRespTec and cannot be null");
            }
            this.CNPJ = cNPJ;
            // to ensure "xContato" is required (not null)
            if (xContato == null)
            {
                throw new ArgumentNullException("xContato is a required property for MdfeSefazRespTec and cannot be null");
            }
            this.xContato = xContato;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for MdfeSefazRespTec and cannot be null");
            }
            this.email = email;
            // to ensure "fone" is required (not null)
            if (fone == null)
            {
                throw new ArgumentNullException("fone is a required property for MdfeSefazRespTec and cannot be null");
            }
            this.fone = fone;
            this.idCSRT = idCSRT;
            this.CSRT = cSRT;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MdfeSefazRespTec {\n");
        ...
        {
            return this.Equals(input as MdfeSefazRespTec);
        }

        /// <summary>
        /// Returns true if MdfeSefazRespTec instances are equal
        /// </summary>
        /// <param name="input">Instance of MdfeSefazRespTec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MdfeSefazRespTec input)
        {
            if (input == null)
            {
                return false;
