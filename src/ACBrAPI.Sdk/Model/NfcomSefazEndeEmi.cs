...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazEndeEmi")]
    public partial class NfcomSefazEndeEmi : IEquatable<NfcomSefazEndeEmi>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazEndeEmi" /> class.
        /// </summary>
        ...
        public NfcomSefazEndeEmi(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string cEP = default(string), string uF = default(string), string fone = default(string), string email = default(string))
        {
            this.xLgr = xLgr;
            this.nro = nro;
            this.xCpl = xCpl;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NfcomSefazEndeEmi {\n");
        ...
        {
            return this.Equals(input as NfcomSefazEndeEmi);
        }

        /// <summary>
        /// Returns true if NfcomSefazEndeEmi instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazEndeEmi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazEndeEmi input)
        {
            if (input == null)
            {
                return false;
