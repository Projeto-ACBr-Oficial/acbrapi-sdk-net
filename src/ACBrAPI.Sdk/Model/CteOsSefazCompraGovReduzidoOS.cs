...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazCompraGovReduzidoOS")]
    public partial class CteOsSefazCompraGovReduzidoOS : IEquatable<CteOsSefazCompraGovReduzidoOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazCompraGovReduzidoOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazCompraGovReduzidoOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazCompraGovReduzidoOS" /> class.
        /// </summary>
        ...
        public CteOsSefazCompraGovReduzidoOS(int? tpEnteGov = default(int?), decimal? pRedutor = default(decimal?), int? tpOperGov = default(int?), List<string> refDFeAnt = default(List<string>))
        {
            // to ensure "tpEnteGov" is required (not null)
            if (tpEnteGov == null)
            {
                throw new ArgumentNullException("tpEnteGov is a required property for CteOsSefazCompraGovReduzidoOS and cannot be null");
            }
            this.tpEnteGov = tpEnteGov;
            // to ensure "pRedutor" is required (not null)
            if (pRedutor == null)
            {
                throw new ArgumentNullException("pRedutor is a required property for CteOsSefazCompraGovReduzidoOS and cannot be null");
            }
            this.pRedutor = pRedutor;
            // to ensure "tpOperGov" is required (not null)
            if (tpOperGov == null)
            {
                throw new ArgumentNullException("tpOperGov is a required property for CteOsSefazCompraGovReduzidoOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazCompraGovReduzidoOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazCompraGovReduzidoOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazCompraGovReduzidoOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazCompraGovReduzidoOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazCompraGovReduzidoOS input)
        {
            if (input == null)
            {
                return false;
