...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnderObraEvento")]
    public partial class EnderObraEvento : IEquatable<EnderObraEvento>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnderObraEvento" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnderObraEvento() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnderObraEvento" /> class.
        /// </summary>
        ...
        public EnderObraEvento(string cEP = default(string), EnderExtSimples endExt = default(EnderExtSimples), string xLgr = default(string), string tpLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string))
        {
            // to ensure "xLgr" is required (not null)
            if (xLgr == null)
            {
                throw new ArgumentNullException("xLgr is a required property for EnderObraEvento and cannot be null");
            }
            this.xLgr = xLgr;
            // to ensure "nro" is required (not null)
            if (nro == null)
            {
                throw new ArgumentNullException("nro is a required property for EnderObraEvento and cannot be null");
            }
            this.nro = nro;
            // to ensure "xBairro" is required (not null)
            if (xBairro == null)
            {
                throw new ArgumentNullException("xBairro is a required property for EnderObraEvento and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnderObraEvento {\n");
        ...
        {
            return this.Equals(input as EnderObraEvento);
        }

        /// <summary>
        /// Returns true if EnderObraEvento instances are equal
        /// </summary>
        /// <param name="input">Instance of EnderObraEvento to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnderObraEvento input)
        {
            if (input == null)
            {
                return false;
