...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazPeriSimp")]
    public partial class CteSimpSefazPeriSimp : IEquatable<CteSimpSefazPeriSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazPeriSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazPeriSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazPeriSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazPeriSimp(string nONU = default(string), string qTotEmb = default(string), CteSimpSefazInfTotAPSimp infTotAP = default(CteSimpSefazInfTotAPSimp))
        {
            // to ensure "nONU" is required (not null)
            if (nONU == null)
            {
                throw new ArgumentNullException("nONU is a required property for CteSimpSefazPeriSimp and cannot be null");
            }
            this.nONU = nONU;
            // to ensure "qTotEmb" is required (not null)
            if (qTotEmb == null)
            {
                throw new ArgumentNullException("qTotEmb is a required property for CteSimpSefazPeriSimp and cannot be null");
            }
            this.qTotEmb = qTotEmb;
            // to ensure "infTotAP" is required (not null)
            if (infTotAP == null)
            {
                throw new ArgumentNullException("infTotAP is a required property for CteSimpSefazPeriSimp and cannot be null");
            }
        ...
        public CteSimpSefazInfTotAPSimp infTotAP { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazPeriSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazPeriSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazPeriSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazPeriSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazPeriSimp input)
        {
            if (input == null)
            {
                return false;
