...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazGIBSMunSimp")]
    public partial class CteSimpSefazGIBSMunSimp : IEquatable<CteSimpSefazGIBSMunSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazGIBSMunSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazGIBSMunSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazGIBSMunSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazGIBSMunSimp(decimal? pIBSMun = default(decimal?), CteSimpSefazDifSimp gDif = default(CteSimpSefazDifSimp), CteSimpSefazDevTribSimp gDevTrib = default(CteSimpSefazDevTribSimp), CteSimpSefazRedSimp gRed = default(CteSimpSefazRedSimp), decimal? vIBSMun = default(decimal?))
        {
            // to ensure "pIBSMun" is required (not null)
            if (pIBSMun == null)
            {
                throw new ArgumentNullException("pIBSMun is a required property for CteSimpSefazGIBSMunSimp and cannot be null");
            }
            this.pIBSMun = pIBSMun;
            // to ensure "vIBSMun" is required (not null)
            if (vIBSMun == null)
            {
                throw new ArgumentNullException("vIBSMun is a required property for CteSimpSefazGIBSMunSimp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazGIBSMunSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazGIBSMunSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazGIBSMunSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazGIBSMunSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazGIBSMunSimp input)
        {
            if (input == null)
            {
                return false;
