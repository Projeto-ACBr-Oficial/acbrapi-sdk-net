...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazRodoSimp")]
    public partial class CteSimpSefazRodoSimp : IEquatable<CteSimpSefazRodoSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazRodoSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazRodoSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazRodoSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazRodoSimp(string rNTRC = default(string), List<CteSimpSefazOccSimp> occ = default(List<CteSimpSefazOccSimp>))
        {
            // to ensure "rNTRC" is required (not null)
            if (rNTRC == null)
            {
                throw new ArgumentNullException("rNTRC is a required property for CteSimpSefazRodoSimp and cannot be null");
            }
            this.RNTRC = rNTRC;
            this.occ = occ;
        }
        ...
        public List<CteSimpSefazOccSimp> occ { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazRodoSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazRodoSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazRodoSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazRodoSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazRodoSimp input)
        {
            if (input == null)
            {
                return false;
