...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Informações das NF.
    /// </summary>
    [DataContract(Name = "CteSimpSefazInfNFSimp")]
    public partial class CteSimpSefazInfNFSimp : IEquatable<CteSimpSefazInfNFSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazInfNFSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazInfNFSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazInfNFSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazInfNFSimp(string serie = default(string), string nDoc = default(string), decimal? unidRat = default(decimal?))
        {
            // to ensure "serie" is required (not null)
            if (serie == null)
            {
                throw new ArgumentNullException("serie is a required property for CteSimpSefazInfNFSimp and cannot be null");
            }
            this.serie = serie;
            // to ensure "nDoc" is required (not null)
            if (nDoc == null)
            {
                throw new ArgumentNullException("nDoc is a required property for CteSimpSefazInfNFSimp and cannot be null");
            }
            this.nDoc = nDoc;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazInfNFSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazInfNFSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazInfNFSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazInfNFSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazInfNFSimp input)
        {
            if (input == null)
            {
                return false;
