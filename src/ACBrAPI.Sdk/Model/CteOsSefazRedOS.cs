...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazRedOS")]
    public partial class CteOsSefazRedOS : IEquatable<CteOsSefazRedOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazRedOS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteOsSefazRedOS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazRedOS" /> class.
        /// </summary>
        ...
        public CteOsSefazRedOS(decimal? pRedAliq = default(decimal?), decimal? pAliqEfet = default(decimal?))
        {
            ...
            if (pRedAliq == null)
            {
                throw new ArgumentNullException("pRedAliq is a required property for CteOsSefazRedOS and cannot be null");
            }
            this.pRedAliq = pRedAliq;
            // to ensure "pAliqEfet" is required (not null)
            if (pAliqEfet == null)
            {
                throw new ArgumentNullException("pAliqEfet is a required property for CteOsSefazRedOS and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazRedOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazRedOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazRedOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazRedOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazRedOS input)
        {
            if (input == null)
            {
                return false;
