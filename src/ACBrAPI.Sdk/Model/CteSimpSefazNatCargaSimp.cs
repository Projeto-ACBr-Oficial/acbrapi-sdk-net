...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Natureza da carga.
    /// </summary>
    [DataContract(Name = "CteSimpSefazNatCargaSimp")]
    public partial class CteSimpSefazNatCargaSimp : IEquatable<CteSimpSefazNatCargaSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazNatCargaSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazNatCargaSimp(string xDime = default(string), List<string> cInfManu = default(List<string>))
        {
            this.xDime = xDime;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazNatCargaSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazNatCargaSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazNatCargaSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazNatCargaSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazNatCargaSimp input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for xDime, length must be less than 14.", new [] { "xDime" });
            }

            // xDime (string) minLength
            if (this.xDime != null && this.xDime.Length < 5)
            {
                yield return new ValidationResult("Invalid value for xDime, length must be greater than 5.", new [] { "xDime" });
            }
