...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Totalização do IBS.
    /// </summary>
    [DataContract(Name = "NfeSefazGIBS")]
    public partial class NfeSefazGIBS : IEquatable<NfeSefazGIBS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGIBS" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfeSefazGIBS() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfeSefazGIBS" /> class.
        /// </summary>
        ...
        public NfeSefazGIBS(NfeSefazGIBSGIBSUF gIBSUF = default(NfeSefazGIBSGIBSUF), NfeSefazGIBSGIBSMun gIBSMun = default(NfeSefazGIBSGIBSMun), decimal? vIBS = default(decimal?), decimal? vCredPres = default(decimal?), decimal? vCredPresCondSus = default(decimal?))
        {
            // to ensure "gIBSUF" is required (not null)
            if (gIBSUF == null)
            {
                throw new ArgumentNullException("gIBSUF is a required property for NfeSefazGIBS and cannot be null");
            }
            this.gIBSUF = gIBSUF;
            // to ensure "gIBSMun" is required (not null)
            if (gIBSMun == null)
            {
                throw new ArgumentNullException("gIBSMun is a required property for NfeSefazGIBS and cannot be null");
            }
            this.gIBSMun = gIBSMun;
            // to ensure "vIBS" is required (not null)
            if (vIBS == null)
            {
                throw new ArgumentNullException("vIBS is a required property for NfeSefazGIBS and cannot be null");
            }
            this.vIBS = vIBS;
            // to ensure "vCredPres" is required (not null)
            if (vCredPres == null)
            {
                throw new ArgumentNullException("vCredPres is a required property for NfeSefazGIBS and cannot be null");
            }
            this.vCredPres = vCredPres;
            // to ensure "vCredPresCondSus" is required (not null)
            if (vCredPresCondSus == null)
            {
                throw new ArgumentNullException("vCredPresCondSus is a required property for NfeSefazGIBS and cannot be null");
            }
        ...
        public NfeSefazGIBSGIBSUF gIBSUF { get; set; }

        /// <summary>
        /// Gets or Sets gIBSMun
        /// </summary>
        [DataMember(Name = "gIBSMun", IsRequired = true, EmitDefaultValue = true)]
        public NfeSefazGIBSGIBSMun gIBSMun { get; set; }
        ...
        {
            return this.Equals(input as NfeSefazGIBS);
        }

        /// <summary>
        /// Returns true if NfeSefazGIBS instances are equal
        /// </summary>
        /// <param name="input">Instance of NfeSefazGIBS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfeSefazGIBS input)
        {
            if (input == null)
            {
                return false;
