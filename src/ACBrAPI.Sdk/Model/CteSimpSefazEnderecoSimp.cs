...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// Dados do endereço.
    /// </summary>
    [DataContract(Name = "CteSimpSefazEnderecoSimp")]
    public partial class CteSimpSefazEnderecoSimp : IEquatable<CteSimpSefazEnderecoSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEnderecoSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazEnderecoSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazEnderecoSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazEnderecoSimp(string xLgr = default(string), string nro = default(string), string xCpl = default(string), string xBairro = default(string), string cMun = default(string), string xMun = default(string), string cEP = default(string), string uF = default(string), string cPais = default(string), string xPais = default(string))
        {
            // to ensure "xLgr" is required (not null)
            if (xLgr == null)
            {
                throw new ArgumentNullException("xLgr is a required property for CteSimpSefazEnderecoSimp and cannot be null");
            }
            this.xLgr = xLgr;
            // to ensure "nro" is required (not null)
            if (nro == null)
            {
                throw new ArgumentNullException("nro is a required property for CteSimpSefazEnderecoSimp and cannot be null");
            }
            this.nro = nro;
            // to ensure "xBairro" is required (not null)
            if (xBairro == null)
            {
                throw new ArgumentNullException("xBairro is a required property for CteSimpSefazEnderecoSimp and cannot be null");
            }
            this.xBairro = xBairro;
            // to ensure "cMun" is required (not null)
            if (cMun == null)
            {
                throw new ArgumentNullException("cMun is a required property for CteSimpSefazEnderecoSimp and cannot be null");
            }
            this.cMun = cMun;
            // to ensure "xMun" is required (not null)
            if (xMun == null)
            {
                throw new ArgumentNullException("xMun is a required property for CteSimpSefazEnderecoSimp and cannot be null");
            }
            this.xMun = xMun;
            // to ensure "uF" is required (not null)
            if (uF == null)
            {
                throw new ArgumentNullException("uF is a required property for CteSimpSefazEnderecoSimp and cannot be null");
            }
            this.UF = uF;
            this.xCpl = xCpl;
            this.CEP = cEP;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazEnderecoSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazEnderecoSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazEnderecoSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazEnderecoSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazEnderecoSimp input)
        {
            if (input == null)
            {
                return false;
