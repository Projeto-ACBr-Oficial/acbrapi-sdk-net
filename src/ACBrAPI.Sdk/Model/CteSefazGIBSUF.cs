...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazGIBSUF")]
    public partial class CteSefazGIBSUF : IEquatable<CteSefazGIBSUF>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazGIBSUF" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazGIBSUF() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazGIBSUF" /> class.
        /// </summary>
        ...
        public CteSefazGIBSUF(decimal? pIBSUF = default(decimal?), CteSefazDif gDif = default(CteSefazDif), CteSefazDevTrib gDevTrib = default(CteSefazDevTrib), CteSefazRed gRed = default(CteSefazRed), decimal? vIBSUF = default(decimal?))
        {
            // to ensure "pIBSUF" is required (not null)
            if (pIBSUF == null)
            {
                throw new ArgumentNullException("pIBSUF is a required property for CteSefazGIBSUF and cannot be null");
            }
            this.pIBSUF = pIBSUF;
            // to ensure "vIBSUF" is required (not null)
            if (vIBSUF == null)
            {
                throw new ArgumentNullException("vIBSUF is a required property for CteSefazGIBSUF and cannot be null");
            }
            this.vIBSUF = vIBSUF;
            this.gDif = gDif;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazGIBSUF {\n");
        ...
        {
            return this.Equals(input as CteSefazGIBSUF);
        }

        /// <summary>
        /// Returns true if CteSefazGIBSUF instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazGIBSUF to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazGIBSUF input)
        {
            if (input == null)
            {
                return false;
