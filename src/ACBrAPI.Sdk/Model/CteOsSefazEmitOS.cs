...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteOsSefazEmitOS : IEquatable<CteOsSefazEmitOS>, IValidatableObject
    {
        ...
        public CteOsSefazEmitOS(string cNPJ = default(string), string iE = default(string), string iEST = default(string), string xNome = default(string), string xFant = default(string), CteOsSefazEndeEmiOS enderEmit = default(CteOsSefazEndeEmiOS), int? cRT = default(int?))
        {
            this.CNPJ = cNPJ;
            this.IE = iE;
            this.IEST = iEST;
