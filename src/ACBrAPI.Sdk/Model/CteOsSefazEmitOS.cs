...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteOsSefazEmitOS")]
    public partial class CteOsSefazEmitOS : IEquatable<CteOsSefazEmitOS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteOsSefazEmitOS" /> class.
        /// </summary>
        ...
        public CteOsSefazEmitOS(string cNPJ = default(string), string iE = default(string), string iEST = default(string), string xNome = default(string), string xFant = default(string), CteOsSefazEndeEmiOS enderEmit = default(CteOsSefazEndeEmiOS), int? cRT = default(int?), string iSUFEmit = default(string))
        {
            this.CNPJ = cNPJ;
            this.IE = iE;
            this.IEST = iEST;
        ...
        public CteOsSefazEndeEmiOS enderEmit { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteOsSefazEmitOS {\n");
        ...
        {
            return this.Equals(input as CteOsSefazEmitOS);
        }

        /// <summary>
        /// Returns true if CteOsSefazEmitOS instances are equal
        /// </summary>
        /// <param name="input">Instance of CteOsSefazEmitOS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteOsSefazEmitOS input)
        {
            if (input == null)
            {
                return false;
