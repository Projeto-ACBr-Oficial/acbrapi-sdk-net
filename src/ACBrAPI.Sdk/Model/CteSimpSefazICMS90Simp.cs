...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// ICMS Outros.
    /// </summary>
    [DataContract(Name = "CteSimpSefazICMS90Simp")]
    public partial class CteSimpSefazICMS90Simp : IEquatable<CteSimpSefazICMS90Simp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMS90Simp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazICMS90Simp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMS90Simp" /> class.
        /// </summary>
        ...
        public CteSimpSefazICMS90Simp(string cST = default(string), decimal? pRedBC = default(decimal?), decimal? vBC = default(decimal?), decimal? pICMS = default(decimal?), decimal? vICMS = default(decimal?), decimal? vCred = default(decimal?), decimal? vICMSDeson = default(decimal?), string cBenef = default(string))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for CteSimpSefazICMS90Simp and cannot be null");
            }
            this.CST = cST;
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for CteSimpSefazICMS90Simp and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "pICMS" is required (not null)
            if (pICMS == null)
            {
                throw new ArgumentNullException("pICMS is a required property for CteSimpSefazICMS90Simp and cannot be null");
            }
            this.pICMS = pICMS;
            // to ensure "vICMS" is required (not null)
            if (vICMS == null)
            {
                throw new ArgumentNullException("vICMS is a required property for CteSimpSefazICMS90Simp and cannot be null");
            }
            this.vICMS = vICMS;
            this.pRedBC = pRedBC;
            this.vCred = vCred;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazICMS90Simp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazICMS90Simp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazICMS90Simp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazICMS90Simp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazICMS90Simp input)
        {
            if (input == null)
            {
                return false;
