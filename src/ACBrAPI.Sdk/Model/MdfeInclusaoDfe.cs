...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// MdfeInclusaoDfe
    /// </summary>
    [DataContract(Name = "MdfeInclusaoDfe")]
    public partial class MdfeInclusaoDfe : IEquatable<MdfeInclusaoDfe>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeInclusaoDfe" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MdfeInclusaoDfe);
        }

        /// <summary>
        /// Returns true if MdfeInclusaoDfe instances are equal
        /// </summary>
        /// <param name="input">Instance of MdfeInclusaoDfe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MdfeInclusaoDfe input)
        {
            if (input == null)
            {
                return false;
