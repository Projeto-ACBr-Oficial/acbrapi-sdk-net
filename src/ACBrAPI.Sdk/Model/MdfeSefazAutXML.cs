...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MdfeSefazAutXML")]
    public partial class MdfeSefazAutXML : IEquatable<MdfeSefazAutXML>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MdfeSefazAutXML" /> class.
        /// </summary>
        ...
        public MdfeSefazAutXML(string cNPJ = default(string), string cPF = default(string))
        {
            this.CNPJ = cNPJ;
            this.CPF = cPF;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MdfeSefazAutXML {\n");
        ...
        {
            return this.Equals(input as MdfeSefazAutXML);
        }

        /// <summary>
        /// Returns true if MdfeSefazAutXML instances are equal
        /// </summary>
        /// <param name="input">Instance of MdfeSefazAutXML to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MdfeSefazAutXML input)
        {
            if (input == null)
            {
                return false;
