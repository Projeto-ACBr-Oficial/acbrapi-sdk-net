...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NfcomSefazICMS20")]
    public partial class NfcomSefazICMS20 : IEquatable<NfcomSefazICMS20>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazICMS20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NfcomSefazICMS20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NfcomSefazICMS20" /> class.
        /// </summary>
        ...
        public NfcomSefazICMS20(string cST = default(string), decimal? pRedBC = default(decimal?), decimal? vBC = default(decimal?), decimal? pICMS = default(decimal?), decimal? vICMS = default(decimal?), decimal? vICMSDeson = default(decimal?), string cBenef = default(string), decimal? pFCP = default(decimal?), decimal? vFCP = default(decimal?))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for NfcomSefazICMS20 and cannot be null");
            }
            this.CST = cST;
            // to ensure "pRedBC" is required (not null)
            if (pRedBC == null)
            {
                throw new ArgumentNullException("pRedBC is a required property for NfcomSefazICMS20 and cannot be null");
            }
            this.pRedBC = pRedBC;
            // to ensure "vBC" is required (not null)
            if (vBC == null)
            {
                throw new ArgumentNullException("vBC is a required property for NfcomSefazICMS20 and cannot be null");
            }
            this.vBC = vBC;
            // to ensure "pICMS" is required (not null)
            if (pICMS == null)
            {
                throw new ArgumentNullException("pICMS is a required property for NfcomSefazICMS20 and cannot be null");
            }
            this.pICMS = pICMS;
            // to ensure "vICMS" is required (not null)
            if (vICMS == null)
            {
                throw new ArgumentNullException("vICMS is a required property for NfcomSefazICMS20 and cannot be null");
            }
            this.vICMS = vICMS;
        ...
        {
            return this.Equals(input as NfcomSefazICMS20);
        }

        /// <summary>
        /// Returns true if NfcomSefazICMS20 instances are equal
        /// </summary>
        /// <param name="input">Instance of NfcomSefazICMS20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NfcomSefazICMS20 input)
        {
            if (input == null)
            {
                return false;
