...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazAereoSimp")]
    public partial class CteSimpSefazAereoSimp : IEquatable<CteSimpSefazAereoSimp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazAereoSimp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazAereoSimp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazAereoSimp" /> class.
        /// </summary>
        ...
        public CteSimpSefazAereoSimp(int? nMinu = default(int?), string nOCA = default(string), DateTime? dPrevAereo = default(DateTime?), CteSimpSefazNatCargaSimp natCarga = default(CteSimpSefazNatCargaSimp), CteSimpSefazTarifaSimp tarifa = default(CteSimpSefazTarifaSimp), List<CteSimpSefazPeriSimp> peri = default(List<CteSimpSefazPeriSimp>))
        {
            // to ensure "dPrevAereo" is required (not null)
            if (dPrevAereo == null)
            {
                throw new ArgumentNullException("dPrevAereo is a required property for CteSimpSefazAereoSimp and cannot be null");
            }
            this.dPrevAereo = dPrevAereo;
            // to ensure "natCarga" is required (not null)
            if (natCarga == null)
            {
                throw new ArgumentNullException("natCarga is a required property for CteSimpSefazAereoSimp and cannot be null");
            }
            this.natCarga = natCarga;
            // to ensure "tarifa" is required (not null)
            if (tarifa == null)
            {
                throw new ArgumentNullException("tarifa is a required property for CteSimpSefazAereoSimp and cannot be null");
            }
            this.tarifa = tarifa;
            this.nMinu = nMinu;
            this.nOCA = nOCA;
        ...
        public CteSimpSefazNatCargaSimp natCarga { get; set; }

        /// <summary>
        /// Gets or Sets tarifa
        /// </summary>
        [DataMember(Name = "tarifa", IsRequired = true, EmitDefaultValue = true)]
        public CteSimpSefazTarifaSimp tarifa { get; set; }

        /// <summary>
        /// Gets or Sets peri
        /// </summary>
        [DataMember(Name = "peri", EmitDefaultValue = false)]
        public List<CteSimpSefazPeriSimp> peri { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazAereoSimp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazAereoSimp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazAereoSimp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazAereoSimp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazAereoSimp input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for nMinu, must be a value less than or equal to 999999999.", new [] { "nMinu" });
            }

            // nMinu (int?) minimum
            if (this.nMinu < (int?)0)
            {
                yield return new ValidationResult("Invalid value for nMinu, must be a value greater than or equal to 0.", new [] { "nMinu" });
            }
