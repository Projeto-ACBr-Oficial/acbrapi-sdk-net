...
namespace ACBrAPI.Sdk.Model
{
    ...
    public partial class CteOsSefazCIBSOS : IEquatable<CteOsSefazCIBSOS>, IValidatableObject
    {
        ...
        public CteOsSefazCIBSOS(decimal? vBC = default(decimal?), CteOsSefazGIBSUFOS gIBSUF = default(CteOsSefazGIBSUFOS), CteOsSefazGIBSMunOS gIBSMun = default(CteOsSefazGIBSMunOS), decimal? vIBS = default(decimal?), CteOsSefazGCBSOS gCBS = default(CteOsSefazGCBSOS), CteOsSefazTribRegularOS gTribRegular = default(CteOsSefazTribRegularOS), CteOsSefazTribCompraGovOS gTribCompraGov = default(CteOsSefazTribCompraGovOS))
        {
