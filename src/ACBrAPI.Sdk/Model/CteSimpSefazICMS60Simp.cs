...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSimpSefazICMS60Simp")]
    public partial class CteSimpSefazICMS60Simp : IEquatable<CteSimpSefazICMS60Simp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMS60Simp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSimpSefazICMS60Simp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSimpSefazICMS60Simp" /> class.
        /// </summary>
        ...
        public CteSimpSefazICMS60Simp(string cST = default(string), decimal? vBCSTRet = default(decimal?), decimal? vICMSSTRet = default(decimal?), decimal? pICMSSTRet = default(decimal?), decimal? vCred = default(decimal?), decimal? vICMSDeson = default(decimal?), string cBenef = default(string))
        {
            // to ensure "cST" is required (not null)
            if (cST == null)
            {
                throw new ArgumentNullException("cST is a required property for CteSimpSefazICMS60Simp and cannot be null");
            }
            this.CST = cST;
            // to ensure "vBCSTRet" is required (not null)
            if (vBCSTRet == null)
            {
                throw new ArgumentNullException("vBCSTRet is a required property for CteSimpSefazICMS60Simp and cannot be null");
            }
            this.vBCSTRet = vBCSTRet;
            // to ensure "vICMSSTRet" is required (not null)
            if (vICMSSTRet == null)
            {
                throw new ArgumentNullException("vICMSSTRet is a required property for CteSimpSefazICMS60Simp and cannot be null");
            }
            this.vICMSSTRet = vICMSSTRet;
            // to ensure "pICMSSTRet" is required (not null)
            if (pICMSSTRet == null)
            {
                throw new ArgumentNullException("pICMSSTRet is a required property for CteSimpSefazICMS60Simp and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSimpSefazICMS60Simp {\n");
        ...
        {
            return this.Equals(input as CteSimpSefazICMS60Simp);
        }

        /// <summary>
        /// Returns true if CteSimpSefazICMS60Simp instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSimpSefazICMS60Simp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSimpSefazICMS60Simp input)
        {
            if (input == null)
            {
                return false;
