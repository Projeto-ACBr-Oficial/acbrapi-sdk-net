...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DcePedidoCancelamento")]
    public partial class DcePedidoCancelamento : IEquatable<DcePedidoCancelamento>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DcePedidoCancelamento" /> class.
        /// </summary>
        /// <param name="justificativa">Justificativa para o cancelamento. Preencheremos automaticamente, caso esteja em branco..</param>
        public DcePedidoCancelamento(string justificativa = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DcePedidoCancelamento {\n");
        ...
        {
            return this.Equals(input as DcePedidoCancelamento);
        }

        /// <summary>
        /// Returns true if DcePedidoCancelamento instances are equal
        /// </summary>
        /// <param name="input">Instance of DcePedidoCancelamento to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DcePedidoCancelamento input)
        {
            if (input == null)
            {
                return false;
