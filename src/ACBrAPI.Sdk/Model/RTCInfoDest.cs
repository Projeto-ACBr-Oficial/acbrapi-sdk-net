...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RTCInfoDest")]
    public partial class RTCInfoDest : IEquatable<RTCInfoDest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RTCInfoDest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RTCInfoDest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RTCInfoDest" /> class.
        /// </summary>
        /// <param name="cNPJ">Número da inscrição no Cadastro Nacional de Pessoa Jurídica (CNPJ) do Destinatário do serviço..</param>
        /// <param name="cPF">Número da inscrição no Cadastro de Pessoa Física (CPF) do Destinatário do serviço..</param>
        ...
        /// <param name="xNome">Nome / Nome Empresarial do do Destinatário do serviço. (required).</param>
        /// <param name="end">end.</param>
        /// <param name="fone">Número do telefone do Destinatário do serviço  (Preencher com o Código DDD + número do telefone. Nas operações com exterior é permitido informar o  código do país + código da localidade + número do telefone)..</param>
        /// <param name="email">* E-mail do Destinatário do serviço.</param>
        public RTCInfoDest(string cNPJ = default(string), string cPF = default(string), string nIF = default(string), int? cNaoNIF = default(int?), string xNome = default(string), Endereco end = default(Endereco), string fone = default(string), string email = default(string))
        {
            // to ensure "xNome" is required (not null)
            if (xNome == null)
            {
                throw new ArgumentNullException("xNome is a required property for RTCInfoDest and cannot be null");
            }
            this.xNome = xNome;
            this.CNPJ = cNPJ;
            this.CPF = cPF;
        ...
        /// </summary>
        /// <value>Número da inscrição no Cadastro Nacional de Pessoa Jurídica (CNPJ) do Destinatário do serviço.</value>
        ...
        /// </summary>
        /// <value>Número da inscrição no Cadastro de Pessoa Física (CPF) do Destinatário do serviço.</value>
        ...
        /// </summary>
        /// <value>Nome / Nome Empresarial do do Destinatário do serviço.</value>
        ...
        /// <summary>
        /// Número do telefone do Destinatário do serviço  (Preencher com o Código DDD + número do telefone. Nas operações com exterior é permitido informar o  código do país + código da localidade + número do telefone).
        /// </summary>
        /// <value>Número do telefone do Destinatário do serviço  (Preencher com o Código DDD + número do telefone. Nas operações com exterior é permitido informar o  código do país + código da localidade + número do telefone).</value>
        ...
        /// </summary>
        /// <value>* E-mail do Destinatário do serviço</value>
        ...
        {
            return this.Equals(input as RTCInfoDest);
        }

        /// <summary>
        /// Returns true if RTCInfoDest instances are equal
        /// </summary>
        /// <param name="input">Instance of RTCInfoDest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RTCInfoDest input)
        {
            if (input == null)
            {
                return false;
