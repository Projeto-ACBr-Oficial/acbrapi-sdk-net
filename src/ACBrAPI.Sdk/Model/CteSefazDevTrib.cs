...
namespace ACBrAPI.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CteSefazDevTrib")]
    public partial class CteSefazDevTrib : IEquatable<CteSefazDevTrib>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazDevTrib" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CteSefazDevTrib() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CteSefazDevTrib" /> class.
        /// </summary>
        ...
        public CteSefazDevTrib(decimal? pDevTrib = default(decimal?), decimal? vDevTrib = default(decimal?))
        {
            // to ensure "vDevTrib" is required (not null)
            if (vDevTrib == null)
            {
                throw new ArgumentNullException("vDevTrib is a required property for CteSefazDevTrib and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CteSefazDevTrib {\n");
        ...
        {
            return this.Equals(input as CteSefazDevTrib);
        }

        /// <summary>
        /// Returns true if CteSefazDevTrib instances are equal
        /// </summary>
        /// <param name="input">Instance of CteSefazDevTrib to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CteSefazDevTrib input)
        {
            if (input == null)
            {
                return false;
