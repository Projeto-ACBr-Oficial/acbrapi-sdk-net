# ACBrAPI.Sdk.Model.CteOsSefazIdeOS
...
**procEmi** | **int?** | Identificador do processo de emissão do CTe OS.  Preencher com:         0 - emissão de CTe com aplicativo do contribuinte  * 3 - emissão CTe pelo contribuinte com aplicativo fornecido pelo Fisco | 
...
**gCompraGov** | [**CteOsSefazCompraGovReduzidoOS**](CteOsSefazCompraGovReduzidoOS.md) |  | [optional] 
