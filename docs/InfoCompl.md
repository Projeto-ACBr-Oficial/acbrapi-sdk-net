...
**xPed** | **string** | Número do  pedido/ordem de compra/ordem de serviço/projeto que autorize a prestação do serviço em operações B2B - Informação de interesse do tomador do serviço para controle e gestão da Negociação. | [optional] 
**gItemPed** | [**InfoItemPed**](InfoItemPed.md) |  | [optional] 
