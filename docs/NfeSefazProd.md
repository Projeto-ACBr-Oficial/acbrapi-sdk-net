# ACBrAPI.Sdk.Model.NfeSefazProd
...
**tpCredPresIBSZFM** | **int?** | Classificação para subapuração do IBS na ZFM. | [optional] 
...
**indBemMovelUsado** | **int?** | Indicador de fornecimento de bem móvel usado: 1-Bem Móvel Usado. | [optional] 
