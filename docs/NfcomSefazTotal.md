# ACBrAPI.Sdk.Model.NfcomSefazTotal
...
**IBSCBSTot** | [**NfcomSefazIBSCBSTot**](NfcomSefazIBSCBSTot.md) |  | [optional] 
**vTotDFe** | **decimal?** | Valor total do documento fiscal  (vNF + total do IBS + total da CBS). | [optional] 
