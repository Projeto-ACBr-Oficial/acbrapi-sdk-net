# ACBrAPI.Sdk.Model.NfseLoteDpsPedidoEmissao
...
**numeroLote** | **long?** | Número do lote. Use apenas quando a numeração automática estiver desativada na configuração da empresa. | [optional] 
