...
namespace Example
{
    public class BaixarPdfDceExample
    {
        public static void Main()
        {
            ...
            {
                // Baixar PDF do DACE
                FileParameter result = apiInstance.BaixarPdfDce(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.BaixarPdfDce: " + e.Message);
...
#### Usando a variante BaixarPdfDceWithHttpInfo
...
{
    // Baixar PDF do DACE
    ApiResponse<FileParameter> response = apiInstance.BaixarPdfDceWithHttpInfo(id);
...
{
    Debug.Print("Exceção ao chamar DceApi.BaixarPdfDceWithHttpInfo: " + e.Message);
...
namespace Example
{
    public class BaixarXmlCancelamentoDceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Baixar XML do cancelamento
                FileParameter result = apiInstance.BaixarXmlCancelamentoDce(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.BaixarXmlCancelamentoDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante BaixarXmlCancelamentoDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Baixar XML do cancelamento
    ApiResponse<FileParameter> response = apiInstance.BaixarXmlCancelamentoDceWithHttpInfo(id);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.BaixarXmlCancelamentoDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BaixarXmlDceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Baixar XML da DC-e processada
                FileParameter result = apiInstance.BaixarXmlDce(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.BaixarXmlDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante BaixarXmlDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Baixar XML da DC-e processada
    ApiResponse<FileParameter> response = apiInstance.BaixarXmlDceWithHttpInfo(id);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.BaixarXmlDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BaixarXmlDceDeclaracaoExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Baixar XML da DC-e
                FileParameter result = apiInstance.BaixarXmlDceDeclaracao(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.BaixarXmlDceDeclaracao: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante BaixarXmlDceDeclaracaoWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Baixar XML da DC-e
    ApiResponse<FileParameter> response = apiInstance.BaixarXmlDceDeclaracaoWithHttpInfo(id);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.BaixarXmlDceDeclaracaoWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class BaixarXmlDceProtocoloExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Baixar XML do Protocolo da SEFAZ
                FileParameter result = apiInstance.BaixarXmlDceProtocolo(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.BaixarXmlDceProtocolo: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante BaixarXmlDceProtocoloWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Baixar XML do Protocolo da SEFAZ
    ApiResponse<FileParameter> response = apiInstance.BaixarXmlDceProtocoloWithHttpInfo(id);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.BaixarXmlDceProtocoloWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **CancelarDce**
> DfeCancelamento CancelarDce (string id, DcePedidoCancelamento body = null)
...
namespace Example
{
    public class CancelarDceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Cancelar uma DC-e autorizada
                DfeCancelamento result = apiInstance.CancelarDce(id, body);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.CancelarDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante CancelarDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Cancelar uma DC-e autorizada
    ApiResponse<DfeCancelamento> response = apiInstance.CancelarDceWithHttpInfo(id, body);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.CancelarDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ConsultarCancelamentoDceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Consultar o cancelamento da DC-e
                DfeCancelamento result = apiInstance.ConsultarCancelamentoDce(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.ConsultarCancelamentoDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante ConsultarCancelamentoDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Consultar o cancelamento da DC-e
    ApiResponse<DfeCancelamento> response = apiInstance.ConsultarCancelamentoDceWithHttpInfo(id);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.ConsultarCancelamentoDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class ConsultarDceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Consultar DC-e
                Dfe result = apiInstance.ConsultarDce(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.ConsultarDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante ConsultarDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Consultar DC-e
    ApiResponse<Dfe> response = apiInstance.ConsultarDceWithHttpInfo(id);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.ConsultarDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> DfeSefazStatus ConsultarStatusSefazDce (string cpfCnpj, string autorizador = null)
...
namespace Example
{
    public class ConsultarStatusSefazDceExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var autorizador = "autorizador_example";  // string | Ambiente Autorizador.    Autorizadores disponíveis: `AN`.    *Caso não seja informado, será utilizado o ambiente autorizador da UF do emitente.* (optional) 

            try
            {
                // Consulta do Status do Serviço na SEFAZ Autorizadora
                DfeSefazStatus result = apiInstance.ConsultarStatusSefazDce(cpfCnpj, autorizador);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.ConsultarStatusSefazDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante ConsultarStatusSefazDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Consulta do Status do Serviço na SEFAZ Autorizadora
    ApiResponse<DfeSefazStatus> response = apiInstance.ConsultarStatusSefazDceWithHttpInfo(cpfCnpj, autorizador);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.ConsultarStatusSefazDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class EmitirDceExample
    {
        public static void Main()
        {
            ...
            HttpClientHandler httpClientHandler = new HttpClientHandler();
            var apiInstance = new DceApi(httpClient, config, httpClientHandler);
            var body = new DcePedidoEmissao(); // DcePedidoEmissao | 

            try
            {
                // Emitir DC-e
                Dfe result = apiInstance.EmitirDce(body);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.EmitirDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante EmitirDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Emitir DC-e
    ApiResponse<Dfe> response = apiInstance.EmitirDceWithHttpInfo(body);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.EmitirDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a name="listardce"></a>
# **ListarDce**
> DfeListagem ListarDce (string cpfCnpj, string ambiente, int? top = null, int? skip = null, bool? inlinecount = null, string referencia = null, string chave = null, string serie = null)
...
namespace Example
{
    public class ListarDceExample
    {
        public static void Main()
        {
            ...
            {
                // Listar DC-e
                DfeListagem result = apiInstance.ListarDce(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling DceApi.ListarDce: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Usando a variante ListarDceWithHttpInfo
Esses métodos retornam um objeto ApiResponse que contêm os dados da resposta, o código de status e os headers HTTP.
...
{
    // Listar DC-e
    ApiResponse<DfeListagem> response = apiInstance.ListarDceWithHttpInfo(cpfCnpj, ambiente, top, skip, inlinecount, referencia, chave, serie);
    Debug.Write("Código de status: " + response.StatusCode);
    Debug.Write("Headers da resposta: " + response.Headers);
    Debug.Write("Conteúdo da resposta: " + response.Data);
}
...
{
    Debug.Print("Exceção ao chamar DceApi.ListarDceWithHttpInfo: " + e.Message);
    Debug.Print("Código de status: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
