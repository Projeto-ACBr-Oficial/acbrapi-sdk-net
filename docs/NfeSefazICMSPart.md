# ACBrAPI.Sdk.Model.NfeSefazICMSPart
...
**motDesICMS** | **int?** | Motivo da desoneração do ICMS:9-Outros;10&#x3D;Deficiente Condutor (Convênio ICMS 38/12) 11&#x3D;Deficiente Não Condutor (Convênio ICMS 38/12). | [optional] 
