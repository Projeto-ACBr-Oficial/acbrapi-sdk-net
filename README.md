...
O SDK da ACBr API para .NET está [disponível no Nuget](https://www.nuget.org/packages/ACBrAPI.Sdk). 
Para adicionar o SDK ao seu projeto, basta instalar o package `ACBrAPI.Sdk` utilizando sua ferramenta preferida de gerenciamento de packages do Nuget.

Se preferir instalar a partir do console/terminal:

```
PM> Install-Package ACBrAPI.Sdk
```

Ou a partir do .NET CLI (cross-platform:

```
dotnet add package ACBrAPI.Sdk
```

<a name="usage"></a>
## Utilização

Após adicionar o package `ACBrAPI.Sdk` ao seu projeto C#, use os namespaces:
```csharp
...
*ContaApi* | [**ConsultarCotaPrePago**](docs\ContaApi.md#consultarcotaprepago) | **GET** /conta/cotas/prepago | Consultar o resumo da cota de créditos pré-pagos.
*ContaApi* | [**ListarCotasConta**](docs\ContaApi.md#listarcotasconta) | **GET** /conta/cotas | Consultar os limites de uso e consumo das cotas disponíveis, exceto a cota de créditos pré-pagos.
*ContaApi* | [**ListarExtratoCreditosConta**](docs\ContaApi.md#listarextratocreditosconta) | **GET** /conta/extrato | Consultar o extrato de movimentação de créditos do tenant atual.
...
*EmpresaApi* | [**ListarCertificados**](docs\EmpresaApi.md#listarcertificados) | **GET** /empresas/certificados | Listar certificados
...
## Documentação dos DTOs
 ...
 - [Model.ContaCotaPrePago](docs\ContaCotaPrePago.md)
 - [Model.ContaExtratoCredito](docs\ContaExtratoCredito.md)
 - [Model.ContaExtratoCreditoListagem](docs\ContaExtratoCreditoListagem.md)
 ...
 - [Model.CteOsSefazALCZFMCBSOS](docs\CteOsSefazALCZFMCBSOS.md)
 - [Model.CteOsSefazAutXMLOS](docs\CteOsSefazAutXMLOS.md)
 - [Model.CteOsSefazCIBSOS](docs\CteOsSefazCIBSOS.md)
 ...
 - [Model.CteOsSefazCompraGovReduzidoOS](docs\CteOsSefazCompraGovReduzidoOS.md)
 - [Model.CteOsSefazDevTribOS](docs\CteOsSefazDevTribOS.md)
 - [Model.CteOsSefazDifOS](docs\CteOsSefazDifOS.md)
 ...
 - [Model.CteOsSefazEstornoCredOS](docs\CteOsSefazEstornoCredOS.md)
 - [Model.CteOsSefazFatOS](docs\CteOsSefazFatOS.md)
 - [Model.CteOsSefazGCBSOS](docs\CteOsSefazGCBSOS.md)
 - [Model.CteOsSefazGIBSMunOS](docs\CteOsSefazGIBSMunOS.md)
 - [Model.CteOsSefazGIBSUFOS](docs\CteOsSefazGIBSUFOS.md)
 - [Model.CteOsSefazGPagAntecipadoOS](docs\CteOsSefazGPagAntecipadoOS.md)
 ...
 - [Model.CteOsSefazPagamentoRTCOS](docs\CteOsSefazPagamentoRTCOS.md)
 - [Model.CteOsSefazPgtoVincOS](docs\CteOsSefazPgtoVincOS.md)
 - [Model.CteOsSefazPropOS](docs\CteOsSefazPropOS.md)
 - [Model.CteOsSefazRedOS](docs\CteOsSefazRedOS.md)
 ...
 - [Model.CteOsSefazTribCTeOS](docs\CteOsSefazTribCTeOS.md)
 - [Model.CteOsSefazTribCompraGovOS](docs\CteOsSefazTribCompraGovOS.md)
 - [Model.CteOsSefazTribRegularOS](docs\CteOsSefazTribRegularOS.md)
 ...
 - [Model.CteSefazALCZFMCBS](docs\CteSefazALCZFMCBS.md)
 ...
 - [Model.CteSefazCIBS](docs\CteSefazCIBS.md)
 ...
 - [Model.CteSefazCompraGovReduzido](docs\CteSefazCompraGovReduzido.md)
 ...
 - [Model.CteSefazDevTrib](docs\CteSefazDevTrib.md)
 - [Model.CteSefazDif](docs\CteSefazDif.md)
 ...
 - [Model.CteSefazEstornoCred](docs\CteSefazEstornoCred.md)
 ...
 - [Model.CteSefazGCBS](docs\CteSefazGCBS.md)
 - [Model.CteSefazGIBSMun](docs\CteSefazGIBSMun.md)
 - [Model.CteSefazGIBSUF](docs\CteSefazGIBSUF.md)
 - [Model.CteSefazGPagAntecipado](docs\CteSefazGPagAntecipado.md)
 ...
 - [Model.CteSefazInfDCe](docs\CteSefazInfDCe.md)
 ...
 - [Model.CteSefazPagamentoRTC](docs\CteSefazPagamentoRTC.md)
 - [Model.CteSefazPass](docs\CteSefazPass.md)
 - [Model.CteSefazPeri](docs\CteSefazPeri.md)
 - [Model.CteSefazPgtoVinc](docs\CteSefazPgtoVinc.md)
 - [Model.CteSefazReceb](docs\CteSefazReceb.md)
 - [Model.CteSefazRed](docs\CteSefazRed.md)
 ...
 - [Model.CteSefazTribCTe](docs\CteSefazTribCTe.md)
 - [Model.CteSefazTribCompraGov](docs\CteSefazTribCompraGov.md)
 - [Model.CteSefazTribRegular](docs\CteSefazTribRegular.md)
 ...
 - [Model.CteSimpSefazALCZFMCBSSimp](docs\CteSimpSefazALCZFMCBSSimp.md)
 ...
 - [Model.CteSimpSefazCIBSSimp](docs\CteSimpSefazCIBSSimp.md)
 ...
 - [Model.CteSimpSefazCompraGovReduzidoSimp](docs\CteSimpSefazCompraGovReduzidoSimp.md)
 - [Model.CteSimpSefazDetContSimp](docs\CteSimpSefazDetContSimp.md)
 - [Model.CteSimpSefazDetSimp](docs\CteSimpSefazDetSimp.md)
 - [Model.CteSimpSefazDevTribSimp](docs\CteSimpSefazDevTribSimp.md)
 - [Model.CteSimpSefazDifSimp](docs\CteSimpSefazDifSimp.md)
 ...
 - [Model.CteSimpSefazEstornoCredSimp](docs\CteSimpSefazEstornoCredSimp.md)
 ...
 - [Model.CteSimpSefazGCBSSimp](docs\CteSimpSefazGCBSSimp.md)
 - [Model.CteSimpSefazGIBSMunSimp](docs\CteSimpSefazGIBSMunSimp.md)
 - [Model.CteSimpSefazGIBSUFSimp](docs\CteSimpSefazGIBSUFSimp.md)
 - [Model.CteSimpSefazGPagAntecipadoSimp](docs\CteSimpSefazGPagAntecipadoSimp.md)
 ...
 - [Model.CteSimpSefazPagamentoRTCSimp](docs\CteSimpSefazPagamentoRTCSimp.md)
 - [Model.CteSimpSefazPassSimp](docs\CteSimpSefazPassSimp.md)
 - [Model.CteSimpSefazPeriSimp](docs\CteSimpSefazPeriSimp.md)
 - [Model.CteSimpSefazPgtoVincSimp](docs\CteSimpSefazPgtoVincSimp.md)
 - [Model.CteSimpSefazRedSimp](docs\CteSimpSefazRedSimp.md)
 ...
 - [Model.CteSimpSefazTribCTeSimp](docs\CteSimpSefazTribCTeSimp.md)
 - [Model.CteSimpSefazTribCompraGovSimp](docs\CteSimpSefazTribCompraGovSimp.md)
 - [Model.CteSimpSefazTribRegularSimp](docs\CteSimpSefazTribRegularSimp.md)
 ...
 - [Model.EmpresaCertificadoListagem](docs\EmpresaCertificadoListagem.md)
 ...
 - [Model.EnderObraEvento](docs\EnderObraEvento.md)
 ...
 - [Model.InfoItemPed](docs\InfoItemPed.md)
 - [Model.InfoObra](docs\InfoObra.md)
 - [Model.InfoPrestador](docs\InfoPrestador.md)
 - [Model.InfoRefNFSe](docs\InfoRefNFSe.md)
 ...
 - [Model.MdfeSefazInfNFePrestParcial](docs\MdfeSefazInfNFePrestParcial.md)
 ...
 - [Model.NfcomSefazCIBS](docs\NfcomSefazCIBS.md)
 - [Model.NfcomSefazCOFINS](docs\NfcomSefazCOFINS.md)
 - [Model.NfcomSefazCompraGovReduzido](docs\NfcomSefazCompraGovReduzido.md)
 - [Model.NfcomSefazDest](docs\NfcomSefazDest.md)
 - [Model.NfcomSefazDet](docs\NfcomSefazDet.md)
 - [Model.NfcomSefazDevTrib](docs\NfcomSefazDevTrib.md)
 - [Model.NfcomSefazDif](docs\NfcomSefazDif.md)
 ...
 - [Model.NfcomSefazGIBS](docs\NfcomSefazGIBS.md)
 - [Model.NfcomSefazGIBSGIBSMun](docs\NfcomSefazGIBSGIBSMun.md)
 - [Model.NfcomSefazGIBSGIBSUF](docs\NfcomSefazGIBSGIBSUF.md)
 - [Model.NfcomSefazGIBSMun](docs\NfcomSefazGIBSMun.md)
 - [Model.NfcomSefazGIBSUF](docs\NfcomSefazGIBSUF.md)
 - [Model.NfcomSefazGNF](docs\NfcomSefazGNF.md)
 - [Model.NfcomSefazGPIX](docs\NfcomSefazGPIX.md)
 - [Model.NfcomSefazGPagAntecipado](docs\NfcomSefazGPagAntecipado.md)
 ...
 - [Model.NfcomSefazIBSCBSTot](docs\NfcomSefazIBSCBSTot.md)
 - [Model.NfcomSefazIBSCBSTotGCBS](docs\NfcomSefazIBSCBSTotGCBS.md)
 ...
 - [Model.NfcomSefazPagamentoRTC](docs\NfcomSefazPagamentoRTC.md)
 - [Model.NfcomSefazPgtoVinc](docs\NfcomSefazPgtoVinc.md)
 - [Model.NfcomSefazProd](docs\NfcomSefazProd.md)
 - [Model.NfcomSefazRed](docs\NfcomSefazRed.md)
 ...
 - [Model.NfcomSefazTribCompraGov](docs\NfcomSefazTribCompraGov.md)
 - [Model.NfcomSefazTribNFCom](docs\NfcomSefazTribNFCom.md)
 - [Model.NfcomSefazTribRegular](docs\NfcomSefazTribRegular.md)
 ...
 - [Model.NfeSefazCompraGov](docs\NfeSefazCompraGov.md)
 - [Model.NfeSefazCredPres](docs\NfeSefazCredPres.md)
 - [Model.NfeSefazCredPresIBSZFM](docs\NfeSefazCredPresIBSZFM.md)
 - [Model.NfeSefazCredPresOper](docs\NfeSefazCredPresOper.md)
 - [Model.NfeSefazDFeReferenciado](docs\NfeSefazDFeReferenciado.md)
 ...
 - [Model.NfeSefazDevTrib](docs\NfeSefazDevTrib.md)
 - [Model.NfeSefazDif](docs\NfeSefazDif.md)
 ...
 - [Model.NfeSefazEstornoCred](docs\NfeSefazEstornoCred.md)
 ...
 - [Model.NfeSefazGCBS](docs\NfeSefazGCBS.md)
 - [Model.NfeSefazGCred](docs\NfeSefazGCred.md)
 - [Model.NfeSefazGEstornoCred](docs\NfeSefazGEstornoCred.md)
 - [Model.NfeSefazGIBS](docs\NfeSefazGIBS.md)
 - [Model.NfeSefazGIBSGIBSMun](docs\NfeSefazGIBSGIBSMun.md)
 - [Model.NfeSefazGIBSGIBSUF](docs\NfeSefazGIBSGIBSUF.md)
 - [Model.NfeSefazGIBSMun](docs\NfeSefazGIBSMun.md)
 - [Model.NfeSefazGIBSUF](docs\NfeSefazGIBSUF.md)
 - [Model.NfeSefazGMono](docs\NfeSefazGMono.md)
 - [Model.NfeSefazGMonoDif](docs\NfeSefazGMonoDif.md)
 - [Model.NfeSefazGMonoPadrao](docs\NfeSefazGMonoPadrao.md)
 - [Model.NfeSefazGMonoRet](docs\NfeSefazGMonoRet.md)
 - [Model.NfeSefazGMonoReten](docs\NfeSefazGMonoReten.md)
 - [Model.NfeSefazGPagAntecipado](docs\NfeSefazGPagAntecipado.md)
 - [Model.NfeSefazGuiaTransito](docs\NfeSefazGuiaTransito.md)
 - [Model.NfeSefazIBSCBSMonoTot](docs\NfeSefazIBSCBSMonoTot.md)
 - [Model.NfeSefazIBSCBSMonoTotGCBS](docs\NfeSefazIBSCBSMonoTotGCBS.md)
 ...
 - [Model.NfeSefazInfPAA](docs\NfeSefazInfPAA.md)
 ...
 - [Model.NfeSefazMonofasia](docs\NfeSefazMonofasia.md)
 ...
 - [Model.NfeSefazPAASignature](docs\NfeSefazPAASignature.md)
 ...
 - [Model.NfeSefazRSAKeyValueType](docs\NfeSefazRSAKeyValueType.md)
 - [Model.NfeSefazRastro](docs\NfeSefazRastro.md)
 - [Model.NfeSefazRed](docs\NfeSefazRed.md)
 ...
 - [Model.NfeSefazTransfCred](docs\NfeSefazTransfCred.md)
 - [Model.NfeSefazTransp](docs\NfeSefazTransp.md)
 - [Model.NfeSefazTransporta](docs\NfeSefazTransporta.md)
 - [Model.NfeSefazTribCompraGov](docs\NfeSefazTribCompraGov.md)
 - [Model.NfeSefazTribNFe](docs\NfeSefazTribNFe.md)
 - [Model.NfeSefazTribRegular](docs\NfeSefazTribRegular.md)
 ...
 - [Model.RTCInfoIBSCBS](docs\RTCInfoIBSCBS.md)
 - [Model.RTCInfoImovel](docs\RTCInfoImovel.md)
 - [Model.RTCInfoReeRepRes](docs\RTCInfoReeRepRes.md)
 - [Model.RTCInfoTributosDif](docs\RTCInfoTributosDif.md)
 - [Model.RTCInfoTributosIBSCBS](docs\RTCInfoTributosIBSCBS.md)
 - [Model.RTCInfoTributosSitClas](docs\RTCInfoTributosSitClas.md)
 - [Model.RTCInfoTributosTribRegular](docs\RTCInfoTributosTribRegular.md)
 - [Model.RTCInfoValoresIBSCBS](docs\RTCInfoValoresIBSCBS.md)
 - [Model.RTCListaDoc](docs\RTCListaDoc.md)
 - [Model.RTCListaDocDFe](docs\RTCListaDocDFe.md)
 - [Model.RTCListaDocFiscalOutro](docs\RTCListaDocFiscalOutro.md)
 - [Model.RTCListaDocFornec](docs\RTCListaDocFornec.md)
 - [Model.RTCListaDocOutro](docs\RTCListaDocOutro.md)
